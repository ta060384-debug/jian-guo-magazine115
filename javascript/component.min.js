...
function(a){a.stopPropagation();this.hide();this.initPageConfig();a=BookInfo.getCurrentPages();for(var b=0;b<a.length;b++)console.log(this.pageWidth,this.pageHeight),global.annotationCookie.repaintCookie(this.pageWidth,this.pageHeight,a[b]-1)}.bind(this));this.save.bind(_event._click,function(a){var b=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return a.stopPropagation(),c.yield(global.annotationCookie.saveCookie(),2);b.hide();c.jumpToEnd()})}.bind(this));
this.undo.bind(_event._click,function(a){a.stopPropagation();this.setPanelIndex(0,0,"none");this.selectCase=AnnotationPannel.NONE;--global.annotationCookie.stepIndex;0>=global.annotationCookie.stepIndex&&(global.annotationCookie.stepIndex=0);global.annotationCookie.repaintSteps()}.bind(this));this.redo.bind(_event._click,function(a){a.stopPropagation();this.setPanelIndex(0,0,"none");this.selectCase=AnnotationPannel.NONE;global.annotationCookie.stepIndex+=1;global.annotationCookie.stepIndex>=global.annotationCookie.allAnnoSteps.length&&
(global.annotationCookie.stepIndex=global.annotationCookie.allAnnoSteps.length);global.annotationCookie.repaintSteps()}.bind(this))},defaultBottomCase:function(){this.selectCase=AnnotationPannel.NONE;this.setPanelIndex(0,0,"none");this.bottomBox.css({display:"none"})},isArray:function(a){return"[object Array]"==Object.prototype.toString.call(a)},defaultCaseEvent:function(){this.annoBtnBox.find("div").bind(_event._click,function(a){a.stopPropagation();a=a.target;if("p"==a.tagName.toLowerCase()||"img"==
a.tagName.toLowerCase())a=$(a).parent();isPhone()||isPad()?$(a).siblings("div").css({background:"transparent"}):$(a).siblings("div").css({background:""})}.bind(this));this.annoBtnBox.find("div").bind(_event._down,function(a){a.stopPropagation();a=a.target;if("p"==a.tagName.toLowerCase()||"img"==a.tagName.toLowerCase())a=$(a).parent();isPhone()||isPad()?$(a).css({background:"rgba(255,255,255,0.2)"}):$(a).css({background:"rgba(0,0,0,0.2)"})}.bind(this));this.annoBtnBox.find("div").bind(_event._up,function(a){a.stopPropagation();
a=a.target;if("p"==a.tagName.toLowerCase()||"img"==a.tagName.toLowerCase())a=$(a).parent();isPhone()||isPad()?$(a).css({background:"transparent"}):$(a).css({background:""})}.bind(this))},initCss:function(){var a=404<=windowWidth?1:windowWidth/404;this.panel.css({display:"none",position:"absolute",width:"404px",height:"auto","border-radius":"1px",top:"60px",left:(0>windowWidth-404?0:(windowWidth-404)/2)+"px","-webkit-transform":"scale("+a+")","-moz-transform":"scale("+a+")","-o-transform":"scale("+
a+")","-ms-transform":"scale("+a+")",transform:"scale("+a+")","-webkit-transform-origin":"0 0","-moz-transform-origin":"0 0","-o-transform-origin":"0 0","-ms-transform-origin":"0 0","transform-origin":"0 0","z-index":"10000"});this.topBox.css({"border-radius":"3px",position:"relative",border:"1px solid rgba(0,0,0,0.1)",background:"#eaeaf0"});this.annoBtnBox.css({"border-radius":"3px",position:"relative",height:"36px",top:"0",left:"15px"});this.bottomBox.css({display:"none","border-radius":"3px","vertical-align":"middle",
width:"402px",left:"0",background:"#eaeaf0",border:"1px solid rgba(0, 0, 0, 0.1)","font-family":"Tahoma , sans-serif , Arial",position:"relative",top:"2px"});this.moveBar.css({cursor:"move",width:"16px",height:"36px",position:"absolute",top:"0"});this.note.css({cursor:"pointer",position:"relative",float:"left",width:"24px",height:"24px",top:"6px",border:"1px solid transparent"});this.pen.css({cursor:"pointer",width:"24px",height:"24px",position:"relative",float:"left",top:"6px",border:"1px solid transparent"});
...
b.downloadButton.downloadType&&(m=b.currentAttachmentName||"");if(location.protocol.match("file:"))return/^\/\//i.test(e)&&(e="https://"+e),window.open(e),q.return();if("downloadAll"==b.downloadButton.downloadType)return"English"==UserGroups&&(n=_get(htmlConfig,"meta.url","")||window.share_url||window.location.href,e=e.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(n))),bookConfig.isEncryptionBook&&(p=BookRestrict.getRestrictToken(),e=appendParamToUrl(e,"code="+p)),window.open(e,"_blank"),q.return();
if(isAndroid()&&isWeChat()||isPad())return window.open(e,"_blank"),q.return();if((!isPhone()&&!isPad()||_agent_.browser.safari)&&/fliphtml5|yunzhan365|anyflip|pubhtml5/.test(location.host))return l=$('<a download="'+m+'" target="_blank" href="'+e+'"></a>'),l[0].click(),q.return();new DownloadFile({url:e,downloadName:m,downloadButton:b.downloadButton,downloadingTips:b.downloadingTips})}q.jumpToEnd()})};b.downloadconfig.code&&!b.verify?(b.downloadPasswordPanel||(b.downloadPasswordPanel=new DownloadPasswordPanel({parent:$("body"),
...
b+"px")},refreshSideEdge:function(a){var b=1===bookConfig.FlipDirection||0===bookConfig.FlipDirection&&bmtConfig.onSideEdge;(void 0===a?0:a)&&!b?(bookConfig.topMargin=this.topMargin,onStageResize(),this.isRefresh=!1):!(b||isPad()||isPhone()||this.isRefresh)&&this.bookmarkList.getLength()&&75>BookInfo.top()-templateArea.getTopHeight()&&(this.topMargin=bookConfig.topMargin,bookConfig.topMargin=75,onStageResize(),this.isRefresh=!0)}}),PhoneBookmarkListPanel=Class({create:function(a){this._super(a)},
onCreate:function(){},newItem:function(a){return new PhoneBookmarkItem(a,this.callback)}}).extend(BookmarkListPanel),PcBookmarkFrame=Class({create:function(a){this.elements=new BookmarkElements(this);this.bookmarkListPanel=new PcBookmarkListPanel(this);this.elements.bookmarkList=this.bookmarkListPanel.bookmarkList;this.elements.bookmarkListPanel=this.bookmarkListPanel;this._super(a)},onCreate:function(){this.initColorCss()},initColorCss:function(){this.stage.css({"background-color":this.mainColor,
color:this.fontColor});this.bookmarkListPanel.initColorCss();this.bookmarkListPanel.resetSwiperHtml()},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='bookmark_content'></div>");this.stage.append(this.content);var a=$("<p class='inputForm'></p>");a.append(this.input);a.append(this.colorSelection);this.content.append(a);this.content.append(this.leftAddPage);
this.content.append(this.rightAddPage);this.content.append(this.bookmarkListPanel.bookmarkListTitle);this.content.append(this.bookmarkListPanel.bookmarkSwiper);this.content.append(this.remove);this.parent.append(this.stage);this.refreshPanel()},refreshPanel:function(){this.bookmarkListPanel.refreshPanel();this.elements.refreshElements()},setRandom:function(){var a=getRandomColor();this.colorSelection.attr("color",a);this.colorSelection.css("background",a)},addItem:function(a){a&&a.caption&&a.pageIndex&&
!this.bookmarkListPanel.inList(a.pageIndex)&&(this.bookmarkListPanel.addItem(a),this.input.val(""),this.setRandom(),this.refreshPanel())},deleteItem:function(a){this.bookmarkListPanel.deleteItem(a);this.refreshPanel()},editItem:function(a){this.bookmarkListPanel.editItem(a);this.refreshPanel()},refreshItem:function(a){this.bookmarkListPanel.refreshItem(a)},removeAll:function(){this.bookmarkListPanel.removeAll();this.refreshPanel()},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-
bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=250;this.height=a-87;this.maxHeight=this.height-188;this.stage.css({height:this.height+"px",top:b+"px"});this.bookmarkListPanel.onResize(this.width,this.maxHeight);this.refreshPanel()},onShow:function(){this.changeIconColor();this.refreshItemsImage()},refreshItemsImage:function(){this.bookmarkListPanel.refreshItemsImage()}}).extend(SlideForm),PhoneBookmarkFrame=Class({create:function(a){this.elements=
new BookmarkElements(this);this.bookmarkListPanel=new PhoneBookmarkListPanel(this);this.elements.bookmarkList=this.bookmarkListPanel.bookmarkList;this.elements.bookmarkListPanel=this.bookmarkListPanel;this._super(a)},onCreate:function(){this.favicon&&this.favicon.changeButtonColor(this.fontColor);this._super()},initHtml:function(){this.title.append(this.close);this.stage.append(this.title);this.stage.append(this.bookmarkListPanel.bookmarkSwiper);this.refreshPanel()},refreshPanel:function(){this.bookmarkListPanel.refreshPanel();
...
e;g++)d.children[g].level=parseInt(d.children[g].level)+1,a(d.children[g])},b=ols.length,c=0;c<b;c++)0==parseInt(ols[c].level)&&(ols[c].level=parseInt(ols[c].level)+1,a(ols[c]))},initElements:function(){this.searchButtonUrl=form_icons.search_form?"data:image/png;base64,"+form_icons.search_form:uiBaseURL+"search_form.png";this.input=$("<input class='input_search' placeholder='"+FormInfo.getFormTitle("tableOfContent")+"'></input>");bookConfig.RightToLeft&&this.input.attr("dir","rtl");this.searchButton=
$("<img class='searchButton' src='"+this.searchButtonUrl+"'/>");this.result=$("<p style='display:none;margin:0 27px;'>"+getLanguage("lblPages","Found Pages")+" <span style='color:"+bookConfig.searchKeywordFontColor+";'>0</span></p>");this.tableofcontentSwiper=$("<div class='stage'></div>");this.tableofcontentSwiperList=$("<ul class='swiper'></ul>");this.refreshSwiper(this.tableofcontentSwiperList,ols);this.tableofcontentSwiper.append(this.tableofcontentSwiperList);isPhone()||isPad()?this.tableofcontentSwiper.css({overflow:"auto",
"-webkit-overflow-scrolling":"touch"}):(this.progress=$("<div class='progress'></div>"),this.progressBar=$("<div class='progressBar'></div>"),this.tableofcontentSwiper.append(this.progress),this.progress.append(this.progressBar),this.tableofcontentSwiper.scroll({},Direction.top))},expandItems:function(){for(var a=0;a<this.tableItems.length;a++)this.tableItems[a].expand()},collapseItems:function(){for(var a=0;a<this.tableItems.length;a++)this.tableItems[a].collapse()},refreshItems:function(a){for(var b=
