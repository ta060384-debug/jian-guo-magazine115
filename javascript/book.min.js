...
thumbnail.setHighLight(c))}function getStaticAdVisible(b){b=void 0===b?!1:b;return!global.staticAd||!global.staticAd.haveAd||isPhone()||isPad()||!global.staticAd.adPosition&&!isPhone()&&!isPad()&&b||global.staticAd.adPosition&&"Chinese"==UserGroups?!1:!0}
...
{thickness:bookConfig.showThicknessOnMobile&&!bookConfig.FlipDirection?!0:!1,bookshadow:!0,grayshadow:!1,miniFullscreen:bookConfig.hideMiniFullscreen?!1:!0,bookpagenumber:bookConfig.updatePageNumberForFlip?!0:!1,staticad:getStaticAdVisible(!0),zoommap:bookConfig.ZoomMapVisible?!0:!1,bookmarktab:global.bmtConfig?!0:!1,noteadd:bookConfig.AnnotationButtonVisible?!0:!1}),bookConfig.HardInnerPageEnable?bookConfig.FlipDirection?bookConfig.HardPageEnable?("single"!=bookConfig.showDoublePage&&(global.flipBook=
bookConfig.isTheBookOpen?new OpenAlbumHardCalendar(b):new AlbumHardCalendar(b)),"double"!=bookConfig.showDoublePage&&(global.singlePageBook=new SingleAlbumHardCalendar(c))):("single"!=bookConfig.showDoublePage&&(global.flipBook=new AlbumCalendar(b)),"double"!=bookConfig.showDoublePage&&(global.singlePageBook=new SingleAlbumCalendar(c))):bookConfig.HardPageEnable?("single"!=bookConfig.showDoublePage&&(global.flipBook=bookConfig.isTheBookOpen?new OpenAlbumHardBook(b):new AlbumHardBook(b)),"double"!=
...
("single"!=bookConfig.showDoublePage&&(global.flipBook=new NormalCalendar(b)),"double"!=bookConfig.showDoublePage&&(global.singlePageBook=new SingleCalendar(c))):(bookConfig.HardPageEnable?("single"!=bookConfig.showDoublePage&&(global.flipBook=bookConfig.isTheBookOpen?new OpenHardBook(b):new HardBook(b)),"double"!=bookConfig.showDoublePage&&(global.singlePageBook=new SingleHardBook(c))):("single"!=bookConfig.showDoublePage&&(global.flipBook=new NormalBook(b)),"double"!=bookConfig.showDoublePage&&
(global.singlePageBook=new SingleBook(c))),bookConfig.flipshortcutbutton&&window.flipShotButton&&flipShotButton.animate()))}
function initIssuuBook(b,c){"issuu"!=bookConfig.FlipStyle||bookType!=BookType.normal_book&&bookType!=BookType.single_book||($.extend(b,{thickness:bookConfig.FlipDirection?!1:!0,bookmarktab:global.bmtConfig?!0:!1}),$.extend(c,{thickness:bookConfig.showThicknessOnMobile&&!bookConfig.FlipDirection?!0:!1,bookshadow:!0,grayshadow:!1,miniFullscreen:bookConfig.hideMiniFullscreen?!1:!0,bookpagenumber:bookConfig.updatePageNumberForFlip?!0:!1,staticad:getStaticAdVisible(!0),zoommap:bookConfig.ZoomMapVisible?
...
function initSlideBook(b,c){if(bookType==BookType.slide_book||bookType==BookType.singleSlide_book){$.extend(b,{thickness:!1,bookshadow:!1,grayshadow:!1,miniFullscreen:!1,bookpagenumber:!1,staticad:getStaticAdVisible(),zoommap:!1,bookmarktab:!1,noteadd:!0});$.extend(c,{thickness:!1,bookshadow:!1,grayshadow:!1,miniFullscreen:!1,bookpagenumber:!1,staticad:getStaticAdVisible(!0),zoommap:!1,bookmarktab:!1,noteadd:!0});if(bookType==BookType.slide_book||bookType==BookType.singleSlide_book)"single"!=bookConfig.showDoublePage&&
(global.slideBook=new PcDoubleSlideBook(b)),"double"!=bookConfig.showDoublePage&&(global.singleSlideBook=new PcSingleSlideBook(c));(isPhone()||isPad())&&global.QRbutton&&QRbutton.hide()}}function initCardBook(b){bookType==BookType.card_book&&($.extend(b,{thickness:!1,bookshadow:!1,grayshadow:!1,miniFullscreen:!1,bookpagenumber:!1,staticad:getStaticAdVisible(!0),zoommap:!1,bookmarktab:!1,noteadd:!0}),global.cardBook=new CardBook(b),(isPhone()||isPad())&&global.QRbutton&&QRbutton.hide())}
...
var tmpBookConfig={},checkBookConfig=function(){var b,c,d,e,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress){b=htmlConfig.bookConfig;c=allocateUTF8(b);window.key_index=Module._DeConfig_Parse(c);void 0==window.aliasConfig&&(window.aliasConfig={});tmpBookConfig.isFirstLastShortcutVisible=getConfigValue("isFirstLastShortcutVisible",!0);tmpBookConfig.miniFullscreenDisplayType=getConfigValue("miniFullscreenDisplayType","always").toLowerCase();tmpBookConfig.isFakeStopBook=
getConfigValue("isFakeStopBook",0);tmpBookConfig.isTabelOfContentSearchBarVisible=getConfigValue("isTabelOfContentSearchBarVisible",!0);tmpBookConfig.mouseDragFlip=getConfigValue("mouseDragFlip",!0);tmpBookConfig.disablePrintShortcut=getConfigValue("disablePrintShortcut",!1);tmpBookConfig.chatBotButtonIconHeight=getConfigValue("chatBotButtonIconHeight",56);tmpBookConfig.chatBotButtonIcon=getConfigValue("chatBotButtonIcon","");tmpBookConfig.isAccessibilityButtonVisible=getConfigValue("isAccessibilityButtonVisible",
!1);tmpBookConfig.ClientBookId=getConfigValue("ClientBookId","");tmpBookConfig.CreatedTime=getConfigValue("CreatedTime","");tmpBookConfig.CreatedVersion=getConfigValue("CreatedVersion","");tmpBookConfig.productName=getConfigValue("productName","");tmpBookConfig.productVersion=getConfigValue("productVersion","");tmpBookConfig.PDFBASE_VERSION_MAC=getConfigValue("PDFBASE_VERSION_MAC","");tmpBookConfig.PDFBASE_VERSION=getConfigValue("PDFBASE_VERSION","");tmpBookConfig.isCachePages=getConfigValue("isCachePages",
!1);tmpBookConfig.displayNumberOfShares=getConfigValue("displayNumberOfShares",!1);tmpBookConfig.additionalNumberOfShare=getConfigValue("additionalNumberOfShare",0);tmpBookConfig.flipSoundURL=getConfigValue("flipSoundURL","");tmpBookConfig.isTableOfContentPagesVisible=getConfigValue("isTableOfContentPagesVisible",!1);tmpBookConfig.isArticlePhoneMoreButtonVisible=getConfigValue("isArticlePhoneMoreButtonVisible",!1);tmpBookConfig.alwaysShowBottomFullscreenPrompt=getConfigValue("alwaysShowBottomFullscreenPrompt",
!1);tmpBookConfig.bottomFullscreenPromptDisplayDuration=getConfigValue("bottomFullscreenPromptDisplayDuration",3);tmpBookConfig.isChatBotButtonVisible=getConfigValue("isChatBotButtonVisible",!1);tmpBookConfig.articleTitlePosition=getConfigValue("articleTitlePosition","center").toLocaleLowerCase();tmpBookConfig.phoneFlipShortcutButtonSize=getConfigValue("phoneFlipShortcutButtonSize","large").toLocaleLowerCase();tmpBookConfig.socialSharingList=getConfigValue("socialSharingList",void 0);tmpBookConfig.socialShareType=
getConfigValue("socialShareType","0");tmpBookConfig.isRestorePageFrameVisible=getConfigValue("isRestorePageFrameVisible",!0);tmpBookConfig.alwaysShowBookInstructionOnStart=getConfigValue("alwaysShowBookInstructionOnStart","0");tmpBookConfig.showBookInstructionCountOnStart=getConfigValue("showBookInstructionCountOnStart",3);tmpBookConfig.toolBarBrandInfoVisible=getConfigValue("toolBarBrandInfoVisible",void 0);void 0!==tmpBookConfig.toolBarBrandInfoVisible&&(tmpBookConfig.toolBarBrandInfoVisible=parseBool(tmpBookConfig.toolBarBrandInfoVisible));
tmpBookConfig.toolBarBrandInfoUrl=getConfigValue("toolBarBrandInfoUrl","");tmpBookConfig.loadingBrandInfoVisible=getConfigValue("loadingBrandInfoVisible",!1);tmpBookConfig.loadingBrandInfoUrl=getConfigValue("loadingBrandInfoUrl","");tmpBookConfig.relatedBrandInfoVisible=getConfigValue("relatedBrandInfoVisible",!1);tmpBookConfig.relatedBrandInfoUrl=getConfigValue("relatedBrandInfoUrl","");tmpBookConfig.relatedCardVisible=getConfigValue("relatedCardVisible",!1);tmpBookConfig.relatedCardUrl=getConfigValue("relatedCardUrl",
"");tmpBookConfig.bookBaseURL=getConfigValue("bookBaseURL","");tmpBookConfig.bookResourceBaseURL=getConfigValue("bookResourceBaseURL","");!tmpBookConfig.bookResourceBaseURL&&window.htmlConfig&&window.htmlConfig.loadingConfig&&window.htmlConfig.loadingConfig.bookResourceBaseURL&&(tmpBookConfig.bookResourceBaseURL=window.htmlConfig.loadingConfig.bookResourceBaseURL);!tmpBookConfig.bookResourceBaseURL&&window.bookResourceBaseURL&&(tmpBookConfig.bookResourceBaseURL=window.bookResourceBaseURL);try{tmpBookConfig.bookResourceBaseURL||
"Chinese"==UserGroups||"article"!=window.templeteName&&"article2"!=window.templeteName&&"article3"!=window.templeteName||(tmpBookConfig.bookResourceBaseURL=window.location.origin+window.location.pathname.remove("mobile/index.html"),tmpBookConfig.bookResourceBaseURL=tmpBookConfig.bookResourceBaseURL.remove("index.html"))}catch(l){}tmpBookConfig.enableCustomizedBookmarkWidth=getConfigValue("enableCustomizedBookmarkWidth",!1);tmpBookConfig.customizedBookmarkWidth=getConfigValue("customizedBookmarkWidth",
50);tmpBookConfig.onlyOpenInDingDing=getConfigValue("onlyOpenInDingDing",!1);tmpBookConfig.disableDingDingSharing=getConfigValue("disableDingDingSharing",!1);tmpBookConfig.formBackgroundOpacity=getConfigValue("formBackgroundOpacity",1);tmpBookConfig.phoneToolbarFontSize=getConfigValue("phoneToolbarFontSize","small").toLowerCase();tmpBookConfig.EnableRecognizeQRcodePressOnMobile=getConfigValue("EnableRecognizeQRcodePressOnMobile",!1);tmpBookConfig.mobileThumbnailSearchBarVisible=getConfigValue("mobileThumbnailSearchBarVisible",
!0);tmpBookConfig.loadingMainColor=getConfigValue("loadingMainColor","#1F2232");tmpBookConfig.loadingBackgroundColorType=getConfigValue("loadingBackgroundColorType","1");tmpBookConfig.isShowFirstOrLastPagePrompt=getConfigValue("isShowFirstOrLastPagePrompt",!0);tmpBookConfig.isShowMobileBottomFullscreenPrompts=getConfigValue("isShowMobileBottomFullscreenPrompts",!1);tmpBookConfig.SmallProgramUrl=getConfigValue("SmallProgramUrl","");tmpBookConfig.searchColor=getConfigValue("searchColor","#00ffff");
tmpBookConfig.searchAlpha=getConfigValue("searchAlpha",.3);tmpBookConfig.appLogoIcon=getConfigValue("appLogoIcon","");tmpBookConfig.HomeURL=getConfigValue("HomeURL","");tmpBookConfig.bookTitle=getConfigValue("bookTitle","FLIPBOOK");tmpBookConfig.bookDescription=getConfigValue("bookDescription","");tmpBookConfig.toolbarColor=getConfigValue("toolbarColor","#27181A");tmpBookConfig.iconColor=getConfigValue("iconColor","#FFFFFF");tmpBookConfig.toolbarColor==tmpBookConfig.iconColor&&(tmpBookConfig.iconColor=
Color(tmpBookConfig.toolbarColor).reverse());tmpBookConfig.pageNumColor=getConfigValue("pageNumColor","#000000");tmpBookConfig.formBackgroundColor=getConfigValue("formBackgroundColor",tmpBookConfig.toolbarColor);tmpBookConfig.formFontColor=getConfigValue("formFontColor",tmpBookConfig.iconColor);tmpBookConfig.formBackgroundColor.toLocaleLowerCase()==tmpBookConfig.formFontColor.toLocaleLowerCase()&&(tmpBookConfig.formFontColor=Color(tmpBookConfig.formBackgroundColor).reverse());tmpBookConfig.loadingBackground=
getConfigValue("loadingBackground","#1F2232");tmpBookConfig.loadingDisplayTime=getConfigValue("loadingDisplayTime",0);tmpBookConfig.searchHightlightColor=getConfigValue("searchHightlightColor","#fdc606");tmpBookConfig.logoHeight=getConfigValue("logoHeight",40);tmpBookConfig.logoTop=getConfigValue("logoTop",0);tmpBookConfig.logoPadding=getConfigValue("logoPadding",0);tmpBookConfig.isFixLogoSize=getConfigValue("isFixLogoSize",!1);tmpBookConfig.HomeButtonVisible=getConfigValue("HomeButtonVisible",!1);
tmpBookConfig.ShareButtonVisible=getConfigValue("ShareButtonVisible",!1);tmpBookConfig.facebookAppId=getConfigValue("facebookAppId","");tmpBookConfig.isInsertFrameLinkEnable=getConfigValue("isInsertFrameLinkEnable",!0);tmpBookConfig.addCurrentPage=getConfigValue("addCurrentPage",!1);tmpBookConfig.DoubleSinglePageButtonVisible=getConfigValue("DoubleSinglePageButtonVisible",!1);tmpBookConfig.ToolBarVisible=getConfigValue("ToolBarVisible",!0);tmpBookConfig.WeChatShareButtonVisible=getConfigValue("WeChatShareButtonVisible",
!1);tmpBookConfig.ThumbnailsButtonVisible=getConfigValue("ThumbnailsButtonVisible",!1);tmpBookConfig.thumbnailColor=getConfigValue("thumbnailColor",tmpBookConfig.formBackgroundColor);tmpBookConfig.thumbnailAlpha=getConfigValue("thumbnailAlpha",100);tmpBookConfig.ThumbnailSize=getConfigValue("ThumbnailSize","small");tmpBookConfig.ZoomButtonVisible=getConfigValue("ZoomButtonVisible",!1);tmpBookConfig.ZoomToolbarVisible=getConfigValue("ZoomToolbarVisible",!0);tmpBookConfig.ZoomMapVisible=getConfigValue("ZoomMapVisible",
!0);tmpBookConfig.MagnifierButtonVisible=getConfigValue("MagnifierButtonVisible",!1);tmpBookConfig.SupportOperatePageZoom=getConfigValue("SupportOperatePageZoom",!0);tmpBookConfig.TableOfContentButtonVisible=getConfigValue("TableOfContentButtonVisible",!1);if(!global.ols||0>=global.ols.length)global.ols=[],tmpBookConfig.TableOfContentButtonVisible=!1;tmpBookConfig.LargeLogoPosition=getConfigValue("LargeLogoPosition","top-left");tmpBookConfig.LargeLogoTarget=getConfigValue("LargeLogoTarget","blank");
tmpBookConfig.isHideTabelOfContentNodes=getConfigValue("isHideTabelOfContentNodes",!0);tmpBookConfig.BookMarkButtonVisible=getConfigValue("BookMarkButtonVisible",!1);tmpBookConfig.SelectTextButtonVisible=getConfigValue("SelectTextButtonVisible",!1);tmpBookConfig.SearchButtonVisible=getConfigValue("SearchButtonVisible",!1);tmpBookConfig.searchKeywordFontColor=getConfigValue("searchKeywordFontColor","#FFB000");tmpBookConfig.FullscreenButtonVisible=getConfigValue("FullscreenButtonVisible",!0);tmpBookConfig.isNeat&&
(tmpBookConfig.FullscreenButtonVisible=!0);tmpBookConfig.hideMiniFullscreen=getConfigValue("hideMiniFullscreen",!1);isIphone()&&window.top==window.self&&(tmpBookConfig.isShowMobileBottomFullscreenPrompts=!1);tmpBookConfig.updatePageNumberForFlip=getConfigValue("updatePageNumberForFlip",!1);tmpBookConfig.leastSearchChar=getConfigValue("leastSearchChar",0);tmpBookConfig.PrintButtonVisible=getConfigValue("PrintButtonVisible",!1);tmpBookConfig.MessageButtonVisible=getConfigValue("MessageButtonVisible",
!1);tmpBookConfig.printWatermarkFile=getConfigValue("printWatermarkFile","");tmpBookConfig.BackgroundSoundButtonVisible=getConfigValue("BackgroundSoundButtonVisible",!1);tmpBookConfig.BackgroundSoundURL=getConfigValue("BackgroundSoundURL","");tmpBookConfig.BackgroundSoundLoop=getConfigValue("BackgroundSoundLoop",-1);tmpBookConfig.HelpButtonVisible=getConfigValue("HelpButtonVisible",!1);tmpBookConfig.helpContentFileURL=getConfigValue("helpContentFileURL","");tmpBookConfig.helpWidth=getConfigValue("helpWidth",
400);tmpBookConfig.helpHeight=getConfigValue("helpHeight",450);tmpBookConfig.showHelpContentAtFirst=getConfigValue("showHelpContentAtFirst",!1);tmpBookConfig.aboutButtonVisible=getConfigValue("aboutButtonVisible",!1);tmpBookConfig.aboutContactInfoTxt=getConfigValue("aboutContactInfoTxt","");tmpBookConfig.AutoPlayButtonVisible=getConfigValue("AutoPlayButtonVisible",!1);tmpBookConfig.autoPlayAutoStart=getConfigValue("autoPlayAutoStart",!1);tmpBookConfig.autoPlayDuration=getConfigValue("autoPlayDuration",
3);tmpBookConfig.autoPlayLoopCount=getConfigValue("autoPlayLoopCount",1);tmpBookConfig.minZoomWidth=getConfigValue("minZoomWidth",0);tmpBookConfig.minZoomHeight=getConfigValue("minZoomHeight",0);tmpBookConfig.maxZoomScale=getConfigValue("maxZoomScale",4);tmpBookConfig.maxZoomHeight=getConfigValue("maxZoomHeight",0);tmpBookConfig.defaultZoomScale=getConfigValue("defaultZoomScale",2);tmpBookConfig.defaultZoomHeight=getConfigValue("defaultZoomHeight",0);tmpBookConfig.middleZoomWidth=getConfigValue("middleZoomWidth",
0);isNaN(tmpBookConfig.middleZoomWidth)&&(tmpBookConfig.middleZoomWidth=0);tmpBookConfig.mouseWheelFlip=getConfigValue("mouseWheelFlip",!0);tmpBookConfig.DownloadButtonVisible=getConfigValue("DownloadButtonVisible",!0);tmpBookConfig.DownloadURL=getConfigValue("DownloadURL","");fixDownloadURLValue();tmpBookConfig.bgBeginColor=getConfigValue("bgBeginColor","#E6E6E6");tmpBookConfig.bgEndColor=getConfigValue("bgEndColor","#E3E3E3");tmpBookConfig.bgMRotation=getConfigValue("bgMRotation",90);tmpBookConfig.backGroundImgURL=
getConfigValue("backGroundImgURL","");tmpBookConfig.backgroundOpacity=getConfigValue("backgroundOpacity",100);tmpBookConfig.LeftShadowWidth=getConfigValue("LeftShadowWidth",40);tmpBookConfig.LeftShadowAlpha=getConfigValue("LeftShadowAlpha",1);tmpBookConfig.RightShadowWidth=getConfigValue("RightShadowWidth",40);tmpBookConfig.RightShadowAlpha=getConfigValue("RightShadowAlpha",1);_agent_.system.name==_agent_.system.ANDROID&&_agent_.browser.wechat&&(tmpBookConfig.RightShadowAlpha=1,tmpBookConfig.LeftShadowAlpha=
1);tmpBookConfig.ShowTopLeftShadow=getConfigValue("ShowTopLeftShadow",!0);tmpBookConfig.pageBackgroundColor=getConfigValue("pageBackgroundColor","#FFFFFF");tmpBookConfig.flipshortcutbutton=getConfigValue("flipshortcutbutton",!1);tmpBookConfig.OriginPageIndex=getConfigValue("OriginPageIndex",1);tmpBookConfig.HardPageEnable=getConfigValue("HardPageEnable",!1);tmpBookConfig.HardInnerPageEnable=getConfigValue("HardInnerPageEnable",!1);tmpBookConfig.bookPageStretch=getConfigValue("bookPageStretch",!1);
_agent_.browser.msie&&11>_agent_.browser.version&&(tmpBookConfig.HardPageEnable=!1,tmpBookConfig.HardInnerPageEnable=!1);tmpBookConfig.HardPageEnable||(tmpBookConfig.HardInnerPageEnable=!1);tmpBookConfig.thicknessWidthType=getConfigValue("thicknessWidthType","thick").toLowerCase();tmpBookConfig.showThicknessOnMobile=getConfigValue("showThicknessOnMobile",!1);"Chinese"==UserGroups&&(tmpBookConfig.pageHighlightType=getConfigValue("pageHighlightType","book").toLowerCase());"English"==UserGroups&&(tmpBookConfig.pageHighlightType=
getConfigValue("pageHighlightType","magazine").toLowerCase());tmpBookConfig.usePdfJs=getConfigValue("usePdfJs",!1);tmpBookConfig.highDefinitionConversion=getConfigValue("highDefinitionConversion",!1);tmpBookConfig.usePdfJs&&(tmpBookConfig.highDefinitionConversion=!1);tmpBookConfig.highDefinitionConversion=!1;tmpBookConfig.isStopMouseMenu=getConfigValue("isStopMouseMenu",!1);tmpBookConfig.thicknessColor=getConfigValue("thicknessColor","#FFFFFF");tmpBookConfig.RightToLeft=getConfigValue("RightToLeft",
!1);tmpBookConfig.flippingTime=getConfigValue("flippingTime",.3);void 0!=tmpBookConfig.flippingTime&&(tmpBookConfig.flippingTime=.2>tmpBookConfig.flippingTime?.2:tmpBookConfig.flippingTime);tmpBookConfig.supportSerialsFlip=getConfigValue("supportSerialsFlip",!0);tmpBookConfig.retainBookCenter=getConfigValue("retainBookCenter",!0);tmpBookConfig.totalPagesCaption=getConfigValue("totalPagesCaption","");tmpBookConfig.pageNumberCaption=getConfigValue("pageNumberCaption","");tmpBookConfig.buttonsSortXML=
getConfigValue("buttonsSortXML",[]);tmpBookConfig.toolbarAlwaysShow=getConfigValue("toolbarAlwaysShow",!1);tmpBookConfig.searchbarAlwaysShowOnMobile=getConfigValue("searchbarAlwaysShowOnMobile",!1);"neat"===_get(htmlConfig,"phoneTemplate.name")&&(tmpBookConfig.searchbarAlwaysShowOnMobile=!1);isPhone()||isPad()||(tmpBookConfig.toolbarAlwaysShow=!0);tmpBookConfig.leftRightPnlShowOption=getConfigValue("leftRightPnlShowOption","").toLowerCase();tmpBookConfig.mobileLeftRightPnlShowOption=getConfigValue("mobileLeftRightPnlShowOption",
"").toLowerCase();tmpBookConfig.topMargin=getConfigValue("topMargin",10);tmpBookConfig.bottomMargin=getConfigValue("bottomMargin",10);tmpBookConfig.leftMargin=getConfigValue("leftMargin",10);tmpBookConfig.rightMargin=getConfigValue("rightMargin",10);tmpBookConfig.topMarginOnMobile=getConfigValue("topMarginOnMobile",10);tmpBookConfig.bottomMarginOnMobile=getConfigValue("bottomMarginOnMobile",10);tmpBookConfig.leftMarginOnMobile=getConfigValue("leftMarginOnMobile",10);tmpBookConfig.rightMarginOnMobile=
getConfigValue("rightMarginOnMobile",10);isPhone()||isPad()?(tmpBookConfig.topMargin=tmpBookConfig.topMarginOnMobile,tmpBookConfig.bottomMargin=tmpBookConfig.bottomMarginOnMobile,tmpBookConfig.leftMargin=tmpBookConfig.leftMarginOnMobile,tmpBookConfig.rightMargin=tmpBookConfig.rightMarginOnMobile,tmpBookConfig.phoneFlipShortcutSwitchButtonVisible=getConfigValue("phoneFlipShortcutSwitchButtonVisible",!1),tmpBookConfig.phoneFlipShortcutButton=getConfigValue("phoneFlipShortcutButton",!1),tmpBookConfig.searchbarAlwaysShowOnMobile&&
tmpBookConfig.toolbarAlwaysShow&&(tmpBookConfig.topMargin+=50)):tmpBookConfig.phoneFlipShortcutButton=!1;tmpBookConfig.visibleAreaLeft=parseFloat(getConfigValue("visibleAreaLeft","0%"));tmpBookConfig.visibleAreaTop=parseFloat(getConfigValue("visibleAreaTop","0%"));tmpBookConfig.visibleAreaRight=parseFloat(getConfigValue("visibleAreaRight","100%"));tmpBookConfig.visibleAreaBottom=parseFloat(getConfigValue("visibleAreaBottom","100%"));tmpBookConfig.visibleAreaLeft=isNaN(tmpBookConfig.visibleAreaLeft)?
"0%":tmpBookConfig.visibleAreaLeft;tmpBookConfig.visibleAreaTop=isNaN(tmpBookConfig.visibleAreaTop)?"0%":tmpBookConfig.visibleAreaTop;tmpBookConfig.visibleAreaRight=isNaN(tmpBookConfig.visibleAreaRight)?"100%":tmpBookConfig.visibleAreaRight;tmpBookConfig.visibleAreaBottom=isNaN(tmpBookConfig.visibleAreaBottom)?"100%":tmpBookConfig.visibleAreaBottom;tmpBookConfig.bleedAreaLeft=parseFloat(getConfigValue("bleedAreaLeft","0%"));tmpBookConfig.bleedAreaTop=parseFloat(getConfigValue("bleedAreaTop","0%"));
...
getConfigValue("largePath","files/large/");tmpBookConfig.thumbPath=getConfigValue("thumbPath","files/thumb/");tmpBookConfig.pageSpacing=getConfigValue("pageSpacing",10);tmpBookConfig.FlipStyle=getConfigValue("FlipStyle","flip");tmpBookConfig.FlipStyle=tmpBookConfig.FlipStyle.toLowerCase();tmpBookConfig.phoneFlipStyle=getConfigValue("phoneFlipStyle",void 0);(isPhone()||isPad())&&void 0!==tmpBookConfig.phoneFlipStyle&&(tmpBookConfig.FlipStyle=tmpBookConfig.phoneFlipStyle.toLowerCase());tmpBookConfig.autoDoublePage=
getConfigValue("autoDoublePage","auto");"docview"===tmpBookConfig.FlipStyle&&(tmpBookConfig.autoDoublePage="single");d=tmpBookConfig.autoDoublePage?tmpBookConfig.autoDoublePage.toLocaleLowerCase():"auto";"single"!=d&&"auto"!=d&&"double"!=d?getConfigValue("autoDoublePage",!0)?tmpBookConfig.showDoublePage="auto":tmpBookConfig.showDoublePage="single":tmpBookConfig.showDoublePage=d;tmpBookConfig.alwaysDoublePageOnMobile=getConfigValue("alwaysDoublePageOnMobile",!1);tmpBookConfig.upsideOnMobile=function(){return isPhone()||
isPad()?tmpBookConfig.alwaysDoublePageOnMobile&&window.innerHeight>window.innerWidth?!0:!1:!1};tmpBookConfig.autoSwitchWidePage=getConfigValue("autoSwitchWidePage",!0);tmpBookConfig.upsideOnMobile()&&"single"!=tmpBookConfig.showDoublePage&&(tmpBookConfig.showDoublePage="double");tmpBookConfig.QRPath=getConfigValue("QRPath","files/extfile/QRURL.png");tmpBookConfig.QRCode=getConfigValue("QRCode",!1);tmpBookConfig.MiniStyle=getConfigValue("MiniStyle",!0);tmpBookConfig.AnnotationButtonVisible=getConfigValue("AnnotationButtonVisible",
...
tmpBookConfig.bgSoundVol=Number.between(tmpBookConfig.bgSoundVol,0,100);tmpBookConfig.enablePageBack=getConfigValue("enablePageBack",!1);tmpBookConfig.userListPath=getConfigValue("userListPath","files/extfiles/users.js");tmpBookConfig.excludeFrontPages=getConfigValue("excludeFrontPages","");tmpBookConfig.isFlipPdf=getConfigValue("isFlipPdf",!1);tmpBookConfig.SingleModeBanFlipToLastPage=getConfigValue("SingleModeBanFlipToLastPage",!1);tmpBookConfig.isSingleBookFullWindowOnMobile=getConfigValue("isSingleBookFullWindowOnMobile",
!1);tmpBookConfig.showGotoButtonsAtFirst=getConfigValue("showGotoButtonsAtFirst",!1);0==tmpBookConfig.isFlipPdf&&void 0!=global.isFlipPdf&&(tmpBookConfig.isFlipPdf=isFlipPdf);tmpBookConfig.FlipSound=getConfigValue("FlipSound",!0);global.flipSoundIsPlaying=tmpBookConfig.FlipSound;tmpBookConfig.CurlingPageCorner=getConfigValue("CurlingPageCorner",!0);tmpBookConfig.BanFlipFromDirection=getConfigValue("BanFlipFromDirection",!1);tmpBookConfig.iconFontColor=getConfigValue("iconFontColor","#ffffff");try{void 0!=
global.staticAd&&1==staticAd.haveAd&&void 0==global.staticAd.adPosition&&("Chinese"==UserGroups&&(global.staticAd.adPosition=1),"English"==UserGroups&&(global.staticAd.adPosition=0)),void 0!=global.staticAd&&1==staticAd.haveAd&&0===parseInt(global.staticAd.adPosition)?tmpBookConfig.retainBookCenter=!1:tmpBookConfig.retainBookCenter=getConfigValue("retainBookCenter",!0)}catch(l){}tmpBookConfig.updateURLForPage=getConfigValue("updateURLForPage",!0);tmpBookConfig.borderColor=getConfigValue("borderColor",
"#572f0d");tmpBookConfig.outerCoverBorder=getConfigValue("outerCoverBorder",!1);tmpBookConfig.hardCoverBorderWidth=getConfigValue("hardCoverBorderWidth",0);tmpBookConfig.cornerRound=getConfigValue("cornerRound",0);tmpBookConfig.hardCoverBorderWidth=tmpBookConfig.HardPageEnable?Number.between(0,16,tmpBookConfig.hardCoverBorderWidth):0;tmpBookConfig.cornerRound=tmpBookConfig.HardPageEnable?Number.between(0,tmpBookConfig.hardCoverBorderWidth,tmpBookConfig.cornerRound):0;tmpBookConfig.coverTexture=getConfigValue("coverTexture",
"none");tmpBookConfig.passwardPrompt=getConfigValue("passwardPrompt","");tmpBookConfig.SlideshowAutoPlay=getConfigValue("SlideshowAutoPlay",!1);tmpBookConfig.SlideshowPlayInterval=getConfigValue("SlideshowPlayInterval",5);tmpBookConfig.productName=getConfigValue("productName","Flip HTML5");tmpBookConfig.homePage=getConfigValue("homePage","http://www.fliphtml5.com");global.productName=tmpBookConfig.productName||"Flip HTML5";global.homePage=tmpBookConfig.homePage||"http://www.fliphtml5.com";tmpBookConfig.backgroundPosition=
getConfigValue("backgroundPosition","Stretch");tmpBookConfig.restorePageVisible=getConfigValue("restorePageVisible",!1);tmpBookConfig.restorePageDuration=getConfigValue("restorePageDuration",86400);tmpBookConfig.toobarClear=getConfigValue("toobarClear",!1);tmpBookConfig.bottomToolBarAlpha=getConfigValue("bottomToolBarAlpha",1);tmpBookConfig.topToolBarAlpha=getConfigValue("topToolBarAlpha",1);tmpBookConfig.ToolBarAlpha=getConfigValue("ToolBarAlpha",1);tmpBookConfig.phoneSearchBarAlpha=getConfigValue("phoneSearchBarAlpha",
.8);!isPhone()&&!isPad()||["slide","docview","card"].includes(tmpBookConfig.FlipStyle.toLowerCase())||(tmpBookConfig.FlipStyle="flip");isBelowIE9()&&(tmpBookConfig.FlipStyle="slide");if(isPhone()||isPad()||"slide"==tmpBookConfig.FlipStyle.toLowerCase()&&"lite"==tmpBookConfig.ToolbarViewMode.toLowerCase())tmpBookConfig.flipshortcutbutton=!1;if("slide"==tmpBookConfig.FlipStyle&&"lite"==tmpBookConfig.ToolbarViewMode.toLowerCase()||isPhone()||isPad())tmpBookConfig.flipshortcutbutton=!1;if(global.videoList&&
1<=global.videoList.length)for(e=0;e<videoList.length;e++)videoList[e].id||(videoList[e].id=""),videoList[e].description||(videoList[e].description=""),videoList[e].thumbnail||(videoList[e].thumbnail=""),videoList[e].title||(videoList[e].title=""),videoList[e].type||(videoList[e].type="");try{window.localStorage||(tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.restorePageVisible=!1,global.pageEditor&&global.pageEditor.setting&&parseBool(global.pageEditor.setting.shoppingCartHTML)&&
(global.pageEditor.setting.shoppingCartHTML=!1))}catch(l){tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.restorePageVisible=!1,global.pageEditor&&global.pageEditor.setting&&parseBool(global.pageEditor.setting.shoppingCartHTML)&&(global.pageEditor.setting.shoppingCartHTML=!1)}0<=global.templeteName.indexOf("article")&&(isPhone()||isPad())&&(tmpBookConfig.BookMarkButtonVisible=!1);tmpBookConfig.OpenWindow=(getConfigValue("OpenWindow","_blank")+"").toLowerCase();
...
(tmpBookConfig.PhoneButtonVisible=!1);tmpBookConfig.PhoneButtonIcon=getConfigValue("PhoneButtonIcon","");tmpBookConfig.phoneNumber=getConfigValue("phoneNumber","");tmpBookConfig.aboutContactInfoTxt=getConfigValue("aboutContactInfoTxt","");tmpBookConfig.isEncryptionBook=getConfigValue("isEncryptionBook",!1);tmpBookConfig.useTheAliCloudChart=getConfigValue("useTheAliCloudChart",!1);tmpBookConfig.securityType=getConfigValue("securityType",0);tmpBookConfig.singlePasswordKey=getConfigValue("singlePasswordKey",
"");tmpBookConfig.singlePasswordMD5=getConfigValue("singlePasswordMD5","");1<=passwardType()&&(tmpBookConfig.useTheAliCloudChart=!1);tmpBookConfig.isEncryptionBook&&(tmpBookConfig.useTheAliCloudChart=!1);tmpBookConfig.useTheFliphtml5Service=getConfigValue("useTheFliphtml5Service",!1);if("online.fliphtml5.com"==document.domain||0<=tmpBookConfig.bookResourceBaseURL.indexOf("online.fliphtml5.com"))tmpBookConfig.useTheAliCloudChart=!1,tmpBookConfig.useTheFliphtml5Service=!0;tmpBookConfig.isEncryptionBook&&
(tmpBookConfig.useTheFliphtml5Service=!1);tmpBookConfig.OnlyOpenInWechat=getConfigValue("OnlyOpenInWechat",!1);tmpBookConfig.NoWechatSharing=getConfigValue("NoWechatSharing",!1);tmpBookConfig.WeChatShareButtonIcon=getConfigValue("WeChatShareButtonIcon","");tmpBookConfig.isShowAssistantPerson=getConfigValue("isShowAssistantPerson",!0);tmpBookConfig.OnlyOpenInIframe=getConfigValue("OnlyOpenInIframe",!1);tmpBookConfig.OnlyOpenInIframeInfo=getConfigValue("OnlyOpenInIframeInfo","Only open in iframe.");
tmpBookConfig.NoWechatSharing&&jQuery(document).ready(function(){window.setTimeout(function(){function l(){WeixinJSBridge.call("hideOptionMenu")}global.wx&&wx.hideOptionMenu();"undefined"==typeof WeixinJSBridge?document.addEventListener?document.addEventListener("WeixinJSBridgeReady",l,!1):document.attachEvent&&(document.attachEvent("WeixinJSBridgeReady",l),document.attachEvent("onWeixinJSBridgeReady",l)):l()},10)});tmpBookConfig.textClarityEnhancement=getConfigValue("textClarityEnhancement",0);tmpBookConfig.textSharpening=
getConfigValue("textSharpening",!0);if(_agent_.browser.firefox||_agent_.browser.opera||_agent_.browser.safari)tmpBookConfig.textSharpening=!1;tmpBookConfig.AboutDescription=tmpBookConfig.AboutDescription.replace(/\n/g,"<br/>");tmpBookConfig.AboutDescription=tmpBookConfig.AboutDescription.replace(/\r/g,"<br/>");checkBookmarkConfig();isBelowIE9()&&(tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.WeChatShareButtonVisible=!1);tmpBookConfig.useTheAliCloudChart&&
...
"Views";"Chinese"==UserGroups&&(global.aboutReadTimesCaptions="\u95c3\u5470\ue1f0\u5a06\u2103\u669f");tmpBookConfig.isNeat=getConfigValue("isNeat",!1);0<=window.location.hash.indexOf("isNeat")&&(tmpBookConfig.isNeat=!0);tmpBookConfig.phoneToolbarType=getConfigValue("phoneToolbarType","image").toLowerCase();tmpBookConfig.phoneIconNumber=getConfigValue("phoneIconNumber",6);tmpBookConfig.phoneIconNumber=Math.max(1,tmpBookConfig.phoneIconNumber);tmpBookConfig.showAdOnTop=getConfigValue("showAdOnTop",
!0);tmpBookConfig.bookPath=getConfigValue("bookPath",window.location.href);tmpBookConfig.bookPath=tmpBookConfig.bookPath.removeStartFrom("index.html");tmpBookConfig.bookPath=tmpBookConfig.bookPath.removeStartFrom("articles/");tmpBookConfig.bookPath=tmpBookConfig.bookPath.removeStartFrom("mobile/");tmpBookConfig.bookPath=tmpBookConfig.bookPath.removeStartFrom("?");tmpBookConfig.bookPath=tmpBookConfig.bookPath.removeStartFrom("#");"/"!=tmpBookConfig.bookPath.slice(-1)&&(tmpBookConfig.bookPath+="/");
tmpBookConfig.loadPreviewImage=!1;tmpBookConfig.removeLoad=!0;tmpBookConfig.showArticleDescription=getConfigValue("showArticleDescription",!1);tmpBookConfig.showArticlePageFlashes=getConfigValue("showArticlePageFlashes",!0);tmpBookConfig.articleListPath=getConfigValue("articleListPath","");tmpBookConfig.articleConfigPath=getConfigValue("articleConfigPath","");tmpBookConfig.bookArticleConfigPath=getConfigValue("bookArticleConfigPath","");tmpBookConfig.periodsConfigPath=getConfigValue("periodsConfigPath",
"");tmpBookConfig.userArticleConfigPath=getConfigValue("userArticleConfigPath","");checkURLValue();tmpBookConfig.pageEditorUrl=getConfigValue("pageEditorUrl","");tmpBookConfig.pageReaderUrl=getConfigValue("pageReaderUrl","");tmpBookConfig.pageSliderUrl=getConfigValue("pageSliderUrl","");tmpBookConfig.pageRestrictUrl=getConfigValue("pageRestrictUrl","");tmpBookConfig.restrictUrl=getConfigValue("restrictUrl","");tmpBookConfig.keyForPageTest=getConfigValue("keyForPageTest","");tmpBookConfig.bookOwnerInfo=
getConfigValue("bookOwnerInfo","");tmpBookConfig.Copyright=getConfigValue("Copyright","");tmpBookConfig.articleTitle=getConfigValue("articleTitle","");tmpBookConfig.articleTime=getConfigValue("articleTime","");tmpBookConfig.isMouseEnterToDisplayArticleTitle=getConfigValue("isMouseEnterToDisplayArticleTitle",!1);tmpBookConfig.delayToFlipFirst=getConfigValue("delayToFlipFirst",!1);tmpBookConfig.timeToFlipFirst=getConfigValue("timeToFlipFirst",10);tmpBookConfig.printBackgroundPosition=getConfigValue("printBackgroundPosition",
"fit");try{if(window.ignoreModuleArray&&window.ignoreModuleArray.bookConfig)for(e=0;e<window.ignoreModuleArray.bookConfig.length;e++)f=window.ignoreModuleArray.bookConfig[e],void 0!=tmpBookConfig[f]&&(tmpBookConfig[f]=!1)}catch(l){}checkFliphtml5PagesConfig();checkFlipStyleConfig();return"issuu"==tmpBookConfig.FlipStyle?k.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/issuubook.min.css"),3):k.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/flipbook.min.css"),3)}checkPageEditorConfig();recordError();g=
Module._getVerifyString();h=UTF8ToString(g);Module._free(g);eval(h);k.jumpToEnd()})};
...
case 3:c++,f.jumpTo(2)}})};function animateOnce(b,c,d,e,f,g){if(b&&c)if(void 0==d||0===d||isIE9())b.css(c),e&&e instanceof Function&&e();else{var h=!1;setAnimation(b,d,f,g);f=function(){1!=h&&(h=!0,setAnimation(b,0),e&&e instanceof Function&&e())};b.one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",f);window.setTimeout(f,5*d);b.css(c)}}
...
var VERSION_NAME="6.4.9",BUILD_DATE="2025060901",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},BrowserType={WEBKIT:1,
OPERA:1,MOZ:2,MS:3},Direction={left:"left",right:"right",top:"top",bottom:"bottom"},bookEvent={onCurrentPageIndexChanged:"BE_PIC",onCurrentPageIndexWillChange:"BE_PIWC",onNoNextPage:"BE_NNP",onNoPreviousPage:"BE_NPP"},PLUGIN_MAGNETICS="AbPIMagneticSlider",PLUGIN_ROTATE3D="AbPIRotationPhotoFor3D",PLUGIN_VIDEO1="VideoPlayerExemple01",PLUGIN_VIDEO2="VideoPlayerExemple02",PLUGIN_CLASSAUDIO="",KEY_CODE_ENTER=13,KEY_CODE_LEFT=37,KEY_CODE_UP=38,KEY_CODE_RIGHT=39,KEY_CODE_DOWN=40,KEY_CODE_HOME=36,KEY_CODE_END=
35,KEY_CODE_PAGEUP=33,KEY_CODE_PAGEDOWN=34,KEY_CODE_DELETE=46,KEY_CODE_F11=122,KEY_CODE_A=65,KEY_CODE_ESC=27,MOUSE_LEFT=1,MOUSE_MIDDLE=2,MOUSE_RIGHT=3,LOADING_WIDTH=30,LOADING_HEIGHT=30,COIL_PAGE_WIDTH=500,isTouchDevice=function(){navigator.userAgent.match(/mobile|tablet|ip(ad|hone|od)|android/i);return _agent_.browser.device==_agent_.browser.DEVICE_PHONE||isPad()};isTouch=isTouchDevice();var _event;
...
this.$parent.width();this.$parent.width();var d=c=b;this.hideSmallTab||("issuu"!=bookConfig.FlipStyle?(c=b/2,d=b/2):(b=flipBook.getCurrentPageIndex(),b=flipBook.getFitWHByIndex(b),c=b[0].x,d=b[1].x));this.leftBar.css({width:c+"px",left:"0px"});this.rightBar.css({width:d+"px",left:"auto",right:0});rightToLeft?(this.resizeItemsOfBar(this.rightBar,"left",1),this.resizeItemsOfBar(this.leftBar,"left",-1)):(this.resizeItemsOfBar(this.leftBar,"left",1),this.resizeItemsOfBar(this.rightBar,"left",-1));!isPad()&&
!isPhone()&&!this.isRefresh&&this.bookmarkList.count()&&75>BookInfo.top()-templateArea.getTopHeight()&&(bookConfig.topMargin=75,this.isRefresh=!0)}this.setScale(1,1,0,0,1,1,0,0)},resizeItemsOfBar:function(b,c,d){for(var e=b.width(),f=0,g=0,h=0;h<this.bookmarkList.count();h++){var k=this.bookmarkList.item(h),l=this.bookmarkPool.getBookmarkItem(k);l.$parent==b&&(f=l.getWidth()+22,g+=l.getWidth()+22)}g+=2;h=b.children().length;Number.between(Math.floor((e-4-f)/(h-1)),10,65);var n=f=0,p=0;for(h=0;h<this.bookmarkList.count();h++)if(k=
this.bookmarkList.item(h),l=this.bookmarkPool.getBookmarkItem(k),l.$parent==b){var t={};g>=e?(0<p&&(n=l.getWidth()>2*p/3?n+(p/2+10):n+(p-l.getWidth()/2+10)),t[c]=n,p=l.getWidth()):(t[c]=f,f+=l.getWidth()+22);t["z-index"]=d*k.pageIndex;l.setPosition(t)}},show:function(){this.visible=!0;this.refresh()},hide:function(){this.hideLeftBar();this.hideRightBar();this.visible=!1},showLeftBar:function(){0<this.leftBar.children().length?this.leftBar.css("display","block"):this.leftBar.css("display","none")},
hideLeftBar:function(){this.leftBar.css("display","none")},showRightBar:function(){0<this.rightBar.children().length?this.rightBar.css("display","block"):this.rightBar.css("display","none")},hideRightBar:function(){this.rightBar.css("display","none")},doSetMovingScale:function(b,c,d,e,f,g,h){this.setScale(1,g,h)},setScale:function(b,c,d,e,f,g,h,k){void 0==c&&(c=1);void 0==d&&(d=0);void 0==g&&(g=1);void 0==h&&(h=0);this.onSideEdge?(f=this.$parent.height(),c=transformCSS({scale:{x:c,y:1},tran:{x:d,
y:(1-c)*f/2},rotate:-90}),g=transformCSS({scale:{x:g,y:1},tran:{x:h,y:(1-g)*f/2},rotate:90})):(c=transformCSS({scale:{x:b,y:1},tran:{x:d,y:e},origin:{x:0,y:100}}),g=transformCSS({scale:{x:f,y:1},tran:{x:h,y:k},origin:{x:100,y:100}}));0<this.leftBar.children().length&&this.leftBar.css(c);0<this.rightBar.children().length&&this.rightBar.css(g);this.scale=1}});
