...
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function c(p){return p instanceof h?p:new h(function(z,v){z(p)})}if(a&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return a;b.prototype.asyncExecute=function(p){if(null==this.batch_){this.batch_=[];var z=this;this.asyncExecuteFunction(function(){z.executeBatch_()})}this.batch_.push(p)};
var g=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(p){g(p,0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var p=this.batch_;this.batch_=[];for(var z=0;z<p.length;++z){var v=p[z];p[z]=null;try{v()}catch(B){this.asyncThrow_(B)}}}this.batch_=null};b.prototype.asyncThrow_=function(p){this.asyncExecuteFunction(function(){throw p;})};var h=function(p){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var z=this.createResolveAndReject_();
try{p(z.resolve,z.reject)}catch(v){z.reject(v)}};h.prototype.createResolveAndReject_=function(){function p(B){return function(D){v||(v=!0,B.call(z,D))}}var z=this,v=!1;return{resolve:p(this.resolveTo_),reject:p(this.reject_)}};h.prototype.resolveTo_=function(p){if(p===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(p instanceof h)this.settleSameAsPromise_(p);else{a:switch(typeof p){case "object":var z=null!=p;break a;case "function":z=!0;break a;default:z=!1}z?this.resolveToNonPromiseObj_(p):
this.fulfill_(p)}};h.prototype.resolveToNonPromiseObj_=function(p){var z=void 0;try{z=p.then}catch(v){this.reject_(v);return}"function"==typeof z?this.settleSameAsThenable_(z,p):this.fulfill_(p)};h.prototype.reject_=function(p){this.settle_(2,p)};h.prototype.fulfill_=function(p){this.settle_(1,p)};h.prototype.settle_=function(p,z){if(0!=this.state_)throw Error("Cannot settle("+p+", "+z+"): Promise already settled in state"+this.state_);this.state_=p;this.result_=z;2===this.state_&&this.scheduleUnhandledRejectionCheck_();
this.executeOnSettledCallbacks_()};h.prototype.scheduleUnhandledRejectionCheck_=function(){var p=this;g(function(){if(p.notifyUnhandledRejection_()){var z=$jscomp.global.console;"undefined"!==typeof z&&z.error(p.result_)}},1)};h.prototype.notifyUnhandledRejection_=function(){if(this.isRejectionHandled_)return!1;var p=$jscomp.global.CustomEvent,z=$jscomp.global.Event,v=$jscomp.global.dispatchEvent;if("undefined"===typeof v)return!0;"function"===typeof p?p=new p("unhandledrejection",{cancelable:!0}):
"function"===typeof z?p=new z("unhandledrejection",{cancelable:!0}):(p=$jscomp.global.document.createEvent("CustomEvent"),p.initCustomEvent("unhandledrejection",!1,!0,p));p.promise=this;p.reason=this.result_;return v(p)};h.prototype.executeOnSettledCallbacks_=function(){if(null!=this.onSettledCallbacks_){for(var p=0;p<this.onSettledCallbacks_.length;++p)n.asyncExecute(this.onSettledCallbacks_[p]);this.onSettledCallbacks_=null}};var n=new b;h.prototype.settleSameAsPromise_=function(p){var z=this.createResolveAndReject_();
p.callWhenSettled_(z.resolve,z.reject)};h.prototype.settleSameAsThenable_=function(p,z){var v=this.createResolveAndReject_();try{p.call(z,v.resolve,v.reject)}catch(B){v.reject(B)}};h.prototype.then=function(p,z){function v(Q,ca){return"function"==typeof Q?function(V){try{B(Q(V))}catch(da){D(da)}}:ca}var B,D,M=new h(function(Q,ca){B=Q;D=ca});this.callWhenSettled_(v(p,B),v(z,D));return M};h.prototype.catch=function(p){return this.then(void 0,p)};h.prototype.callWhenSettled_=function(p,z){function v(){switch(B.state_){case 1:p(B.result_);
break;case 2:z(B.result_);break;default:throw Error("Unexpected state: "+B.state_);}}var B=this;null==this.onSettledCallbacks_?n.asyncExecute(v):this.onSettledCallbacks_.push(v);this.isRejectionHandled_=!0};h.resolve=c;h.reject=function(p){return new h(function(z,v){v(p)})};h.race=function(p){return new h(function(z,v){for(var B=$jscomp.makeIterator(p),D=B.next();!D.done;D=B.next())c(D.value).callWhenSettled_(z,v)})};h.all=function(p){var z=$jscomp.makeIterator(p),v=z.next();return v.done?c([]):new h(function(B,
D){function M(V){return function(da){Q[V]=da;ca--;0==ca&&B(Q)}}var Q=[],ca=0;do Q.push(void 0),ca++,c(v.value).callWhenSettled_(M(Q.length-1),D),v=z.next();while(!v.done)})};return h},"es6","es3");$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};$jscomp.assign=$jscomp.TRUST_ES6_POLYFILLS&&"function"==typeof Object.assign?Object.assign:function(a,b){for(var c=1;c<arguments.length;c++){var g=arguments[c];if(g)for(var h in g)$jscomp.owns(g,h)&&(a[h]=g[h])}return a};
...
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var B=Object.seal({}),D=Object.seal({}),M=new a([[B,2],[D,3]]);if(2!=M.get(B)||3!=M.get(D))return!1;M.delete(B);M.set(D,4);return!M.has(B)&&4==M.get(D)}catch(Q){return!1}}function c(){}function g(B){var D=typeof B;return"object"===D&&null!==B||"function"===D}function h(B){if(!$jscomp.owns(B,p)){var D=new c;$jscomp.defineProperty(B,p,{value:D})}}function n(B){if(!$jscomp.ISOLATE_POLYFILLS){var D=Object[B];D&&(Object[B]=
function(M){if(M instanceof c)return M;Object.isExtensible(M)&&h(M);return D(M)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var p="$jscomp_hidden_"+Math.random();n("freeze");n("preventExtensions");n("seal");var z=0,v=function(B){this.id_=(z+=Math.random()+1).toString();if(B){B=$jscomp.makeIterator(B);for(var D;!(D=B.next()).done;)D=D.value,this.set(D[0],D[1])}};v.prototype.set=function(B,D){if(!g(B))throw Error("Invalid WeakMap key");
h(B);if(!$jscomp.owns(B,p))throw Error("WeakMap key fail: "+B);B[p][this.id_]=D;return this};v.prototype.get=function(B){return g(B)&&$jscomp.owns(B,p)?B[p][this.id_]:void 0};v.prototype.has=function(B){return g(B)&&$jscomp.owns(B,p)&&$jscomp.owns(B[p],this.id_)};v.prototype.delete=function(B){return g(B)&&$jscomp.owns(B,p)&&$jscomp.owns(B[p],this.id_)?delete B[p][this.id_]:!1};return v},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(a){function b(){if($jscomp.ASSUME_NO_NATIVE_MAP||!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var v=Object.seal({x:4}),B=new a($jscomp.makeIterator([[v,"s"]]));if("s"!=B.get(v)||1!=B.size||B.get({x:4})||B.set({x:4},"t")!=B||2!=B.size)return!1;var D=B.entries(),M=D.next();if(M.done||M.value[0]!=v||"s"!=M.value[1])return!1;M=D.next();return M.done||4!=M.value[0].x||"t"!=M.value[1]||!D.next().done?!1:!0}catch(Q){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var c=new WeakMap,g=function(v){this.data_={};this.head_=p();this.size=0;if(v){v=$jscomp.makeIterator(v);for(var B;!(B=v.next()).done;)B=B.value,this.set(B[0],B[1])}};g.prototype.set=function(v,B){v=0===v?0:v;var D=h(this,v);D.list||(D.list=this.data_[D.id]=[]);D.entry?D.entry.value=B:(D.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:v,value:B},D.list.push(D.entry),
this.head_.previous.next=D.entry,this.head_.previous=D.entry,this.size++);return this};g.prototype.delete=function(v){v=h(this,v);return v.entry&&v.list?(v.list.splice(v.index,1),v.list.length||delete this.data_[v.id],v.entry.previous.next=v.entry.next,v.entry.next.previous=v.entry.previous,v.entry.head=null,this.size--,!0):!1};g.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=p();this.size=0};g.prototype.has=function(v){return!!h(this,v).entry};g.prototype.get=function(v){return(v=
h(this,v).entry)&&v.value};g.prototype.entries=function(){return n(this,function(v){return[v.key,v.value]})};g.prototype.keys=function(){return n(this,function(v){return v.key})};g.prototype.values=function(){return n(this,function(v){return v.value})};g.prototype.forEach=function(v,B){for(var D=this.entries(),M;!(M=D.next()).done;)M=M.value,v.call(B,M[1],M[0],this)};g.prototype[Symbol.iterator]=g.prototype.entries;var h=function(v,B){var D=B&&typeof B;"object"==D||"function"==D?c.has(B)?D=c.get(B):
(D=""+ ++z,c.set(B,D)):D="p_"+B;var M=v.data_[D];if(M&&$jscomp.owns(v.data_,D))for(v=0;v<M.length;v++){var Q=M[v];if(B!==B&&Q.key!==Q.key||B===Q.key)return{id:D,list:M,index:v,entry:Q}}return{id:D,list:M,index:-1,entry:void 0}},n=function(v,B){var D=v.head_;return $jscomp.iteratorPrototype(function(){if(D){for(;D.head!=v.head_;)D=D.previous;for(;D.next!=D.head;)return D=D.next,{done:!1,value:B(D)};D=null}return{done:!0,value:void 0}})},p=function(){var v={};return v.previous=v.next=v.head=v},z=0;
...
function z(d){if(!d)throw Error("Assertion Failed");}function v(d){ea.setImmediate?setImmediate(d):setTimeout(d,0)}function B(d,e){return d.reduce(function(f,k,l){l=e(k,l);return l&&(f[l[0]]=l[1]),f},{})}function D(d,e){if(ua.call(d,e))return d[e];if(!e)return d;if("string"!=typeof e){for(var f=[],k=0,l=e.length;k<l;++k){var m=D(d,e[k]);f.push(m)}return f}f=e.indexOf(".");if(-1!==f)return d=d[e.substr(0,f)],void 0===d?void 0:D(d,e.substr(f+1))}function M(d,e,f){if(d&&void 0!==e&&!("isFrozen"in Object&&
...
this._listeners=[];this.onuncatched=ba;this._lib=!1;var k=this._PSD=O;if(wa&&(this._stackHolder=na(),this._prev=null,this._numPrev=0),"function"!=typeof d){if(d!==$a)throw new TypeError("Not a function");return this._state=e,this._value=f,void(!1===this._state&&Mb(this,this._value))}this._value=this._state=null;++k.ref;(function t(m,q){try{q(function(w){if(null===m._state){if(w===m)throw new TypeError("A promise cannot be resolved with itself.");var u=m._lib&&ab();w&&"function"==typeof w.then?t(m,
function(x,r){w instanceof N?w._then(x,r):w.then(x,r)}):(m._state=!0,m._value=w,wc(m));u&&bb()}},Mb.bind(null,m))}catch(w){Mb(m,w)}})(this,d)}function xc(d,e,f,k,l){this.onFulfilled="function"==typeof d?d:null;this.onRejected="function"==typeof e?e:null;this.resolve=f;this.reject=k;this.psd=l}function Mb(d,e){var f;nb.push(e);null===d._state&&(f=d._lib&&ab(),e=Nb(e),d._state=!1,d._value=e,wa&&null!==e&&"object"==typeof e&&!e._promise&&function(k,l,m){try{k.apply(null,m)}catch(q){l&&l(q)}}(function(){var k=
...
delete (e=ca(e))[d],e}}function ha(){}function eb(d){function e(q,t){if(t){for(var w=arguments.length,u=Array(w-1);--w;)u[w-1]=arguments[w];return k[q].subscribe.apply(null,u),d}if("string"==typeof q)return k[q]}function f(q,t,w){if("object"!=typeof q){t=t||dd;var u={subscribers:[],fire:w=w||ba,subscribe:function(x){-1===u.subscribers.indexOf(x)&&(u.subscribers.push(x),u.fire=t(u.fire,x))},unsubscribe:function(x){u.subscribers=u.subscribers.filter(function(r){return r!==x});u.fire=u.subscribers.reduce(t,
w)}};return k[q]=e[q]=u}ja(q).forEach(function(x){var r=q[x];if(pa(r))f(x,q[x][0],q[x][1]);else{if("asap"!==r)throw new S.InvalidArgument("Invalid event config");var C=f(x,Za,function(){for(var y=arguments.length,A=Array(y);y--;)A[y]=arguments[y];C.subscribers.forEach(function(G){v(function(){G.apply(null,A)})})})}})}var k={};e.addEventType=f;for(var l=1,m=arguments.length;l<m;++l)f(arguments[l]);return e}function fb(d,e){return h(e).from({prototype:d}),e}function Ta(d,e){return!(d.filter||d.algorithm||
...
query:{index:k,range:d.range}})}function Bb(d,e,f,k){var l=d.replayFilter?Ka(d.filter,d.replayFilter()):d.filter;if(d.or){var m={},q=function(t,w,u){var x,r;l&&!l(w,u,function(C){return w.stop(C)},function(C){return w.fail(C)})||("[object ArrayBuffer]"===(r=""+(x=w.primaryKey))&&(r=""+new Uint8Array(x)),ua.call(m,r)||(m[r]=!0,e(t,w,u)))};return Promise.all([d.or._iterate(q,f),Fc(Ec(d,k,f),d.algorithm,q,!d.keysOnly&&d.valueMapper)])}return Fc(Ec(d,k,f),Ka(d.algorithm,l),e,!d.keysOnly&&d.valueMapper)}
function Fc(d,e,f,k){var l=fa(k?function(m,q,t){return f(k(m),q,t)}:f);return d.then(function(m){if(m)return m.start(function(){var q=function(){return m.continue()};e&&!e(m,function(t){return q=t},function(t){m.stop(t);q=ba},function(t){m.fail(t);q=ba})||l(m.value,m,function(t){return q=t});q()})})}function ra(d,e){try{var f=Gc(d),k=Gc(e);if(f!==k)return"Array"===f?1:"Array"===k?-1:"binary"===f?1:"binary"===k?-1:"string"===f?1:"string"===k?-1:"Date"===f?1:"Date"!==k?NaN:-1;switch(f){case "number":case "Date":case "string":return e<
d?1:d<e?-1:0;case "binary":return function(l,m){for(var q=l.length,t=m.length,w=q<t?q:t,u=0;u<w;++u)if(l[u]!==m[u])return l[u]<m[u]?-1:1;return q===t?0:q<t?-1:1}(Hc(d),Hc(e));case "Array":return function(l,m){for(var q=l.length,t=m.length,w=q<t?q:t,u=0;u<w;++u){var x=ra(l[u],m[u]);if(0!==x)return x}return q===t?0:q<t?-1:1}(d,e)}}catch(l){}return NaN}function Gc(d){var e=typeof d;if("object"!=e)return e;if(ArrayBuffer.isView(d))return"binary";d=Yb.call(d).slice(8,-1);return"ArrayBuffer"===d?"binary":
d}function Hc(d){return d instanceof Uint8Array?d:ArrayBuffer.isView(d)?new Uint8Array(d.buffer,d.byteOffset,d.byteLength):new Uint8Array(d)}function Z(){}function id(d,e){return d<e?-1:d===e?0:1}function jd(d,e){return e<d?-1:d===e?0:1}function va(d,e,f){d=d instanceof Ic?new d.Collection(d):d;return d._ctx.error=new (f||TypeError)(e),d}function Ua(d){return(new d.Collection(d,function(){return{type:1,lower:"",upper:""}})).limit(0)}function Cb(d,e,f,k){function l(A){m="next"===A?function(F){return F.toUpperCase()}:
function(F){return F.toLowerCase()};q="next"===A?function(F){return F.toLowerCase()}:function(F){return F.toUpperCase()};t="next"===A?id:jd;var G=f.map(function(F){return{lower:q(F),upper:m(F)}}).sort(function(F,E){return t(F.lower,E.lower)});w=G.map(function(F){return F.upper});u=G.map(function(F){return F.lower});r="next"===(x=A)?"":k}var m,q,t,w,u,x,r,C=f.length;if(!f.every(function(A){return"string"==typeof A}))return va(d,"String expected.");l("next");d=new d.Collection(d,function(){return Fa(w[0],
u[C-1]+k)});d._ondirectionchange=function(A){l(A)};var y=0;return d._addAlgorithm(function(A,G,F){var E=A.key;if("string"!=typeof E)return!1;var H=q(E);if(e(H,u,y))return!0;for(var I=null,J=y;J<C;++J){var K=function(L,P,R,W,qa,ka){for(var T=Math.min(L.length,W.length),U=-1,X=0;X<T;++X){var Va=P[X];if(Va!==W[X])return 0>qa(L[X],R[X])?L.substr(0,X)+R[X]+R.substr(X+1):0>qa(L[X],W[X])?L.substr(0,X)+W[X]+R.substr(X+1):0<=U?L.substr(0,U)+P[U]+R.substr(U+1):null;0>qa(L[X],Va)&&(U=X)}return T<W.length&&"next"===
ka?L+R.substr(L.length):T<L.length&&"prev"===ka?L.substr(0,R.length):0>U?null:L.substr(0,U)+W[U]+R.substr(U+1)}(E,H,w[J],u[J],t,x);null===K&&null===I?y=J+1:(null===I||0<t(I,K))&&(I=K)}return G(null!==I?function(){A.continue(I+r)}:F),!1}),d}function Fa(d,e,f,k){return{type:2,lower:d,upper:e,lowerOpen:f,upperOpen:k}}function ma(){}function xa(d){return fa(function(e){return gb(e),d(e.target.error),!1})}function gb(d){d.stopPropagation&&d.stopPropagation();d.preventDefault&&d.preventDefault()}function ya(){}
function Zb(d,e,f,k,l,m,q){return{name:d,keyPath:e,unique:f,multi:k,auto:l,compound:m,src:(f&&!q?"&":"")+(k?"*":"")+(l?"++":"")+Jc(e)}}function Jc(d){return"string"==typeof d?d:d?"["+[].join.call(d,"+")+"]":""}function Kc(d,e,f){return{name:d,primKey:e,indexes:f,mappedClass:null,idxByName:B(f,function(k){return[k.name,k]})}}function $b(d){return null==d?function(){}:"string"==typeof d?1===(e=d).split(".").length?function(f){return f[e]}:function(f){return D(f,e)}:function(f){return D(f,d)};var e}
function hb(d){return null==d?":id":"string"==typeof d?d:"["+d.join("+")+"]"}function kd(d,e,f){function k(u){if(3===u.type)return null;if(4===u.type)throw Error("Cannot convert never type to IDBKeyRange");var x=u.lower,r=u.upper,C=u.lowerOpen;u=u.upperOpen;return void 0===x?void 0===r?null:e.upperBound(r,!!u):void 0===r?e.lowerBound(x,!!C):e.bound(x,r,!!C,!!u)}var l,m,q=(l=f,m=[].slice.call(d.objectStoreNames),{schema:{name:d.name,tables:m.map(function(u){return l.objectStore(u)}).map(function(u){var x=
u.keyPath,r=u.autoIncrement,C=pa(x),y={};r={name:u.name,primaryKey:{name:null,isPrimaryKey:!0,outbound:null==x,compound:C,keyPath:x,autoIncrement:r,unique:!0,extractKey:$b(x)},indexes:[].slice.call(u.indexNames).map(function(A){return u.index(A)}).map(function(A){var G=A.name,F=A.unique,E=A.multiEntry;A=A.keyPath;E={name:G,compound:pa(A),keyPath:A,unique:F,multiEntry:E,extractKey:$b(A)};return y[hb(A)]=E}),getIndexByKeyPath:function(A){return y[hb(A)]}};return y[":id"]=r.primaryKey,null!=x&&(y[hb(x)]=
r.primaryKey),r})},hasGetAll:0<m.length&&"getAll"in l.objectStore(m[0])&&!("undefined"!=typeof navigator&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&604>[].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1])});f=q.schema;var t=q.hasGetAll;q=f.tables.map(function(u){var x=u.name;return{name:x,schema:u,mutate:function(r){var C=r.trans,y=r.type,A=r.keys,G=r.values,F=r.range;return new Promise(function(E,H){function I(U){++ka;gb(U)}function J(U){U=U.target.result;
W.forEach(function(X,Va){return null!=X.error&&(qa[Va]=X.error)});E({numFailures:ka,failures:qa,results:"delete"===y?A:W.map(function(X){return X.result}),lastResult:U})}E=fa(E);H=C.objectStore(x);var K=null==H.keyPath,L="put"===y||"add"===y;if(!L&&"delete"!==y&&"deleteRange"!==y)throw Error("Invalid operation type: "+y);var P,R=(A||G||{length:1}).length;if(A&&G&&A.length!==G.length)throw Error("Given keys array must have same length as given values array.");if(0===R)return E({numFailures:0,failures:{},
results:[],lastResult:void 0});var W=[],qa=[],ka=0;if("deleteRange"===y){if(4===F.type)return E({numFailures:ka,failures:qa,results:[],lastResult:void 0});3===F.type?W.push(P=H.clear()):W.push(P=H.delete(k(F)))}else{K=L?K?[G,A]:[G,null]:[A,null];var T=K[0];K=K[1];if(L)for(L=0;L<R;++L)W.push(P=K&&void 0!==K[L]?H[y](T[L],K[L]):H[y](T[L])),P.onerror=I;else for(L=0;L<R;++L)W.push(P=H[y](T[L])),P.onerror=I}P.onerror=function(U){I(U);J(U)};P.onsuccess=J})},getMany:function(r){var C=r.trans,y=r.keys;return new Promise(function(A,
G){A=fa(A);var F,E=C.objectStore(x),H=y.length,I=Array(H),J=0,K=0,L=function(R){R=R.target;I[R._pos]=R.result;++K===J&&A(I)};G=xa(G);for(var P=0;P<H;++P)null!=y[P]&&((F=E.get(y[P]))._pos=P,F.onsuccess=L,F.onerror=G,++J);0===J&&A(I)})},get:function(r){var C=r.trans,y=r.key;return new Promise(function(A,G){A=fa(A);var F=C.objectStore(x).get(y);F.onsuccess=function(E){return A(E.target.result)};F.onerror=xa(G)})},query:function(r){return new Promise(function(C,y){C=fa(C);var A,G,F,E=r.trans,H=r.values,
I=r.limit,J=r.query,K=I===1/0?void 0:I,L=J.index;J=J.range;E=E.objectStore(x);L=L.isPrimaryKey?E:E.index(L.name);J=k(J);if(0===I)return C({result:[]});t?((K=H?L.getAll(J,K):L.getAllKeys(J,K)).onsuccess=function(P){return C({result:P.target.result})},K.onerror=xa(y)):(A=0,G=!H&&"openKeyCursor"in L?L.openKeyCursor(J):L.openCursor(J),F=[],G.onsuccess=function(P){return(P=G.result)?(F.push(H?P.value:P.primaryKey),++A===I?C({result:F}):void P.continue()):C({result:F})},G.onerror=xa(y))})},openCursor:function(r){var C=
r.trans,y=r.values,A=r.query,G=r.reverse,F=r.unique;return new Promise(function(E,H){E=fa(E);var I=A.index,J=A.range,K=C.objectStore(x);K=I.isPrimaryKey?K:K.index(I.name);I=G?F?"prevunique":"prev":F?"nextunique":"next";var L=!y&&"openKeyCursor"in K?K.openKeyCursor(k(J),I):K.openCursor(k(J),I);L.onerror=xa(H);L.onsuccess=fa(function(P){var R,W,qa,ka,T=L.result;T?(T.___id=++ld,T.done=!1,R=T.continue.bind(T),W=(W=T.continuePrimaryKey)&&W.bind(T),qa=T.advance.bind(T),ka=function(){throw Error("Cursor not stopped");
...
T.continue=T.continuePrimaryKey=T.advance=ka;Wa(md)}});return L.onsuccess=fa(function(Wa){L.onsuccess=X;X()}),T.continue=R,T.continuePrimaryKey=W,T.advance=qa,X(),Va},E(T)):E(null)},H)})},count:function(r){var C=r.query,y=r.trans,A=C.index,G=C.range;return new Promise(function(F,E){var H=y.objectStore(x),I=A.isPrimaryKey?H:H.index(A.name);I=(H=k(G))?I.count(H):I.count();I.onsuccess=fa(function(J){return F(J.target.result)});I.onerror=xa(E)})}}});var w={};return q.forEach(function(u){return w[u.name]=
u}),{stack:"dbcore",transaction:d.transaction.bind(d),table:function(u){if(!w[u])throw Error("Table '"+u+"' not found");return w[u]},MIN_KEY:-1/0,MAX_KEY:ib(e),schema:f}}function nd(d,e,f,k){var l=f.IDBKeyRange;return f.indexedDB,{dbcore:(k=kd(e,l,k),d.dbcore.reduce(function(m,q){q=q.create;return Y(Y({},m),q(m))},k))}}function ac(d,e){var f=d._novip;d=e.db;e=nd(f._middlewares,d,f._deps,e);f.core=e.dbcore;f.tables.forEach(function(k){var l=k.name;f.core.schema.tables.some(function(m){return m.name===
l})&&(k.core=f.core.table(l),f[l]instanceof f.Table&&(f[l].core=k.core))})}function Db(d,e,f,k){var l=d._novip;f.forEach(function(m){var q=k[m];e.forEach(function(t){var w=n(t,m);(!w||"value"in w&&void 0===w.value)&&(t===l.Transaction.prototype||t instanceof l.Transaction?g(t,m,{get:function(){return this.table(m)},set:function(u){tc(this,m,{value:u,writable:!0,configurable:!0,enumerable:!0})}}):t[m]=new l.Table(m,q))})})}function bc(d,e){var f=d._novip;e.forEach(function(k){for(var l in k)k[l]instanceof
f.Table&&delete k[l]})}function od(d,e){return d._cfg.version-e._cfg.version}function pd(d,e,f,k){var l=d._dbSchema,m=d._createTransaction("readwrite",d._storeNames,l);m.create(f);m._completion.catch(k);var q=m._reject.bind(m),t=O.transless||O;Ea(function(){var w,u,x,r,C;O.trans=m;O.transless=t;0===e?(ja(l).forEach(function(y){cc(f,y,l[y].primKey,l[y].indexes)}),ac(d,f),N.follow(function(){return d.on.populate.fire(m)}).catch(q)):(u=(w=d)._novip,x=[],w=u._versions,r=u._dbSchema=dc(0,u.idbdb,f),C=
!1,w.filter(function(y){return y._cfg.version>=e}).forEach(function(y){x.push(function(){var A=r,G=y._cfg.dbschema;ec(u,A,f);ec(u,G,f);r=u._dbSchema=G;var F=Mc(A,G);F.add.forEach(function(K){cc(f,K[0],K[1].primKey,K[1].indexes)});F.change.forEach(function(K){if(K.recreate)throw new S.Upgrade("Not yet support for changing primary key");var L=f.objectStore(K.name);K.add.forEach(function(P){return fc(L,P)});K.change.forEach(function(P){L.deleteIndex(P.name);fc(L,P)});K.del.forEach(function(P){return L.deleteIndex(P)})});
var E=y._cfg.contentUpgrade;if(E&&y._cfg.version>e){ac(u,f);m._memoizedTables={};C=!0;var H=Q(G);F.del.forEach(function(K){H[K]=A[K]});bc(u,[u.Transaction.prototype]);Db(u,[u.Transaction.prototype],ja(H),H);m.schema=H;var I,J=gc(E);J&&Sa();F=N.follow(function(){var K;(I=E(m))&&J&&(K=Aa.bind(null,null),I.then(K,K))});return I&&"function"==typeof I.then?N.resolve(I):F.then(function(){return I})}});x.push(function(A){var G;C&&qd||(G=y._cfg.dbschema,[].slice.call(A.db.objectStoreNames).forEach(function(F){return null==
G[F]&&A.db.deleteObjectStore(F)}));bc(u,[u.Transaction.prototype]);Db(u,[u.Transaction.prototype],u._storeNames,u._dbSchema);m.schema=u._dbSchema})}),function A(){return x.length?N.resolve(x.shift()(m.idbtrans)).then(A):N.resolve()}().then(function(){var A;ja(A=r).forEach(function(G){f.db.objectStoreNames.contains(G)||cc(f,G,A[G].primKey,A[G].indexes)})}).catch(q))})}function Mc(d,e){var f,k={del:[],add:[],change:[]};for(f in d)e[f]||k.del.push(f);for(f in e){var l=d[f],m=e[f];if(l){var q={name:f,
def:m,recreate:!1,del:[],add:[],change:[]};if(""+(l.primKey.keyPath||"")!=""+(m.primKey.keyPath||"")||l.primKey.auto!==m.primKey.auto&&!Eb)q.recreate=!0,k.change.push(q);else{l=l.idxByName;m=m.idxByName;var t=void 0;for(t in l)m[t]||q.del.push(t);for(t in m){var w=l[t],u=m[t];w?w.src!==u.src&&q.change.push(u):q.add.push(u)}(0<q.del.length||0<q.add.length||0<q.change.length)&&k.change.push(q)}}else k.add.push([f,m])}return k}function cc(d,e,f,k){var l=d.db.createObjectStore(e,f.keyPath?{keyPath:f.keyPath,
autoIncrement:f.auto}:{autoIncrement:f.auto});return k.forEach(function(m){return fc(l,m)}),l}function fc(d,e){d.createIndex(e.name,e.keyPath,{unique:e.unique,multiEntry:e.multi})}function dc(d,e,f){var k={};return Fb.call(e.objectStoreNames,0,void 0).forEach(function(l){for(var m=f.objectStore(l),q=Zb(Jc(x=m.keyPath),x||"",!1,!1,!!m.autoIncrement,x&&"string"!=typeof x,!0),t=[],w=0;w<m.indexNames.length;++w){var u=m.index(m.indexNames[w]),x=u.keyPath;u=Zb(u.name,x,!!u.unique,!!u.multiEntry,!1,x&&
"string"!=typeof x,!1);t.push(u)}k[l]=Kc(l,q,t)}),k}function ec(d,e,f){d=d._novip;for(var k=f.db.objectStoreNames,l=0;l<k.length;++l){var m=k[l],q=f.objectStore(m);d._hasGetAll="getAll"in q;for(var t=0;t<q.indexNames.length;++t){var w=q.indexNames[t],u=q.index(w).keyPath,x="string"==typeof u?u:"["+Fb.call(u,void 0,void 0).join("+")+"]";!e[m]||(u=e[m].idxByName[x])&&(u.name=w,delete e[m].idxByName[x],e[m].idxByName[w]=u)}}"undefined"!=typeof navigator&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&
...
}var f=d._state,k=d._deps.indexedDB;if(f.isBeingOpened||d.idbdb)return f.dbReadyPromise.then(function(){return f.dbOpenError?la(f.dbOpenError):d});wa&&(f.openCanceller._stackHolder=na());f.isBeingOpened=!0;f.dbOpenError=null;f.openComplete=!1;var l=f.openCanceller,m,q=f.dbReadyResolve,t=null,w=!1;return N.race([l,("undefined"==typeof navigator?N.resolve():!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent)&&indexedDB.databases?(new Promise(function(u){function x(){return indexedDB.databases().finally(u)}
m=setInterval(x,100);x()})).finally(function(){return clearInterval(m)}):Promise.resolve()).then(function(){return new N(function(u,x){if(e(),!k)throw new S.MissingAPI;var r=d.name,C=f.autoSchema?k.open(r):k.open(r,Math.round(10*d.verno));if(!C)throw new S.MissingAPI;C.onerror=xa(x);C.onblocked=fa(d._fireOnBlocked);C.onupgradeneeded=fa(function(y){var A;t=C.transaction;f.autoSchema&&!d._options.allowEmptyDB?(C.onerror=gb,t.abort(),C.result.close(),(A=k.deleteDatabase(r)).onsuccess=A.onerror=fa(function(){x(new S.NoSuchDatabase("Database "+
r+" doesnt exist"))})):(t.onerror=xa(x),y=y.oldVersion>Math.pow(2,62)?0:y.oldVersion,w=1>y,d._novip.idbdb=C.result,pd(d,y/10,t,x))},x);C.onsuccess=fa(function(){t=null;var y,A,G,F,E=d._novip.idbdb=C.result,H=Fb.call(E.objectStoreNames,void 0,void 0);if(0<H.length)try{var I=E.transaction(1===H.length?H[0]:H,"readonly");f.autoSchema?(A=E,G=I,(y=(y=d)._novip).verno=A.version/10,G=y._dbSchema=dc(0,A,G),y._storeNames=Fb.call(A.objectStoreNames,0,void 0),Db(y,[y._allTables],ja(G),G)):(ec(d,d._dbSchema,
I),((F=Mc(dc(0,(F=d).idbdb,I),F._dbSchema)).add.length||F.change.some(function(J){return J.add.length||J.change.length}))&&console.warn("Dexie SchemaDiff: Schema was extended without increasing the number passed to db.version(). Some queries may fail."));ac(d,I)}catch(J){}jb.push(d);E.onversionchange=fa(function(J){f.vcFired=!0;d.on("versionchange").fire(J)});E.onclose=fa(function(J){d.on("close").fire(J)});w&&(F=d._deps,I=r,E=F.indexedDB,F=F.IDBKeyRange,ic(E)||"__dbnames"===I||hc(E,F).put({name:I}).catch(ba));
u()},x)})})]).then(function(){return e(),f.onReadyBeingFired=[],N.resolve(jc(function(){return d.on.ready.fire(d.vip)})).then(function x(){if(0<f.onReadyBeingFired.length){var r=f.onReadyBeingFired.reduce(Lb,ba);return f.onReadyBeingFired=[],N.resolve(jc(function(){return r(d.vip)})).then(x)}})}).finally(function(){f.onReadyBeingFired=null;f.isBeingOpened=!1}).then(function(){return d}).catch(function(u){f.dbOpenError=u;try{t&&t.abort()}catch(x){}return l===f.openCanceller&&d._close(),la(u)}).finally(function(){f.openComplete=
!0;q()})}function kc(d){function e(m){return d.next(m)}function f(m){return function(q){var t=m(q);q=t.value;return t.done?q:q&&"function"==typeof q.then?q.then(k,l):pa(q)?Promise.all(q).then(k,l):k(q)}}var k=f(e),l=f(function(m){return d.throw(m)});return f(e)()}function Hb(d,e,f){d=pa(d)?d.slice():[d];for(var k=0;k<f;++k)d.push(e);return d}function lc(d,e,f,k){return f=f||{},k=k||"",ja(d).forEach(function(l){var m,q,t;ua.call(e,l)?(m=d[l],q=e[l],"object"==typeof m&&"object"==typeof q&&m&&q?(t=Yb.call(m).slice(8,
-1))!==Yb.call(q).slice(8,-1)?f[k+l]=e[l]:"Object"===t?lc(m,q,f,k+l+"."):m!==q&&(f[k+l]=e[l]):m!==q&&(f[k+l]=e[l])):f[k+l]=void 0}),ja(e).forEach(function(l){ua.call(d,l)||(f[k+l]=e[l])}),f}function Nc(d,e,f){try{if(!e||e.keys.length<d.length)return null;for(var k=[],l=0,m=0;l<e.keys.length&&m<d.length;++l)0===ra(e.keys[l],d[m])&&(k.push(f?ca(e.values[l]):e.values[l]),++m);return k.length===d.length?k:null}catch(q){return null}}function kb(d,e,f){var k=ra(e,f);if(!isNaN(k)){if(0<k)throw RangeError();
if(!("from"in d))return b(d,{from:e,to:f,d:1});var l=d.l;k=d.r;if(0>ra(f,d.from))return l?kb(l,e,f):d.l={from:e,to:f,d:1,l:null,r:null},Oc(d);if(0<ra(e,d.to))return k?kb(k,e,f):d.r={from:e,to:f,d:1,l:null,r:null},Oc(d);0>ra(e,d.from)&&(d.from=e,d.l=null,d.d=k?k.d+1:1);0<ra(f,d.to)&&(d.to=f,d.r=null,d.d=d.l?d.l.d+1:1);f=!d.r;l&&!d.l&&lb(d,l);k&&f&&lb(d,k)}}function lb(d,e){"from"in e&&function m(k,l){var q=l.from,t=l.to,w=l.l;l=l.r;kb(k,q,t);w&&m(k,w);l&&m(k,l)}(d,e)}function Pc(d,e){e=mc(e);var f=
...
e=Y({addons:ia.addons,autoOpen:!0,indexedDB:k.indexedDB,IDBKeyRange:k.IDBKeyRange},e);this._deps={indexedDB:e.indexedDB,IDBKeyRange:e.IDBKeyRange};k=e.addons;this._dbSchema={};this._versions=[];this._storeNames=[];this._allTables={};this.idbdb=null;this._novip=this;var l,m,q,t,w,u={dbOpenError:null,isBeingOpened:!1,onReadyBeingFired:null,openComplete:!1,dbReadyResolve:ba,dbReadyPromise:null,cancelOpen:ba,openCanceller:null,autoSchema:!0,PR1398_maxLoop:3};u.dbReadyPromise=new N(function(x){u.dbReadyResolve=
x});u.openCanceller=new N(function(x,r){u.cancelOpen=r});this._state=u;this.name=d;this.on=eb(this,"populate","blocked","versionchange","close",{ready:[Lb,ba]});this.on.ready.subscribe=p(this.on.ready.subscribe,function(x){return function(r,C){ia.vip(function(){var y=f._state;y.openComplete?(y.dbOpenError||N.resolve().then(r),C&&x(r)):y.onReadyBeingFired?(y.onReadyBeingFired.push(r),C&&x(r)):(x(r),C||x(function G(){f.on.ready.unsubscribe(r);f.on.ready.unsubscribe(G)}))})}});this.Collection=(l=this,
fb(sd.prototype,function(x,r){this.db=l;var C=Rc,y=null;if(r)try{C=r()}catch(G){y=G}var A=x._ctx;r=A.table;x=r.hook.reading.fire;this._ctx={table:r,index:A.index,isPrimKey:!A.index||r.schema.primKey.keyPath&&A.index===r.schema.primKey.name,range:C,keysOnly:!1,dir:"next",unique:"",algorithm:null,filter:null,replayFilter:null,justLimit:!0,isMatch:null,offset:0,limit:1/0,error:y,or:A.or,valueMapper:x!==Za?x:null}}));this.Table=(m=this,fb(td.prototype,function(x,r,C){this.db=m;this._tx=C;this.name=x;
this.schema=r;this.hook=m._allTables[x]?m._allTables[x].hook:eb(null,{creating:[ad,ba],reading:[$c,Za],updating:[cd,ba],deleting:[bd,ba]})}));this.Transaction=(q=this,fb(ud.prototype,function(x,r,C,y,A){var G=this;this.db=q;this.mode=x;this.storeNames=r;this.schema=C;this.chromeTransactionDurability=y;this.idbtrans=null;this.on=eb(this,"complete","error","abort");this.parent=A||null;this.active=!0;this._reculock=0;this._blockedFuncs=[];this._waitingQueue=this._waitingFor=this._reject=this._resolve=
null;this._spinCount=0;this._completion=new N(function(F,E){G._resolve=F;G._reject=E});this._completion.then(function(){G.active=!1;G.on.complete.fire()},function(F){var E=G.active;return G.active=!1,G.on.error.fire(F),G.parent?G.parent._reject(F):E&&G.idbtrans&&G.idbtrans.abort(),la(F)})}));this.Version=(t=this,fb(vd.prototype,function(x){this.db=t;this._cfg={version:x,storesSource:null,dbschema:{},tables:{},contentUpgrade:null}}));this.WhereClause=(w=this,fb(Ic.prototype,function(x,r,C){this.db=
w;this._ctx={table:x,index:":id"===r?null:r,or:C};var y=w._deps.indexedDB;if(!y)throw new S.MissingAPI;this._cmp=this._ascending=y.cmp.bind(y);this._descending=function(A,G){return y.cmp(G,A)};this._max=function(A,G){return 0<y.cmp(A,G)?A:G};this._min=function(A,G){return 0>y.cmp(A,G)?A:G};this._IDBKeyRange=w._deps.IDBKeyRange}));this.on("versionchange",function(x){0<x.newVersion?console.warn("Another connection wants to upgrade database '"+f.name+"'. Closing db now to resume the upgrade."):console.warn("Another connection wants to delete database '"+
f.name+"'. Closing db now to resume the delete request.");f.close()});this.on("blocked",function(x){!x.newVersion||x.newVersion<x.oldVersion?console.warn("Dexie.delete('"+f.name+"') was blocked"):console.warn("Upgrade '"+f.name+"' blocked by other connection holding version "+x.oldVersion/10)});this._maxKey=ib(e.IDBKeyRange);this._createTransaction=function(x,r,C,y){return new f.Transaction(x,r,C,f._options.chromeTransactionDurability,y)};this._fireOnBlocked=function(x){f.on("blocked").fire(x);jb.filter(function(r){return r.name===
f.name&&r!==f&&!r._state.vcFired}).map(function(r){return r.on("versionchange").fire(x)})};this.use(wd);this.use(xd);this.use(yd);this.use(zd);this.vip=Object.create(this,{_vip:{value:!0}});k.forEach(function(x){return x(f)})}function nc(d){this._subscribe=d}function Sc(d,e){return ja(e).forEach(function(f){lb(d[f]||(d[f]=new za),e[f])}),d}function Tc(d){var e=!1,f=void 0,k=new Ad(function(l){function m(){return ja(u).some(function(G){return w[G]&&Pc(w[G],u[G])})}var q=gc(d),t=!1,w={},u={},x={get closed(){return t},
unsubscribe:function(){t=!0;Ga.storagemutated.unsubscribe(y)}};l.start&&l.start(x);var r=!1,C=!1,y=function(G){Sc(w,G);m()&&A()},A=function(){var G,F;r||t||(w={},F=function(E){q&&Sa();var H=function(){return Ea(d,{subscr:E,trans:null})};H=O.trans?Ra(O.transless,H):H();return q&&H.then(Aa,Aa),H}(G={}),C||(Ga("storagemutated",y),C=!0),r=!0,Promise.resolve(F).then(function(E){f=E;r=!(e=!0);t||(m()?A():(w={},u=G,l.next&&l.next(E)))},function(E){e=r=!1;l.error&&l.error(E);x.unsubscribe()}))};return A(),
...
stack:{get:function(){if(this._stack)return this._stack;try{Ob=!0;var d=function m(f,k,l){if(k.length===l)return k;var q="",t,w,u;!1===f._state&&(null!=(t=f._value)?(w=t.name||"Error",u=t.message||t,q=sa(t,0)):(w=t,u=""),k.push(w+(u?": "+u:"")+q));wa&&((q=sa(f._stackHolder,2))&&-1===k.indexOf(q)&&k.push(q),f._prev&&m(f._prev,k,l));return k}(this,[],20).join("\nFrom previous: ");return null!==this._state&&(this._stack=d),d}finally{Ob=!1}}},timeout:function(d,e){var f=this;return d<1/0?new N(function(k,
...
e){return new N(function(f,k){return Ea(function(l,m){var q=O;q.unhandleds=[];q.onunhandled=m;q.finalize=Ha(function(){var t=this;var w=function(){0===t.unhandleds.length?l():m(t.unhandleds[0])};qb.push(function x(){w();qb.splice(qb.indexOf(x),1)});++Ja;cb(function(){0==--Ja&&Qb()},[])},q.finalize);d()},e,f,k)})}});tb&&(tb.allSettled&&g(N,"allSettled",function(){var d=V.apply(null,arguments).map(sb);return new N(function(e){0===d.length&&e([]);var f=d.length,k=Array(f);d.forEach(function(l,m){return N.resolve(l).then(function(q){return k[m]=
{status:"fulfilled",value:q}},function(q){return k[m]={status:"rejected",reason:q}}).then(function(){return--f||e(k)})})})}),tb.any&&"undefined"!=typeof AggregateError&&g(N,"any",function(){var d=V.apply(null,arguments).map(sb);return new N(function(e,f){0===d.length&&f(new AggregateError([]));var k=d.length,l=Array(k);d.forEach(function(m,q){return N.resolve(m).then(function(t){return e(t)},function(t){l[q]=t;--k||f(new AggregateError(l))})})})}));var oa={awaits:0,echoes:0,id:0},gd=0,ub=[],Ub=0,
wb=0,fd=0;-1===(""+Vb).indexOf("[native code]")&&(Sa=Aa=ba);var Cc="unhandledrejection",la=N.reject,Na=String.fromCharCode(65535),jb=[],Eb="undefined"!=typeof navigator&&/(MSIE|Trident|Edge)/.test(navigator.userAgent),qd=Eb,Dd=Eb,Rc={type:3,lower:-1/0,lowerOpen:!1,upper:[[]],upperOpen:!1},td=(ha.prototype._trans=function(d,e,f){function k(t,w,u){if(!u.schema[m])throw new S.NotFound("Table "+m+" not part of transaction");return e(u.idbtrans,u)}var l=this._tx||O.trans,m=this.name,q=ab();try{return l&&
l.db===this.db?l===O.trans?l._promise(d,k,f):Ea(function(){return l._promise(d,k,f)},{trans:l,transless:O.transless||O}):function C(w,u,x,r){if(w.idbdb&&(w._state.openComplete||O.letThrough||w._vip)){var y=w._createTransaction(u,x,w._dbSchema);try{y.create(),w._state.PR1398_maxLoop=3}catch(A){return A.name===pc.InvalidState&&w.isOpen()&&0<--w._state.PR1398_maxLoop?(console.warn("Dexie: Need to reopen db"),w._close(),w.open().then(function(){return C(w,u,x,r)})):la(A)}return y._promise(u,function(A,
G){return Ea(function(){return O.trans=y,r(A,G,y)})}).then(function(A){return y._completion.then(function(){return A})})}if(w._state.openComplete)return la(new S.DatabaseClosed(w._state.dbOpenError));if(!w._state.isBeingOpened){if(!w._options.autoOpen)return la(new S.DatabaseClosed);w.open().catch(ba)}return w._state.dbReadyPromise.then(function(){return C(w,u,x,r)})}(this.db,d,[this.name],k)}finally{q&&bb()}},ha.prototype.get=function(d,e){var f=this;return d&&d.constructor===Object?this.where(d).first(e):
this._trans("readonly",function(k){return f.core.get({trans:k,key:d}).then(function(l){return f.hook.reading.fire(l)})}).then(e)},ha.prototype.where=function(d){function e(w,u){try{return 0===m.cmp(w,u)}catch(x){return!1}}if("string"==typeof d)return new this.db.WhereClause(this,d);if(pa(d))return new this.db.WhereClause(this,"["+d.join("+")+"]");var f=ja(d);if(1===f.length)return this.where(f[0]).equals(d[f[0]]);var k=this.schema.indexes.concat(this.schema.primKey).filter(function(w){return w.compound&&
f.every(function(u){return 0<=w.keyPath.indexOf(u)})&&w.keyPath.every(function(u){return 0<=f.indexOf(u)})})[0];if(k&&this.db._maxKey!==Na)return this.where(k.name).equals(k.keyPath.map(function(w){return d[w]}));!k&&wa&&console.warn("The query "+JSON.stringify(d)+" on "+this.name+" would benefit of a compound index ["+f.join("+")+"]");var l=this.schema.idxByName,m=this.db._deps.indexedDB,q=f.reduce(function(w,u){var x=w[0],r=w[1];w=l[u];var C=d[u];return[x||w,x||!w?Ka(r,w&&w.multi?function(y){y=
D(y,u);return pa(y)&&y.some(function(A){return e(C,A)})}:function(y){return e(C,D(y,u))}):r]},[null,null]),t=q[0];q=q[1];return t?this.where(t.name).equals(d[t.keyPath]).filter(q):k?this.filter(q):this.where(f).equals("")},ha.prototype.filter=function(d){return this.toCollection().and(d)},ha.prototype.count=function(d){return this.toCollection().count(d)},ha.prototype.offset=function(d){return this.toCollection().offset(d)},ha.prototype.limit=function(d){return this.toCollection().limit(d)},ha.prototype.each=
...
l=Array.isArray(e)?e:void 0,m=(f=f||(l?void 0:e))?f.allKeys:void 0;return this._trans("readwrite",function(q){var t=k.schema.primKey,w=t.auto;if((t=t.keyPath)&&l)throw new S.InvalidArgument("bulkAdd(): keys argument invalid on tables with inbound keys");if(l&&l.length!==d.length)throw new S.InvalidArgument("Arguments objects and keys must have the same length");var u=d.length;t=t&&w?d.map(zb(t)):d;return k.core.mutate({trans:q,type:"add",keys:l,values:t,wantResults:m}).then(function(x){var r=x.numFailures,
C=x.results,y=x.lastResult;x=x.failures;if(0===r)return m?C:y;throw new Ya(k.name+".bulkAdd(): "+r+" of "+u+" operations failed",x);})})},ha.prototype.bulkPut=function(d,e,f){var k=this,l=Array.isArray(e)?e:void 0,m=(f=f||(l?void 0:e))?f.allKeys:void 0;return this._trans("readwrite",function(q){var t=k.schema.primKey,w=t.auto;if((t=t.keyPath)&&l)throw new S.InvalidArgument("bulkPut(): keys argument invalid on tables with inbound keys");if(l&&l.length!==d.length)throw new S.InvalidArgument("Arguments objects and keys must have the same length");
var u=d.length;t=t&&w?d.map(zb(t)):d;return k.core.mutate({trans:q,type:"put",keys:l,values:t,wantResults:m}).then(function(x){var r=x.numFailures,C=x.results,y=x.lastResult;x=x.failures;if(0===r)return m?C:y;throw new Ya(k.name+".bulkPut(): "+r+" of "+u+" operations failed",x);})})},ha.prototype.bulkDelete=function(d){var e=this,f=d.length;return this._trans("readwrite",function(k){return e.core.mutate({trans:k,type:"delete",keys:d})}).then(function(k){var l=k.numFailures,m=k.lastResult;k=k.failures;
...
l.schema),range:k.range}}).then(function(q){return Math.min(q,k.limit)});var m=0;return Bb(k,function(){return++m,!1},f,l).then(function(){return m})}).then(d)},Z.prototype.sortBy=function(d,e){function f(w,u){return u?f(w[l[u]],u-1):w[m]}function k(w,u){w=f(w,q);u=f(u,q);return w<u?-t:u<w?t:0}var l=d.split(".").reverse(),m=l[0],q=l.length-1,t="next"===this._ctx.dir?1:-1;return this.toArray(function(w){return w.sort(k)}).then(e)},Z.prototype.toArray=function(d){var e=this;return this._read(function(f){var k=
e._ctx;if("next"===k.dir&&Ta(k,!0)&&0<k.limit){var l=k.valueMapper,m=Ab(k,k.table.core.schema);return k.table.core.query({trans:f,limit:k.limit,values:!0,query:{index:m,range:k.range}}).then(function(t){t=t.result;return l?t.map(l):t})}var q=[];return Bb(k,function(t){return q.push(t)},f,k.table.core).then(function(){return q})},d)},Z.prototype.offset=function(d){var e=this._ctx;return 0>=d||(e.offset+=d,Ta(e)?Xb(e,function(){var f=d;return function(k,l){return 0===f||(1===f?--f:l(function(){k.advance(f);
...
Z.prototype.lastKey=function(d){return this.reverse().firstKey(d)},Z.prototype.distinct=function(){var d=this._ctx;d=d.index&&d.table.schema.idxByName[d.index];if(!d||!d.multi)return this;var e={};return Wb(this._ctx,function(f){var k=f.primaryKey.toString();f=ua.call(e,k);return e[k]=!0,!f}),this},Z.prototype.modify=function(d){var e=this,f=this._ctx;return this._write(function(k){function l(F,E){var H=E.failures;E=E.numFailures;A+=F-E;F=0;for(E=ja(H);F<E.length;F++)y.push(H[E[F]])}var m,q;var t=
"function"==typeof d?d:(m=ja(d),q=m.length,function(F){for(var E=!1,H=0;H<q;++H){var I=m[H],J=d[I];D(F,I)!==J&&(M(F,I,J),E=!0)}return E});var w=f.table.core,u=w.schema.primaryKey,x=u.outbound,r=u.extractKey,C=e.db._options.modifyChunkSize||200,y=[],A=0,G=[];return e.clone().primaryKeys().then(function(F){function E(H){var I=Math.min(C,F.length-H);return w.getMany({trans:k,keys:F.slice(H,H+I),cache:"immutable"}).then(function(J){for(var K=[],L=[],P=x?[]:null,R=[],W=0;W<I;++W){var qa=J[W],ka={value:ca(qa),
primKey:F[H+W]};!1!==t.call(ka,ka.value,ka)&&(null==ka.value?R.push(F[H+W]):x||0===ra(r(qa),r(ka.value))?(L.push(ka.value),x&&P.push(F[H+W])):(R.push(F[H+W]),K.push(ka.value)))}var T=Ta(f)&&f.limit===1/0&&("function"!=typeof d||d===sc)&&{index:f.index,range:f.range};return Promise.resolve(0<K.length&&w.mutate({trans:k,type:"add",values:K}).then(function(U){for(var X in U.failures)R.splice(parseInt(X),1);l(K.length,U)})).then(function(){return(0<L.length||T&&"object"==typeof d)&&w.mutate({trans:k,
type:"put",keys:P,values:L,criteria:T,changeSpec:"function"!=typeof d&&d}).then(function(U){return l(L.length,U)})}).then(function(){return(0<R.length||T&&d===sc)&&w.mutate({trans:k,type:"delete",keys:R,criteria:T}).then(function(U){return l(R.length,U)})}).then(function(){return F.length>H+I&&E(H+C)})})}return E(0).then(function(){if(0<y.length)throw new mb("Error modifying one or more objects",y,A,G);return F.length})})})},Z.prototype.delete=function(){var d=this._ctx,e=d.range;return Ta(d)&&(d.isPrimKey&&
...
d._descending;e.sort(f)};var l=0;return k._addAlgorithm(function(m,q,t){for(var w=m.key;0<f(w,e[l]);)if(++l===e.length)return q(t),!1;return 0===f(w,e[l])||(q(function(){m.continue(e[l])}),!1)}),k},ma.prototype.notEqual=function(d){return this.inAnyRange([[-1/0,d],[d,this.db._maxKey]],{includeLowers:!1,includeUppers:!1})},ma.prototype.noneOf=function(){var d=V.apply(Pa,arguments);if(0===d.length)return new this.Collection(this);try{d.sort(this._ascending)}catch(f){return va(this,"Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.")}var e=
d.reduce(function(f,k){return f?f.concat([[f[f.length-1][1],k]]):[[-1/0,k]]},null);return e.push([d[d.length-1],this.db._maxKey]),this.inAnyRange(e,{includeLowers:!1,includeUppers:!1})},ma.prototype.inAnyRange=function(d,e){function f(E,H){return C(E[0],H[0])}var k=this,l=this._cmp,m=this._ascending,q=this._descending,t=this._min,w=this._max;if(0===d.length)return Ua(this);if(!d.every(function(E){return void 0!==E[0]&&void 0!==E[1]&&0>=m(E[0],E[1])}))return va(this,"First argument to inAnyRange() must be an Array of two-value Arrays [lower,upper] where upper must not be lower than lower",
S.InvalidArgument);var u=!e||!1!==e.includeLowers,x=e&&!0===e.includeUppers,r,C=m;try{(r=d.reduce(function(E,H){for(var I=0,J=E.length;I<J;++I){var K=E[I];if(0>l(H[0],K[1])&&0<l(H[1],K[0])){K[0]=t(K[0],H[0]);K[1]=w(K[1],H[1]);break}}return I===J&&E.push(H),E},[])).sort(f)}catch(E){return va(this,"Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.")}var y=0,A=x?function(E){return 0<m(E,r[y][1])}:function(E){return 0<=m(E,r[y][1])},G=u?function(E){return 0<
q(E,r[y][0])}:function(E){return 0<=q(E,r[y][0])},F=A;d=new this.Collection(this,function(){return Fa(r[0][0],r[r.length-1][1],!u,!x)});return d._ondirectionchange=function(E){C="next"===E?(F=A,m):(F=G,q);r.sort(f)},d._addAlgorithm(function(E,H,I){for(var J=E.key;F(J);)if(++y===r.length)return H(I),!1;return!A(J)&&!G(J)||(0===k._cmp(J,r[y][1])||0===k._cmp(J,r[y][0])||H(function(){C===m?E.continue(r[y][0]):E.continue(r[y][1])}),!1)}),d},ma.prototype.startsWithAnyOf=function(){var d=V.apply(Pa,arguments);
...
d&&"readwrite"!==this.mode)return la(new S.ReadOnly("Transaction is readonly"));if(!this.active)return la(new S.TransactionInactive);if(this._locked())return new N(function(m,q){k._blockedFuncs.push([function(){k._promise(d,e,f).then(m,q)},O])});if(f)return Ea(function(){var m=new N(function(q,t){k._lock();var w=e(q,t,k);w&&w.then&&w.then(q,t)});return m.finally(function(){return k._unlock()}),m._lib=!0,m});var l=new N(function(m,q){var t=e(m,q,k);t&&t.then&&t.then(m,q)});return l._lib=!0,l},ya.prototype._root=
function(){return this.parent?this.parent._root():this},ya.prototype.waitFor=function(d){var e,f=this._root(),k=N.resolve(d);f._waitingFor?f._waitingFor=f._waitingFor.then(function(){return k}):(f._waitingFor=k,f._waitingQueue=[],e=f.idbtrans.objectStore(f.storeNames[0]),function q(){for(++f._spinCount;f._waitingQueue.length;)f._waitingQueue.shift()();f._waitingFor&&(e.get(-1/0).onsuccess=q)}());var l=f._waitingFor;return new N(function(q,t){k.then(function(w){return f._waitingQueue.push(fa(q.bind(null,
w)))},function(w){return f._waitingQueue.push(fa(t.bind(null,w)))}).finally(function(){f._waitingFor===l&&(f._waitingFor=null)})})},ya.prototype.abort=function(){this.active&&(this.active=!1,this.idbtrans&&this.idbtrans.abort(),this._reject(new S.Abort))},ya.prototype.table=function(d){var e=this._memoizedTables||(this._memoizedTables={});if(ua.call(e,d))return e[d];var f=this.schema[d];if(!f)throw new S.NotFound("Table "+d+" not part of transaction");f=new this.db.Table(d,f,this);return f.core=this.db.core.table(d),
e[d]=f},ya),ib=function(d){try{return d.only([[]]),ib=function(){return[[]]},[[]]}catch(e){return ib=function(){return Na},Na}},ld=0,vd=(Gb.prototype._parseStoresSpec=function(d,e){ja(d).forEach(function(f){if(null!==d[f]){var k=d[f].split(",").map(function(m,q){var t=(m=m.trim()).replace(/([&*]|\+\+)/g,""),w=/^\[/.test(t)?t.match(/^\[(.*)\]$/)[1].split("+"):t;return Zb(t,w||null,/&/.test(m),/\*/.test(m),/\+\+/.test(m),pa(w),0===q)}),l=k.shift();if(l.multi)throw new S.Schema("Primary key cannot be multi-valued");
...
e,e.Transaction.prototype]),Db(e,[e._allTables,e,e.Transaction.prototype,this._cfg.tables],ja(k),k),e._storeNames=ja(k),this},Gb.prototype.upgrade=function(d){return this._cfg.contentUpgrade=Lb(this._cfg.contentUpgrade||ba,d),this},Gb),wd={stack:"dbcore",name:"VirtualIndexMiddleware",level:1,create:function(d){return Y(Y({},d),{table:function(e){function f(r,C,y){var A=hb(r),G=q[A]=q[A]||[],F=null==r?0:"string"==typeof r?1:r.length;A=0<C;A=Y(Y({},y),{isVirtual:A,keyTail:C,keyLength:F,extractKey:$b(r),
unique:!A&&y.unique});return G.push(A),A.isPrimaryKey||t.push(A),1<F&&f(2===F?r[0]:r.slice(0,F-1),C+1,y),G.sort(function(E,H){return E.keyTail-H.keyTail}),A}function k(r){var C,y=r.query.index;return y.isVirtual?Y(Y({},r),{query:{index:y,range:(C=r.query.range,y=y.keyTail,{type:1===C.type?2:C.type,lower:Hb(C.lower,C.lowerOpen?d.MAX_KEY:d.MIN_KEY,y),lowerOpen:!0,upper:Hb(C.upper,C.upperOpen?d.MIN_KEY:d.MAX_KEY,y),upperOpen:!0})}}):r}var l=d.table(e),m=l.schema,q={},t=[];e=f(m.primaryKey.keyPath,0,
m.primaryKey);q[":id"]=[e];for(var w=0,u=m.indexes;w<u.length;w++){var x=u[w];f(x.keyPath,0,x)}return Y(Y({},l),{schema:Y(Y({},m),{primaryKey:e,indexes:t,getIndexByKeyPath:function(r){return(r=q[hb(r)])&&r[0]}}),count:function(r){return l.count(k(r))},query:function(r){return l.query(k(r))},openCursor:function(r){function C(F){return Object.create(F,{continue:{value:function(E){null!=E?F.continue(Hb(E,r.reverse?d.MAX_KEY:d.MIN_KEY,A)):r.unique?F.continue(F.key.slice(0,G).concat(r.reverse?d.MIN_KEY:
d.MAX_KEY,A)):F.continue()}},continuePrimaryKey:{value:function(E,H){F.continuePrimaryKey(Hb(E,d.MAX_KEY,A),H)}},primaryKey:{get:function(){return F.primaryKey}},key:{get:function(){var E=F.key;return 1===G?E[0]:E.slice(0,G)}},value:{get:function(){return F.value}}})}var y=r.query.index,A=y.keyTail,G=y.keyLength;return y.isVirtual?l.openCursor(k(r)).then(function(F){return F&&C(F)}):l.openCursor(r)}})}})}},xd={stack:"dbcore",name:"HooksMiddleware",level:2,create:function(d){return Y(Y({},d),{table:function(e){var f=
d.table(e),k=f.schema.primaryKey;return Y(Y({},f),{mutate:function(l){function m(r){var C,y,A=O.trans,G=r.keys||(C=k,"delete"===(y=r).type?y.keys:y.keys||y.values.map(C.extractKey));if(!G)throw Error("Keys missing");return"delete"!==(r="add"===r.type||"put"===r.type?Y(Y({},r),{keys:G}):Y({},r)).type&&(r.values=a([],r.values,!0)),r.keys&&(r.keys=a([],r.keys,!0)),y=G,("add"===(C=r).type?Promise.resolve([]):f.getMany({trans:C.trans,keys:y,cache:"immutable"})).then(function(F){var E=G.map(function(H,
I){var J,K,L,P=F[I],R={onerror:null,onsuccess:null};return"delete"===r.type?w.fire.call(R,H,P,A):"add"===r.type||void 0===P?(J=u.fire.call(R,H,r.values[I],A),null==H&&null!=J&&(r.keys[I]=H=J,k.outbound||M(r.values[I],k.keyPath,H))):(J=lc(P,r.values[I]),(K=x.fire.call(R,J,H,P,A))&&(L=r.values[I],Object.keys(K).forEach(function(W){ua.call(L,W)?L[W]=K[W]:M(L,W,K[W])}))),R});return f.mutate(r).then(function(H){var I=H.failures,J=H.results,K=H.numFailures;H=H.lastResult;for(var L=0;L<G.length;++L){var P=
(J||G)[L],R=E[L];null==P?R.onerror&&R.onerror(I[L]):R.onsuccess&&R.onsuccess("put"===r.type&&F[L]?r.values[L]:P)}return{failures:I,results:J,numFailures:K,lastResult:H}}).catch(function(H){return E.forEach(function(I){return I.onerror&&I.onerror(H)}),Promise.reject(H)})})}var q=O.trans,t=q.table(e).hook,w=t.deleting,u=t.creating,x=t.updating;switch(l.type){case "add":if(u.fire===ba)break;return q._promise("readwrite",function(){return m(l)},!0);case "put":if(u.fire===ba&&x.fire===ba)break;return q._promise("readwrite",
function(){return m(l)},!0);case "delete":if(w.fire===ba)break;return q._promise("readwrite",function(){return m(l)},!0);case "deleteRange":if(w.fire!==ba)return q._promise("readwrite",function(){return function G(C,y,A){return f.query({trans:C,values:!1,query:{index:k,range:y},limit:A}).then(function(F){var E=F.result;return m({type:"delete",keys:E,trans:C}).then(function(H){return 0<H.numFailures?Promise.reject(H.failures[0]):E.length<A?{failures:[],numFailures:0,lastResult:void 0}:G(C,Y(Y({},y),
{lower:E[E.length-1],lowerOpen:!0}),A)})})}(l.trans,l.range,1E4)},!0)}return f.mutate(l)}})}})}},zd={stack:"dbcore",level:-1,create:function(d){return{table:function(e){var f=d.table(e);return Y(Y({},f),{getMany:function(k){if(!k.cache)return f.getMany(k);var l=Nc(k.keys,k.trans._cache,"clone"===k.cache);return l?N.resolve(l):f.getMany(k).then(function(m){return k.trans._cache={keys:k.keys,values:"clone"===k.cache?ca(m):m},m})},mutate:function(k){return"add"!==k.type&&(k.trans._cache=null),f.mutate(k)}})}}}},
...
(y=C.query).index;var y=y.range;return[C,new za(null!==(C=y.lower)&&void 0!==C?C:d.MIN_KEY,null!==(y=y.upper)&&void 0!==y?y:d.MAX_KEY)]}var m=d.table(k),q=m.schema,t=q.primaryKey,w=t.extractKey,u=t.outbound,x=Y(Y({},m),{mutate:function(C){function y(L){return G[L="idb://"+e+"/"+k+"/"+L]||(G[L]=new za)}var A=C.trans,G=A.mutatedParts||(A.mutatedParts={}),F=y(""),E=y(":dels"),H=C.type;A="deleteRange"===C.type?[C.range]:"delete"===C.type?[C.keys]:50>C.values.length?[[],C.values]:[];var I=A[0],J=A[1],
...
E.add(P),F.add(P)):(F.add(f),E.add(f),q.indexes.forEach(function(W){return y(W.name).add(f)})),L})}}),r={get:function(C){return[t,new za(C.key)]},getMany:function(C){return[t,(new za).addKeys(C.keys)]},count:l,query:l,openCursor:l};return ja(r).forEach(function(C){x[C]=function(y){var A=O.subscr;if(A){var G=function(K){K="idb://"+e+"/"+k+"/"+K;return A[K]||(A[K]=new za)},F=G(""),E=G(":dels"),H=r[C](y),I=H[0];H=H[1];if(G(I.name||"").add(H),!I.isPrimaryKey){if("count"!==C){var J="query"===C&&u&&y.values&&
m.query(Y(Y({},y),{values:!1}));return m[C].apply(this,arguments).then(function(K){if("query"===C){if(u&&y.values)return J.then(function(R){R=R.result;return F.addKeys(R),K});var L=y.values?K.result.map(w):K.result;(y.values?F:E).addKeys(L)}else if("openCursor"===C){var P=y.values;return K&&Object.create(K,{key:{get:function(){return E.addKey(K.primaryKey),K.key}},primaryKey:{get:function(){var R=K.primaryKey;return E.addKey(R),R}},value:{get:function(){return P&&F.addKey(K.primaryKey),K.value}}})}return K})}E.add(f)}}return m[C].apply(this,
...
new N(function(f){d.dbReadyResolve=f});d.openCanceller=new N(function(f,k){d.cancelOpen=k})},ia.prototype.close=function(){this._close();var d=this._state;this._options.autoOpen=!1;d.dbOpenError=new S.DatabaseClosed;d.isBeingOpened&&d.cancelOpen(d.dbOpenError)},ia.prototype.delete=function(){var d=this,e=0<arguments.length,f=this._state;return new N(function(k,l){function m(){d.close();var q=d._deps.indexedDB.deleteDatabase(d.name);q.onsuccess=fa(function(){var t=d._deps;var w=d.name;var u=t.indexedDB;
t=t.IDBKeyRange;ic(u)||"__dbnames"===w||hc(u,t).delete(w).catch(ba);k()});q.onerror=xa(l);q.onblocked=d._fireOnBlocked}if(e)throw new S.InvalidArgument("Arguments not allowed in db.delete()");f.isBeingOpened?f.dbReadyPromise.then(m):m()})},ia.prototype.backendDB=function(){return this.idbdb},ia.prototype.isOpen=function(){return null!==this.idbdb},ia.prototype.hasBeenClosed=function(){var d=this._state.dbOpenError;return d&&"DatabaseClosed"===d.name},ia.prototype.hasFailed=function(){return null!==
...
arguments);return this._transaction.apply(this,d)},ia.prototype._transaction=function(d,e,f){var k=this,l=O.trans;l&&l.db===this&&-1===d.indexOf("!")||(l=null);var m,q=-1!==d.indexOf("?");d=d.replace("!","").replace("?","");try{if(m=e.map(function(u){u=u instanceof k.Table?u.name:u;if("string"!=typeof u)throw new TypeError("Invalid table argument to Dexie.transaction(). Only Table or String are allowed");return u}),"r"==d||"readonly"===d)var t="readonly";else{if("rw"!=d&&"readwrite"!=d)throw new S.InvalidArgument("Invalid transaction mode: "+
d);t="readwrite"}if(l){if("readonly"===l.mode&&"readwrite"===t){if(!q)throw new S.SubTransaction("Cannot enter a sub-transaction with READWRITE mode when parent transaction is READONLY");l=null}l&&m.forEach(function(u){if(l&&-1===l.storeNames.indexOf(u)){if(!q)throw new S.SubTransaction("Table "+u+" not included in parent transaction.");l=null}});q&&l&&!l.active&&(l=null)}}catch(u){return l?l._promise(null,function(x,r){r(u)}):la(u)}var w=function G(x,r,C,y,A){return N.resolve().then(function(){var F=
O.transless||O,E=x._createTransaction(r,C,x._dbSchema,y);F={trans:E,transless:F};if(y)E.idbtrans=y.idbtrans;else try{E.create(),x._state.PR1398_maxLoop=3}catch(J){return J.name===pc.InvalidState&&x.isOpen()&&0<--x._state.PR1398_maxLoop?(console.warn("Dexie: Need to reopen db"),x._close(),x.open().then(function(){return G(x,r,C,null,A)})):la(J)}var H,I=gc(A);return I&&Sa(),F=N.follow(function(){var J;(H=A.call(E,E))&&(I?(J=Aa.bind(null,null),H.then(J,J)):"function"==typeof H.next&&"function"==typeof H.throw&&
(H=kc(H)))},F),(H&&"function"==typeof H.then?N.resolve(H).then(function(J){return E.active?J:la(new S.PrematureCommit("Transaction committed too early. See http://bit.ly/2kdckMn"))}):F.then(function(){return H})).then(function(J){return y&&E._resolve(),E._completion.then(function(){return J})}).catch(function(J){return E._reject(J),la(J)})})}.bind(null,this,t,m,l,f);return l?l._promise(t,w,"lock"):O.trans?Ra(O.transless,function(){return k._whenReady(w)}):this._whenReady(w)},ia.prototype.table=function(d){if(!ua.call(this._allTables,
...
onResize:function(a,b,c){this.scale=c;this.pageWidth=a;this.pageHeight=b;this.canvasPanel[0].width=a;this.canvasPanel[0].height=b;this.drawCanvas[0].width=a;this.drawCanvas[0].height=b;this.panelContainer.css({width:this.pageWidth+"px",height:this.pageHeight+"px"});this.resizeNote(a,b)},resizeNote:function(a,b){var c=this,g,h,n,p,z;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){if(1==v.nextAddress)return global.annotationCookie?v.yield(global.annotationCookie.getCookie("Note"),2):
v.return();g=v.yieldResult;if(!g)return v.return();h=g[c.index-1];if(!h)return v.return();for(n in h)p=a,z=b,c.noteParent.find("#"+n).css({left:h[n].position.x*p+"px",top:h[n].position.y*z+"px",width:h[n].size*a+"px",height:h[n].size*b+"px"}),c.noteParent.find("#"+n).find(".noteBox").css({top:h[n].size*z+10+"px"});v.jumpToEnd()})},initEvent:function(){this.eraserCircle.bind("pointerdown ",function(a){a.preventDefault()}.bind(this));this.panelContainer.bind("pointerdown mousedown mouseup mouseover mousemove",
...
global.annotationCookie.stepIndex+=1}},getPosition:function(a,b,c,g){if(isPad()||isPhone())c=b=0,"note"==g&&(b=-this.pageWidth/25,c=-this.pageHeight/28);g=BookInfo.getBook().showPage.parameters.toScale||1;a=a.originalEvent&&a.originalEvent.changedTouches?a.originalEvent.changedTouches:a.changedTouches?a.changedTouches:[a];var h=document.documentElement.scrollLeft||document.body.scrollLeft,n=document.documentElement.scrollTop||document.body.scrollTop;b=(a[0].pageX||a[0].clientX+h)-this.panelContainer.offset().left+
b;a=(a[0].pageY||a[0].clientY+n)-this.panelContainer.offset().top+c;return{x:b/g,y:a/g}},showEraser:function(a,b){var c=this.getNumberFromSlider("eraser");this.eraserCircle.css({"pointer-events":"none",display:"block",background:"rgba(33,33,33,0.4)",width:c+"px",height:c+"px",left:a+"px",top:b+"px"})},drawLine:function(a,b){this.ctx.beginPath();.85<=this.getNumberFromSlider("alpha")/100?this.ctx.lineCap="round":this.ctx.lineCap="butt";this.ctx.lineJoin="round";this.ctx.lineWidth=this.getNumberFromSlider("width");
this.ctx.strokeStyle=Color(global.annotationPannel.inputColor.val()).rgba(this.getNumberFromSlider("alpha")/100);this.ctx.moveTo(this.X,this.Y);this.ctx.lineTo(a,b);this.ctx.stroke();this.X=a;this.Y=b},drawRect:function(a,b,c){a.beginPath();a.lineCap="round";a.lineJoin="round";a.lineWidth=this.getNumberFromSlider("width");a.strokeStyle=Color(global.annotationPannel.inputColor.val()).rgba(this.getNumberFromSlider("alpha")/100);var g=this.X,h=this.Y;0>b-this.X&&(g=b);0>c-this.Y&&(h=c);a.moveTo(g,h);
a.strokeRect(g,h,Math.abs(b-this.X),Math.abs(c-this.Y));a.stroke()},drawEllipse:function(a,b,c){b=b/2+this.X/2;c=c/2+this.Y/2;var g=Math.abs(b-this.X),h=Math.abs(c-this.Y);a.lineCap="round";a.lineJoin="round";a.lineWidth=this.getNumberFromSlider("width");a.strokeStyle=Color(global.annotationPannel.inputColor.val()).rgba(this.getNumberFromSlider("alpha")/100);a.save();var n=g>h?g:h;g/=n;h/=n;a.scale(g,h);a.beginPath();a.arc(b/g,c/h,n,0,2*Math.PI,!1);a.closePath();a.restore();a.stroke()},eraserClear:function(a,
b){this.ctx.beginPath();this.ctx.stroke();this.ctx.clearRect(this.X,this.Y,this.getNumberFromSlider("eraser"),this.getNumberFromSlider("eraser"));this.X=a;this.Y=b},clearCvs:function(){this.ctx.clearRect(0,0,this.pageWidth,this.pageHeight)}}),AnnotationCookie=Class({create:function(a,b,c){var g=this;this.parent=a;this.bookType=BookInfo.getBookType();this.pageWidth=b;this.pageHeight=c;this.defaultWidth=b;this.scale=this.tranScale=1;this.stepIndex=0;this.currentSteps=[];this.allAnnoSteps=[];this.migrationStatusMap=
new Map;global.annotationCookieDB=new AnnotationCookieDB;global.annotationCookieDB.init().then(function(){g.migrateData()})},getCookieName:function(a){var b=bookConfig.ClientBookId?bookConfig.ClientBookId:"";return window.location.href.replace(window.location.hash,"").replace(window.location.search,"")+b+a},getCookie:function(a){var b=this,c,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){return 1==h.nextAddress?(null==(c=b.migrationStatusMap.get(a))?0:c.isDone)?h.jumpTo(2):h.yield(b.migrateLocalStorageToIndexedDB(a),
2):4!=h.nextAddress?h.yield(global.annotationCookieDB.getCookie(a),4):(g=h.yieldResult)?h.return(g):h.return(null)})},migrateData:function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){return 1==b.nextAddress?b.yield(a.migrateLocalStorageToIndexedDB("Cookie"),2):b.yield(a.migrateLocalStorageToIndexedDB("Note"),0)})},migrateLocalStorageToIndexedDB:function(a){var b=this,c,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:c=b.migrationStatusMap.get(a)||
{promise:null,isDone:!1};if(c.isDone)return h.return();if(!c.promise){h.jumpTo(2);break}return h.yield(c.promise,3);case 3:return h.return();case 2:return g=function(){var n,p,z,v,B;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:return D.yield(global.annotationCookieDB.getCookie(a),2);case 2:if(n=D.yieldResult)return D.return(n);p=b.getCookieName(a);z=window.localStorage.getItem(p);if(!z)return D.return();B=v=JSON.parse(z);D.setCatchFinallyBlocks(3);return D.yield(global.annotationCookieDB.saveCookie(a,
B),5);case 5:D.leaveTryBlock(0);break;case 3:D.enterCatchBlock(),D.jumpToEnd()}})}.call(b),b.migrationStatusMap.set(a,{promise:g,isDone:!1}),h.yield(g,4);case 4:b.migrationStatusMap.set(a,{promise:null,isDone:!0}),h.jumpToEnd()}})},hasCvsCookie:function(a){var b=this,c,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){switch(n.nextAddress){case 1:c=["Cookie"],g=0;case 2:if(!(g<c.length)){n.jumpTo(4);break}return n.yield(b.getCookie(c[g]),5);case 5:if((h=n.yieldResult)&&h.length&&
h[a]&&h[a].length)return n.return(!0);g++;n.jumpTo(2);break;case 4:return n.return(!1)}})},saveCookie:function(){var a=this,b,c,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return n.yield(a.getCookie("Cookie",!1),2);(b=n.yieldResult)||(b=[]);for(c=0;c<a.stepIndex;c++)if(g=a.allAnnoSteps[c].index,a.isArray(g))for(h=0;h<g.length;h++)b[g[h]]=[];else b[g]||(b[g]=[]),b[g].push(a.allAnnoSteps[c]);return n.yield(global.annotationCookieDB.saveCookie("Cookie",b),0)})},
getPage:function(a){a=a?a+1:BookInfo.getBook().currentPageIndex;var b="";"slide"==bookConfig.FlipStyle.toLocaleLowerCase()&&BookInfo.isDoublePage(BookInfo.getBookType())?(BookInfo.getBook().pageArray[a].leftPage?b=BookInfo.getBook().pageArray[a].leftPage.pageAttachments.$annotation:BookInfo.getBook().pageArray[a].rightPage&&(b=BookInfo.getBook().pageArray[a].rightPage.pageAttachments.$annotation),rightToLeft&&BookInfo.getBook().pageArray[a].rightPage&&(b=BookInfo.getBook().pageArray[a].rightPage.pageAttachments.$annotation)):
b=BookInfo.getBook().pageArray[a].page.pageAttachments.$annotation;return b},repaintCookie:function(a,b,c,g){var h=this,n,p,z;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){h.pageWidth=a;h.pageHeight=b;g||(g=h.getPage(c));a&&b||(h.pageWidth=g.width(),h.pageHeight=g.height());if(!h.pageWidth||!h.pageHeight)return v.return();h.clearUnsaveCookie();if(!BookInfo.getBook().showPage.find("#annotationCvsPanel"+(c+1))[0])return v.return();n=BookInfo.getBook().showPage.find("#annotationCvsPanel"+
(c+1))[0].getContext("2d");n.clearRect(0,0,h.pageWidth,h.pageHeight);p=function(){h.getCookie("Cookie").then(function(B){B&&B[c]&&h.putCookie(c,B[c])})};z=function(){h.getCookie("Note").then(function(B){if(g&&B){B[c]&&Object.keys(B[c]).length&&g.css({display:"block"});for(var D in B[c]){var M=B[c][D],Q=M.position.x*h.pageWidth,ca=M.position.y*h.pageHeight,V=g.find("#"+D),da=h.getNoteBoxSize();V[0]?(V.css({"font-size":14/h.scale+"px",left:Q/h.scale+"px",top:ca/h.scale+"px",width:.05*h.pageWidth/h.scale+
"px",height:.05*h.pageWidth/h.scale+"px"}),isPad()||isPhone()?(V.css({width:.05*h.pageWidth/h.scale+"px",height:.05*h.pageWidth/h.scale+"px"}),V.find(".noteBox").css({top:"50%",left:"50%",transform:"translate(-50%, -50%)","-webkit-transform":"translate(-50%, -50%)"})):V.find(".noteBox").css({top:(.05*h.pageWidth+10)/h.scale+"px","-webkit-transform":"scale("+h.tranScale+")","-o-transform":"scale("+h.tranScale+")","-moz-transform":"scale("+h.tranScale+")","-ms-transform":"scale("+h.tranScale+")",transform:"scale("+
h.tranScale+")","-webkit-transform-origin":"0 0","-o-transform-origin":"0 0","-moz-transform-origin":"0 0","-ms-transform-origin":"0 0","transform-origin":"0 0"}),V.find(".noteBox textarea").css({width:da.width-20+"px",height:da.height+"px"}).val(M.value),isPhone()||isPad()?V.find(".noteBox .noteTitle").css({width:da.width-82+"px"}):V.find(".noteBox .noteTitle").css({width:da.width-68+"px"}),h.refreshNoteColor(V,M.colorIndex,da)):isPhone()||isPad()?new AnnotationAddMobileNote(g,B[c][D]):new AnnotationAddNote(g,
B[c][D])}}})};p();z();v.jumpToEnd()})},getNoteBoxSize:function(){if(isPhone()){var a=148<parseInt(this.pageWidth/2)?148:parseInt(this.pageWidth/2);var b=80<parseInt(this.pageHeight/2)?80:parseInt(this.pageHeight/2)}else a=228<parseInt(this.pageWidth/2)?228:parseInt(this.pageWidth/2),b=100<parseInt(this.pageHeight/2)?100:parseInt(this.pageHeight/2);b>a-20&&(b=a-20);return{width:a,height:b}},refreshNoteColor:function(a,b,c){if(void 0!=b){var g=a.find(".noteBox"),h="#FFF1dc #ffe2df #e6f6ff #e7ffea #f3e9ff #d0cdc7".split(" "),
n=g.find(".colorBox");a.find(".noteSvgIcon").html(this.getNoteSvg(h[b]));g.css({background:h[b]});a=$(n.find("span")[b]);if(isPhone()||isPad())4>p&&(p=4),8<p&&(p=8),n.find("span").removeClass("active").css({margin:"10px "+p+"px;"});else{var p=(c.width-72)/7;4>p&&(p=4);n.find("span").removeClass("active").css({margin:"9px 0 9px "+p+"px","box-shadow":"0 0 0 1px rgba(11,11,11,0.3)","-webkit-box-shadow":"0 0 0 1px rgba(11,11,11,0.3)"})}a.addClass("active").css({"box-shadow":"0 0 0 2px #4BA0FF","-webkit-box-shadow":"0 0 0 2px #4BA0FF"})}},
getNoteSvg:function(a){return'<svg style="position:absolute;top:0;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"><defs><style>.cls-1, .cls-2 {fill-rule: evenodd;}.cls-1 {opacity: 0.85;}</style></defs><path id="\u8930\u3222\u59f8_2" data-name="\u8930\u3222\u59f8 2" class="cls-1" d="M2,0H15.917A1.98,1.98,0,0,1,18,2V13l-5,5s-8.875.063-11,0-2-2.667-2-2.667-0.062-10.562,0-13S2,0,2,0Z"/><path  fill="'+a+'" id="\u8930\u3222\u59f8_2_\u93b7\u75af\u7909" data-name="\u8930\u3222\u59f8 2 \u93b7\u75af\u7909" class="cls-2" d="M2,1H16a0.863,0.863,0,0,1,1,1c-0.031,1.156,0,10,0,10H12v5H2s-0.906.281-1-1S0.969,3,1,2A0.994,0.994,0,0,1,2,1ZM13,13h4l-4,4V13ZM4.5,5h5a0.5,0.5,0,0,1,0,1h-5A0.5,0.5,0,0,1,4.5,5Zm0,3h7a0.5,0.5,0,0,1,0,1h-7A0.5,0.5,0,0,1,4.5,8Zm0,3h5a0.5,0.5,0,0,1,0,1h-5A0.5,0.5,0,0,1,4.5,11Z"/></svg>'},
putCookie:function(a,b){if(BookInfo.getBook().showPage.find("#annotationCvsPanel"+(a+1))[0]&&(BookInfo.getBook().showPage.find("#annotationCvsPanel"+(a+1))[0].getContext("2d"),b))for(var c=0;c<b.length;c++){var g=b[c].cookie,h=b[c].type;var n=BookInfo.getBook().showPage.find("#annotationCvsPanel"+(a+1))[0].getContext("2d");if("Clear"==h)for(var p=BookInfo.getCurrentPages(),z=0;z<p.length;z++){n=BookInfo.getBook().showPage.find("#annotationCvsPanel"+p[z])[0];if(!n)return;n=n.getContext("2d");n.clearRect(0,
0,this.pageWidth,this.pageHeight)}for(p=0;p<g.length;p++)switch(h){case "Pen":this.drawLine(n,g[p]);break;case "Rect":this.drawRect(n,g[p]);break;case "Round":this.drawRound(n,g[p]);break;case "Eraser":this.drawClear(n,g[p])}}},stepPaint:function(a,b,c){if("Clear"!=a)var g=BookInfo.getBook().showPage.find("#annotationCvsPanel"+(b+1))[0].getContext("2d");for(var h=0;h<c.length;h++)switch(a){case "Pen":this.drawLine(g,c[h]);break;case "Rect":this.drawRect(g,c[h]);break;case "Round":this.drawRound(g,
c[h]);break;case "Eraser":this.drawClear(g,c[h]);break;case "Clear":for(var n=0;n<b.length;n++)g=BookInfo.getBook().showPage.find("#annotationCvsPanel"+(b[n]+1))[0].getContext("2d"),g.clearRect(0,0,this.pageWidth,this.pageHeight)}},repaintSteps:function(){var a=this,b,c,g,h,n,p,z;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){switch(v.nextAddress){case 1:if(!a.allAnnoSteps.length)return v.return();v.setCatchFinallyBlocks(2);b=BookInfo.getCurrentPages();c=0;case 4:if(!(c<b.length)){for(p=
0;p<a.stepIndex;p++)a.stepPaint(a.allAnnoSteps[p].type,a.allAnnoSteps[p].index,a.allAnnoSteps[p].cookie);v.leaveTryBlock(0);break}g=BookInfo.getBook().showPage.find("#annotationCvsPanel"+b[c])[0].getContext("2d");g.clearRect(0,0,a.pageWidth,a.pageHeight);return v.yield(a.hasCvsCookie(b[c]-1),7);case 7:h=v.yieldResult;if(!h){v.jumpTo(5);break}return v.yield(a.getCookie("Cookie"),9);case 9:n=v.yieldResult,a.putCookie(b[c]-1,n[b[c]-1]);case 5:c++;v.jumpTo(4);break;case 2:z=v.enterCatchBlock(),console.log(z),
v.jumpToEnd()}})},clearUnsaveCookie:function(){this.stepIndex=0;this.currentSteps=[];this.allAnnoSteps=[]},deleteNoteCookie:function(a,b,c){return global.annotationCookieDB.deleteNoteCookie(a,b,c)},isArray:function(a){return"[object Array]"==Object.prototype.toString.call(a)},drawRound:function(a,b){if(this.isFullConfig(b)){var c=(b.x/2+b.startX/2)*this.pageWidth,g=(b.y/2+b.startY/2)*this.pageHeight,h=Math.abs(c-b.startX*this.pageWidth),n=Math.abs(g-b.startY*this.pageHeight);a.lineCap="round";a.lineJoin=
"round";a.lineWidth=parseInt(b.lineWidth*this.pageWidth);a.strokeStyle=b.color;a.save();b=h>n?h:n;h/=b;n/=b;a.scale(h,n);a.beginPath();a.arc(c/h,g/n,b,0,2*Math.PI,!1);a.closePath();a.restore();a.stroke()}},drawRect:function(a,b){if(this.isFullConfig(b)){a.beginPath();a.lineCap="round";a.lineJoin="round";a.lineWidth=b.lineWidth*this.pageWidth;a.strokeStyle=b.color;var c=b.startX*this.pageWidth,g=b.startY*this.pageHeight;0>b.x-b.startX&&(c=b.x*this.pageWidth);0>b.y-b.startY&&(g=b.y*this.pageHeight);
a.moveTo(c,g);a.strokeRect(c,g,Math.abs(b.x-b.startX)*this.pageWidth,Math.abs(b.y-b.startY)*this.pageHeight);a.stroke()}},drawLine:function(a,b){this.isFullConfig(b)&&(a.lineCap=.85<=b.opacity?"round":"butt",a.lineJoin="round",a.lineWidth=b.lineWidth*this.pageWidth,a.strokeStyle=b.color,a.beginPath(),a.moveTo(b.startX*this.pageWidth,b.startY*this.pageHeight),a.lineTo(b.x*this.pageWidth,b.y*this.pageHeight),a.stroke(),a.closePath())},drawClear:function(a,b){a&&b.x&&b.y&&b.lineWidth&&(a.beginPath(),
a.clearRect(b.x*this.pageWidth,b.y*this.pageHeight,b.lineWidth*this.pageWidth,b.lineWidth*this.pageWidth),a.stroke(),a.closePath())},isFullConfig:function(a){return a&&a.startX&&a.startY&&a.x&&a.y&&a.lineWidth&&a.color},onResize:function(a,b,c){this.scale=c;this.tranScale=a/this.defaultWidth;this.pageWidth=a;this.pageHeight=b},setAllAnnoSteps:function(a,b,c){this.allAnnoSteps.length>this.stepIndex&&(this.allAnnoSteps.length=this.stepIndex);switch(a){case 2:this.allAnnoSteps.push({type:"Pen",index:b,
cookie:c});break;case 3:this.allAnnoSteps.push({type:"Rect",index:b,cookie:c});break;case 4:this.allAnnoSteps.push({type:"Round",index:b,cookie:c});break;case 5:this.allAnnoSteps.push({type:"Eraser",index:b,cookie:c});break;case 11:this.allAnnoSteps.push({type:"Clear",index:b,cookie:c})}},saveNoteCookie:function(a,b,c,g){return global.annotationCookieDB.saveNoteCookie(a,b,c,g)}}),AnnotationCookieDB=Class({create:function(){this.annotationDb=null;this.storeName="annotations";this.initPromise=null;
this.isInitialized=!1},init:function(a){a=void 0===a?"AnnotationDB":a;var b=this,c,g,h,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(z){switch(z.nextAddress){case 1:if(b.isInitialized)return z.return();c=0;g=5;case 2:if(!("undefined"===typeof Dexie&&c<g)){if("undefined"===typeof Dexie)return z.return();z.setCatchFinallyBlocks(5);b.annotationDb=new Dexie(a);h={};b.annotationDb.version(1).stores((h[b.storeName]="++id, key, type",h));b.initPromise=b.annotationDb.open();return z.yield(b.initPromise,
7)}return z.yield(new Promise(function(v){return setTimeout(v,100)}),4);case 4:c++;z.jumpTo(2);break;case 7:b.isInitialized=!0;z.leaveTryBlock(0);break;case 5:return z.enterCatchBlock(),z.setCatchFinallyBlocks(8),z.yield(null==(n=b.annotationDb)?void 0:n.delete(),10);case 10:return b.annotationDb=new Dexie(a),p={},b.annotationDb.version(1).stores((p[b.storeName]="++id, key, type",p)),b.initPromise=b.annotationDb.open(),z.yield(b.initPromise,11);case 11:b.isInitialized=!0;z.leaveTryBlock(0);break;
case 8:z.enterCatchBlock(),z.jumpToEnd()}})},ensureInit:function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){switch(b.nextAddress){case 1:if(a.isInitialized){b.jumpTo(2);break}return b.yield(a.init(),2);case 2:return b.setCatchFinallyBlocks(4),b.yield(a.initPromise,6);case 6:b.leaveTryBlock(0);break;case 4:b.enterCatchBlock(),b.jumpToEnd()}})},getCookieName:function(a){var b="undefined"!==typeof bookConfig&&bookConfig.ClientBookId?bookConfig.ClientBookId:"";return window.location.href.replace(window.location.hash,
"").replace(window.location.search,"")+b+a},getCookie:function(a){var b=this,c,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){switch(n.nextAddress){case 1:return n.yield(b.ensureInit(),2);case 2:return c=b.getCookieName(a),n.setCatchFinallyBlocks(3),n.yield(b.annotationDb[b.storeName].where("key").equals(c).first(),5);case 5:return(g=n.yieldResult)&&g.content?n.return(JSON.parse(g.content)):n.return(null);case 3:return h=n.enterCatchBlock(),console.log("getCookie error:",h),n.return(null)}})},
saveCookie:function(a,b,c){c=void 0===c?"":c;var g=this,h,n,p,z;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){switch(v.nextAddress){case 1:return v.yield(g.ensureInit(),2);case 2:return h=g.getCookieName(a),n={key:h,type:c,content:"string"===typeof b?b:JSON.stringify(b)},v.setCatchFinallyBlocks(3),v.yield(g.annotationDb[g.storeName].where("key").equals(h).first(),5);case 5:return(p=v.yieldResult)?(n.id=p.id,v.yield(g.annotationDb[g.storeName].put(n),9)):v.yield(g.annotationDb[g.storeName].add(n),
8);case 8:return v.return(v.yieldResult);case 9:return v.return(v.yieldResult);case 7:v.leaveTryBlock(0);break;case 3:z=v.enterCatchBlock(),console.log("saveCookie error:",z),v.jumpToEnd()}})},deleteCookie:function(a){var b=this,c,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:return h.yield(b.ensureInit(),2);case 2:return c=b.getCookieName(a),h.setCatchFinallyBlocks(3),h.yield(b.annotationDb[b.storeName].where("key").equals(c).delete(),5);case 5:return h.return(h.yieldResult);
case 3:g=h.enterCatchBlock(),console.log("deleteCookie error:",g),h.jumpToEnd()}})},saveNoteCookie:function(a,b,c,g){var h=this,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){switch(p.nextAddress){case 1:return p.yield(h.ensureInit(),2);case 2:return p.yield(h.getCookie(a),3);case 3:return n=(n=p.yieldResult)||[],n[b]||(n[b]={}),n[b][c]=g,p.yield(h.saveCookie(a,n),4);case 4:return p.return(p.yieldResult)}})},deleteNoteCookie:function(a,b,c){var g=this,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){switch(n.nextAddress){case 1:return n.yield(g.ensureInit(),
2);case 2:return n.yield(g.getCookie(a),3);case 3:h=n.yieldResult;if(!(h&&h[b]&&h[b][c])){console.log("Note item not found");n.jumpTo(0);break}delete h[b][c];0===Object.keys(h[b]).length&&(h[b]=null);return n.yield(g.saveCookie(a,h),5);case 5:return n.return(n.yieldResult)}})}}),AnnotationAddNote=Class({create:function(a,b,c){this.parent=a;this.config=b;b.colorIndex||(b.colorIndex=0);this.size=.05;this.setColorIndex(b.colorIndex);this.initPageConfig();this.colorArr="#FFF1dc #ffe2df #e6f6ff #e7ffea #f3e9ff #d0cdc7".split(" ");
this.position={x:b.position.x*this.notePanelWidth,y:b.position.y*this.notePanelHeight};if(isPhone()||isPad())this.position={x:b.position.x*this.notePanelWidth/global.annotationCookie.scale,y:b.position.y*this.notePanelHeight/global.annotationCookie.scale};this.noteShow=c;this.container=$("<div id="+b.id+" title='"+this.config.value+"' class='noteContainer'></div>");this.icon=$("<div class='noteSvgIcon'>"+this.getNoteSvg("#FFF1dc")+"</div>");b.colorIndex&&this.icon.html(this.getNoteSvg(this.colorArr[b.colorIndex]));
this.close=$("<p class='note-panel-close'><span class='note-btn-icon'></span></p>");this.remove=$("<p class='note-panel-remove'><span class='note-btn-icon'></span></p>");this.noteTitle=$("<div class='noteTitle'>"+this.config.time+"</div>");this.noteTitleBg=$("<div class='notetitleBg' style='width:100%;height:28px;position:absolute;left:0;background:rgba(11,11,11,0.1);'></div>");this.noteBox=$("<div class='noteBox'></div>");this.textarea=$("<textarea placeholder='"+getLanguage("tltAddTexts","add texts")+
"...'>"+this.config.value+"</textarea>");this.colorBox=$("<div class='colorBox'></div>");this.initColorItems();this.noteBox.append(this.noteTitleBg).append(this.noteTitle).append(this.close).append(this.remove).append(this.textarea).append(this.colorBox);this.container.append(this.icon).append(this.noteBox);this.parent.append(this.container);this.initDeletePart();this.initCss();this.initEvent();this.showOrHide();this.moveEvent()},initDeletePart:function(){this.deleteBox=$("<div class='deleteBox' ></div>");
this.centerBox=$("<div class='centerBox' style='border-radius:4px;text-align:center;position:absolute;left:50%;top:35%;transform:translate(-50%,-50%);width:100%;'></div>");this.deleteAlertText=$("<div class='infDeleteNote' style='padding: 0 10px;font-size:18px;'>"+getLanguage("infDeleteNote","Do you want to delete the note?")+"</div>");this.confirmBox=$("<div style='text-align:center;position:absolute;bottom:0;height:50px;line-height:50px;width:100%;border-top:1px solid rgba(11,11,11,0.1);'></div>");
this.yes=$("<div class='yes deleteBtn' style='cursor:pointer;display:inline-block;color:#FF5E5F;border-left: 1px solid rgba(11,11,11,0.1);width:50%;box-sizing:border-box;height:50px;line-height:50px;'>"+getLanguage("lblConfirm","confirm")+"</div>");this.no=$("<div class='no deleteBtn' style='cursor:pointer;display:inline-block;width:50%;box-sizing:border-box;height:50px;line-height:50px;'>"+getLanguage("lblCancel","cancel")+"</div>");this.centerBox.append(this.deleteAlertText);this.confirmBox.append(this.no).append(this.yes);
this.deleteBox.append(this.centerBox).append(this.confirmBox);this.deleteBox.css({"z-index":"10000",background:"#fff","box-shadow":" 0 0 3px #bbb",display:"none",width:"228px",height:"164px",position:"absolute",top:"0",left:"0",bottom:"0",right:"0"});this.noteBox.append(this.deleteBox);this.confirmBox.find(".deleteBtn").bind("mouseenter",function(a){$(a.target).css({background:"rgba(11,11,11,0.1)"})}.bind(this));this.confirmBox.find(".deleteBtn").bind("mouseleave",function(a){$(a.target).css({background:""})}.bind(this));
this.yes.bind(_event._click,function(){var a=this;global.annotationCookie.deleteNoteCookie("Note",this.config.index,this.config.id).then(function(){a.container.remove();a.container=void 0;a.deleteBox.fadeOut(200)})}.bind(this));this.no.bind(_event._click,function(){this.deleteBox.fadeOut(200)}.bind(this))},setColorIndex:function(a){this.colorIndex=a},initPageConfig:function(){this.pageIndex=this.config.index+1;BookInfo.getBook().pageArray.length&&BookInfo.getBook().pageArray[this.pageIndex]&&("slide"==
bookConfig.FlipStyle.toLocaleLowerCase()&&BookInfo.isDoublePage(BookInfo.getBookType())?(BookInfo.getBook().pageArray[this.pageIndex].leftPage?this.page=BookInfo.getBook().pageArray[this.pageIndex].leftPage:BookInfo.getBook().pageArray[this.pageIndex].rightPage&&(this.page=BookInfo.getBook().pageArray[this.pageIndex].rightPage),rightToLeft&&BookInfo.getBook().pageArray[this.pageIndex].rightPage&&(this.page=BookInfo.getBook().pageArray[this.pageIndex].rightPage)):this.page=BookInfo.getBook().pageArray[this.pageIndex].page,
this.pageWidth=this.page.pageWidth,this.pageHeight=this.page.pageHeight,this.page.pageAttachments?(this.notePanelWidth=this.page.pageAttachments.pageWidth,this.notePanelHeight=this.page.pageAttachments.pageHeight):(this.notePanelWidth=this.parent.width(),this.notePanelHeight=this.parent.height()),isPhone()||isPad()?(this.noteBoxWidth=148<parseInt(this.notePanelWidth/2)?148:parseInt(this.notePanelWidth/2),this.noteBoxHeight=80<parseInt(this.notePanelHeight/2)?80:parseInt(this.notePanelHeight/2)):(this.noteBoxWidth=
228<parseInt(this.notePanelWidth/2)?228:parseInt(this.notePanelWidth/2),this.noteBoxHeight=100<parseInt(this.notePanelHeight/2)?100:parseInt(this.notePanelHeight/2)),this.noteBoxHeight>this.noteBoxWidth-20&&(this.noteBoxHeight=this.noteBoxWidth-20))},initColorItems:function(){var a=(this.noteBoxWidth-72)/7;4>a&&(a=4);for(var b=0;b<this.colorArr.length;b++){var c=$("<span style='float:left;cursor:pointer;background:"+this.colorArr[b]+";margin: 9px 0 9px "+a+"px;width:12px;height:12px;display:inline-block;border-radius:50%;box-shadow:0 0 0 1px rgba(11,11,11,0.3);-webkit-box-shadow:0 0 0 1px rgba(11,11,11,0.3)'></span>");
b==this.colorIndex&&(c.addClass("active").css({"box-shadow":"0 0 0 2px #4BA0FF","-webkit-box-shadow":"0 0 0 2px #4BA0FF"}),this.noteBox.css({background:this.colorArr[b]}));this.colorItemEvent(c,b);this.colorBox.append(c)}},colorItemEvent:function(a,b){a.bind(_event._click,function(){this.colorBox.find("span").removeClass("active").css({"box-shadow":"0 0 0 1px rgba(11,11,11,0.3)","-webkit-box-shadow":"0 0 0 1px rgba(11,11,11,0.3)"});a.css({"box-shadow":"0 0 0 2px #4BA0FF","-webkit-box-shadow":"0 0 0 2px #4BA0FF"}).addClass("active");
this.noteBox.css({background:this.colorArr[b]});this.setColorIndex(b);this.icon.html(this.getNoteSvg(this.colorArr[b]));this.saveNoteCookie()}.bind(this))},getNoteSvg:function(a){return'<svg style="position:absolute;top:0;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"><defs><style>.cls-1, .cls-2 {fill-rule: evenodd;}.cls-1 {opacity: 0.85;}</style></defs><path id="\u8930\u3222\u59f8_2" data-name="\u8930\u3222\u59f8 2" class="cls-1" d="M2,0H15.917A1.98,1.98,0,0,1,18,2V13l-5,5s-8.875.063-11,0-2-2.667-2-2.667-0.062-10.562,0-13S2,0,2,0Z"/><path  fill="'+
...
b.on("panstart",function(c){c=this.getPanPosition(c);this.X=c.x;this.Y=c.y;this.isfocus=!0}.bind(this));b.on("panend",function(c){var g=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){g.isfocus=!1;return h.yield(g.saveNoteCookie(),0)})}.bind(this));b.on("panmove",function(c){var g=this,h,n,p,z,v,B,D,M,Q,ca,V,da,na,sa;return $jscomp.asyncExecutePromiseGeneratorProgram(function(aa){switch(aa.nextAddress){case 1:if(!g.isfocus){aa.jumpTo(0);break}g.initPageConfig();h=global.annotationCookie.tranScale||
1;n=global.annotationCookie.scale||1;p=g.getPanPosition(c);z=p.x/n-g.X/n;v=p.y/n-g.Y/n;B=a.left()+z;D=a.top()+v;M=g.parent.offset();Q=parseInt((g.pageWidth-g.parent.width())/2);ca=(g.pageHeight-g.parent.height())/2;V=BookInfo.getCurrentPages();da=0;if(2>V.length){B<=-Q&&(B=-Q);B>=g.pageWidth-a.width()-Q&&(B=g.pageWidth-a.width()-Q);aa.jumpTo(3);break}if(Math.ceil(M.left-Q)>=parseInt(windowWidth/2)){aa.jumpTo(4);break}if(B<=-Q){B=-Q;aa.jumpTo(3);break}if(!(p.x>=M.left+g.pageWidth+a.width()/2-Q&&2==
V.length)){p.x>=M.left+g.pageWidth-a.width()/2-Q&&p.x<=M.left+g.pageWidth+a.width()/2+-Q&&(B=g.pageWidth-a.width()-Q);aa.jumpTo(3);break}na=0;case 8:if(!(na<V.length)){aa.jumpTo(3);break}sa=g.getPage(V[na]);if(sa[0]==g.parent[0]){aa.jumpTo(9);break}Q=(g.pageWidth-sa.width())/2;B=-Q;sa.css({display:"block"}).append(a);g.parent=sa;return aa.yield(global.annotationCookie.deleteNoteCookie("Note",g.config.index,g.config.id),12);case 12:return g.config.index=V[na]-1,aa.yield(g.saveNoteCookie(),13);case 13:aa.jumpTo(3);
break;case 9:na++;aa.jumpTo(8);break;case 4:if(!(2==V.length&&p.x-M.left<-a.width()/2-Q)){B<=-Q&&(B=-Q);B>=g.pageWidth-a.width()-Q&&(B=g.pageWidth-a.width()-Q);aa.jumpTo(3);break}na=0;case 15:if(!(na<V.length)){aa.jumpTo(3);break}sa=g.getPage(V[na]);if(sa[0]==g.parent[0]){aa.jumpTo(16);break}Q=(g.pageWidth-sa.width())/2;B=g.pageWidth-a.width()-Q;sa.css({display:"block"}).append(a);g.parent=sa;return aa.yield(global.annotationCookie.deleteNoteCookie("Note",g.config.index,g.config.id),19);case 19:return g.config.index=
V[na]-1,aa.yield(g.saveNoteCookie(),20);case 20:aa.jumpTo(3);break;case 16:na++;aa.jumpTo(15);break;case 3:D<=-ca?D=-ca:isPhone()||isPad()?D>g.pageHeight-a.height()-ca&&(D=g.pageHeight-a.height()-ca):D>g.pageHeight-a.height()-10-(g.noteBox.height()+24)*h-ca&&(D=g.pageHeight-a.height()-10-(g.noteBox.height()+24)*h-ca),B<=-Q&&(B=-Q),B>=g.pageWidth-a.width()-Q&&(B=g.pageWidth-a.width()-Q),a.css({left:parseFloat(B)+"px",top:parseFloat(D)+"px"}),isPhone()||isPad()||(g.pageWidth-g.container.left()-Q<=g.noteBox.width()*
...
this.colorBox.css({"text-align":"center",position:"absolute",overflow:"hidden",bottom:"0",left:"0",width:"100%",height:"40px",background:"rgba(11,11,11,0.1)"});this.close.find(".note-btn-icon").css({background:"url("+uiBaseURL+"annotationSprite.png) -72px -1px no-repeat",position:"absolute",height:"14px",width:"14px",top:"4px",right:"5px"});this.remove.find(".note-btn-icon").css({background:"url("+uiBaseURL+"annotationSprite.png) -120px -17px no-repeat",position:"absolute",height:"14px",width:"14px",
top:"4px",right:"5px"});this.close.css({cursor:"pointer",position:"absolute",height:"14px",width:"14px",padding:"5px",top:"8px",right:"9px"});this.remove.css({cursor:"pointer",position:"absolute",height:"14px",width:"14px",padding:"5px",top:"8px",right:"42px"});this.icon.css({cursor:"pointer",width:"100%",height:"100%"});this.icon.find("img").css({position:"relative",cursor:"pointer",width:"100%",height:"100%","z-index":"51"});this.noteBox.css({overflow:"hidden","border-radius":"5px","padding-bottom":"40px",
"z-index":"1","-webkit-box-shadow":" 2px 2px 5px #111","-o-box-shadow":" 2px 2px 5px #111","-moz-box-shadow":" 2px 2px 5px #111","-ms-box-shadow":" 2px 2px 5px #111","box-shadow":" 2px 2px 5px #111",position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)","min-width":this.noteBoxWidth/a+"px","min-height":this.noteBoxHeight/a+"px"});this.noteTitle.css({overflow:"hidden","text-overflow":"ellipsis","white-space":"nowrap","font-size":12/a+"px",position:"relative",width:this.noteBoxWidth-
82+"px",padding:12/a+"px "+8/a+"px"});this.textarea.css({resize:"none",border:"none",overflow:"auto","padding-top":"5px",background:"transparent","font-size":12/a+"px",position:"relative",width:(this.noteBoxWidth-20)/a+"px",margin:"0 "+8/a+"px 0",height:this.noteBoxHeight/a+"px"});if(isPad()||isPhone())this.close.find(".note-btn-icon").css({opacity:"1"}),this.remove.find(".note-btn-icon").css({opacity:"1"})},showOrHide:function(){this.noteShow?(this.initPageConfig(),this.initColorItems(),this.initCss(),
this.mobileNoteBox.html(this.noteBox),tmpContainer.append(this.mobileNoteBox),this.mobileNoteBox.css({display:"block"}),this.noteBox.css({display:"block"}),this.initNoteEvent(),this.noteShow=!1):(this.mobileNoteBox.css({display:"none"}),this.mobileNoteBox.html(""),this.mobileNoteBox.remove(),this.noteBox.css({display:"none"}),this.noteShow=!0);this.hasMove=!1}}).extend("AnnotationAddNote"),HardPage=Class({create:function(a,b,c,g,h){this._super(a,b,c,g,h);this.isHardPage=!0;this.borderWidth=bookConfig.hardCoverBorderWidth;
this.outerCoverBorder=bookConfig.outerCoverBorder||BookInfo.isInnerPage(a,g);this.$page=$("<div class='hardSide' style='background-color:"+bookConfig.borderColor+";'></div>");this.$page.append(this.page.side);this.page.side.addClass("pageSide");this.renderPage()},newPage:function(a,b,c,g){this.page=new HardSide(a,b,c,g)},setLeftOrRight:function(a){(this.isLeft=a)?this.setCSSByName("left-side"):this.setCSSByName("right-side");var b=a&&this.outerCoverBorder?this.borderWidth:0,c=bookConfig.cornerRound;
a?(this.$page.css({"border-radius":c+"px 0px 0px "+c+"px"}),this.$page.css({"margin-top":-this.borderWidth+"px","margin-left":-this.borderWidth+"px"})):(this.$page.css({"border-radius":"0px "+c+"px "+c+"px 0px"}),this.$page.css({"margin-top":-this.borderWidth+"px","margin-right":-this.borderWidth+"px"}));this.page.side.css({left:b+"px"})},setUpOrDown:function(a){(this.isUp=a)?this.setCSSByName("up-side"):this.setCSSByName("down-side");var b=a&&this.outerCoverBorder?this.borderWidth:0,c=bookConfig.cornerRound;
a?(this.$page.css({"border-radius":c+"px "+c+"px 0px 0px"}),this.$page.css({"margin-top":-this.borderWidth+"px","margin-left":-this.borderWidth+"px"})):(this.$page.css({"border-radius":"0px 0px "+c+"px "+c+"px"}),this.$page.css({"margin-bottom":-this.borderWidth+"px","margin-left":-this.borderWidth+"px"}));this.page.side.css({top:b+"px"})},onResize:function(a,b,c){this.pageWidth=a;this.pageHeight=b;bookConfig.FlipDirection?(this.width=a+2*this.borderWidth,this.height=b+this.borderWidth,this.pageWidth=
this.outerCoverBorder?a:a+2*this.borderWidth,this.pageHeight=this.outerCoverBorder?b:b+this.borderWidth):(this.width=a+this.borderWidth,this.height=b+2*this.borderWidth,this.pageWidth=this.outerCoverBorder?a:a+this.borderWidth,this.pageHeight=this.outerCoverBorder?b:b+2*this.borderWidth);if(this.page)this.page.onResize(this.pageWidth,this.pageHeight);this.$page.css({width:this.width,height:this.height});bookConfig.FlipDirection?this.page.side.css({left:this.outerCoverBorder?this.borderWidth:0}):this.page.side.css({top:this.outerCoverBorder?
this.borderWidth:0});if(this.rendering)this.rendering.onResize(a,b)},renderPage:function(){this.rendering&&(this.rendering.destroy(),this.rendering=null);this.rendering=new PageRendering(this.$page,this.pageIndex,this.bookType);this.rendering.onResize(this.width,this.height);this.rendering.render()},beginToFlip:function(){},setHardCover:function(a,b,c,g,h){this.outerCoverBorder=bookConfig.outerCoverBorder||BookInfo.isInnerPage(this.pageIndex,this.bookType);this.$page.css("background-color",bookConfig.borderColor);
this.borderWidth!=bookConfig.hardCoverBorderWidth&&(this.borderWidth=bookConfig.hardCoverBorderWidth,bookConfig.FlipDirection?this.setUpOrDown(this.isUp):this.setLeftOrRight(this.isLeft),this.onResize(this.pageWidth,this.pageHeight));this.renderPage()}}).extend(PageInterface),HardSide=Class({create:function(a,b,c,g){this._super(a,b,c,g);this.isHard=!0},addFlipShadow:function(){},renderPage:function(){}}).extend(BookPage),HardCover=Class({create:function(a){this.parent=a;this.borderWidth=bookConfig.hardCoverBorderWidth;
this.rightToLeft=bookConfig.RightToLeft;this.cover=$("<div class='hardCover'></div>");this.initPage();this.initBookSpine();this.parent.append(this.cover)},initPage:function(){var a=BookInfo.getHardCoverPages(!0);this.leftPage=new HardPage(a[0],"coverPage",!1,BookType.normal_book);this.rightPage=new HardPage(a[1],"coverPage",!1,BookType.normal_book);this.cover.append(this.leftPage.$page);this.cover.append(this.rightPage.$page);this.leftPage.rendering.midCoil&&this.leftPage.rendering.midCoil.hide();
this.rightPage.rendering.midCoil&&this.rightPage.rendering.midCoil.hide();this.leftPage.setLeftOrRight(!0);this.rightPage.setLeftOrRight(!1);this.leftPage.setCSSByStyle({top:"0",left:"0","margin-top":0,"margin-left":0});this.rightPage.setCSSByStyle({top:"0",right:"0","margin-top":0,"margin-right":0})},initBookSpine:function(){this.topSpine=new BookSpine(this.cover);this.bottomSpine=new BookSpine(this.cover);this.topSpine.setCSSByName("top_spine");this.bottomSpine.setCSSByName("botoom_spine")},onResize:function(a,
b,c){if(this.leftPage)this.leftPage.onResize(a,b);if(this.rightPage)this.rightPage.onResize(a,b);this.topSpine.onResize(c);this.bottomSpine.onResize(c);this.pageWidth=a;this.pageHeight=b;this.resizeCover(a,b,c)},resizeCover:function(a,b,c){this.thicknessWidthArray=c;this.width=2*a+(c[0]+c[1])+2*this.borderWidth;this.height=b+2*this.borderWidth;this.cover.css({width:this.width+"px",height:this.height+"px",left:-(this.borderWidth+c[0])+"px",top:-this.borderWidth+"px"})},refresh:function(a,b,c){this.refreshBookSpine(b);
this.refreshPage(a,c);this.resizeCover(this.pageWidth,this.pageHeight,b)},getSensitiveIndex:function(){return BookInfo.getSensitiveIndex(!0)},refreshPage:function(a,b){var c=this.getSensitiveIndex().min,g=this.getSensitiveIndex().max;if(a<=c||a>=g){if(a<=c&&bookConfig.RightToLeft||!bookConfig.RightToLeft&&a>=g)this.rightPage&&this.rightPage.setVisible(!1),(b<g&&bookConfig.RightToLeft||b>c&&!bookConfig.RightToLeft)&&this.leftPage&&this.leftPage.setVisible(!0);if(a<=c&&!bookConfig.RightToLeft||bookConfig.RightToLeft&&
a>=g)this.leftPage&&this.leftPage.setVisible(!1),(b<g&&!bookConfig.RightToLeft||b>c&&bookConfig.RightToLeft)&&this.rightPage&&this.rightPage.setVisible(!0);this.hideBookSpine()}else this.showBookSpine(),this.leftPage&&this.leftPage.setVisible(!0),this.rightPage&&this.rightPage.setVisible(!0)},refreshBookSpine:function(a){this.topSpine.refresh(a);this.bottomSpine.refresh(a)},hideBookSpine:function(){this.topSpine.hide();this.bottomSpine.hide()},showBookSpine:function(){this.topSpine.show();this.bottomSpine.show()},
...
2,totalPageCount].indexOf(b)&&0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(a))return!1;0>[1,totalPageCount].indexOf(b)&&[1,totalPageCount].indexOf(a);return!0},toHardPage:function(a){return!1},toCoverPage:function(a){var b=this.currentPageIndex;return 0>[1,2,totalPageCount-1,totalPageCount].indexOf(b)&&0>[1,2,totalPageCount-1,totalPageCount].indexOf(a)||0<=[2,3].indexOf(b)&&0>[1,totalPageCount].indexOf(a)||0>[1,totalPageCount].indexOf(b)&&0>[1,totalPageCount].indexOf(a)?!1:!0},isHardPage:function(a,
b){return!1},isCoverPage:function(a,b){return 1==a||2==a||a==totalPageCount||a==totalPageCount-1?!0:!1},gotoNearPage:function(a){1==this.currentPageIndex?gotoPageFun(2,!1,"cross page"):this.currentPageIndex==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):a==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):1==a&&gotoPageFun(2,!1,"cross page")},initBook:function(){this._super();this.hardCover=new HardCover(this.flipBook)},newPage:function(a){return 1==a||2==a||a==totalPageCount||
a==totalPageCount-1?new HardPage(a,"page",!1,BookType.normal_book):new NormalPage(a,"page",!1,BookType.normal_book)},followToPoint:function(a,b,c){this._super(a,b,c);this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth())},getDownUpHardPage:function(a,b,c){this.addPageArray([a,b]);c?(this.pageArray[a]&&this.pageArray[a].setLeftOrRight(!0),this.pageArray[b]&&this.pageArray[b].setLeftOrRight(!1),this.pageArray[a]&&this.pageArray[a].setCSSByName("flip-hard-left-side"),this.pageArray[b]&&
this.pageArray[b].setCSSByName("flip-hard-right-side")):(this.pageArray[a]&&this.pageArray[a].setLeftOrRight(!1),this.pageArray[b]&&this.pageArray[b].setLeftOrRight(!0),this.pageArray[a]&&this.pageArray[a].setCSSByName("flip-hard-right-side"),this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-left-side"));return[this.pageArray[a],this.pageArray[b]]},setAttachmentBeforeFlipTo:function(a){this._super(a);this.hardCover&&this.hardCover.refresh(a,this.getThicknessWidth(),this.currentPageIndex)},
...
b,this.getThicknessWidth());this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},resizeBook:function(a,b){this._super(a,b);this.hardCover.onResize(a,b,this.getThicknessWidth());this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},show:function(){this._super();this.hardCover.show()},hide:function(){this._super();this.hardCover.hide()}}).extend(NormalBook),OpenHardBook=Class({crossFlipMode:function(a){var b=this.currentPageIndex;
return 0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(b)&&0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(a)||totalPageCount!=b&&totalPageCount!=a?!1:!0},toSoftPage:function(a){return 0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(this.currentPageIndex)&&0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(a)?!1:!0},toCoverPage:function(a){return totalPageCount!=this.currentPageIndex&&totalPageCount!=a?!1:!0},isCoverPage:function(a,b){return a==
totalPageCount||a==totalPageCount-1?!0:!1},gotoNearPage:function(a){this.currentPageIndex==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):a==totalPageCount&&gotoPageFun(totalPageCount-1,!1,"cross page")},newPage:function(a){return 1==a||a==totalPageCount||a==totalPageCount-1?new HardPage(a,"page",!1,BookType.normal_book):new NormalPage(a,"page",!1,BookType.normal_book)}}).extend(HardBook),SingleHardCover=Class({initPage:function(){var a=BookInfo.getHardCoverPages(!1);bookConfig.RightToLeft&&
(this.leftPage=new HardPage(a[0],"coverPage",!0,BookType.single_book));bookConfig.RightToLeft||(this.rightPage=new HardPage(a[0],"coverPage",!0,BookType.single_book));this.leftPage&&this.cover.append(this.leftPage.$page);this.rightPage&&this.cover.append(this.rightPage.$page);this.leftPage&&this.leftPage.setLeftOrRight(!0);this.rightPage&&this.rightPage.setLeftOrRight(!1);this.leftPage&&this.leftPage.setCSSByStyle({top:"0",left:"0","margin-top":0,"margin-left":0});this.rightPage&&this.rightPage.setCSSByStyle({top:"0",
right:"0","margin-top":0,"margin-right":0})},getSensitiveIndex:function(){return BookInfo.getSensitiveIndex(!1)},initBookSpine:function(){this.topSpine=new SingleBookSpine(this.cover);this.bottomSpine=new SingleBookSpine(this.cover);this.topSpine.setCSSByName("top_spine");this.bottomSpine.setCSSByName("botoom_spine")},resizeCover:function(a,b,c){this.thicknessWidthArray=c;this.width=a+(c[0]+c[1])+this.borderWidth;this.height=b+2*this.borderWidth;this.cover.css({width:this.width+"px",height:this.height+
"px",left:(bookConfig.RightToLeft?-(this.borderWidth+c[0]):0)+"px",top:-this.borderWidth+"px"})}}).extend(HardCover),SingleBookSpine=Class({onResize:function(a){this.width=a[0]+a[1];this.bookSpine.css({width:this.width});bookConfig.RightToLeft?this.bookSpine.css({left:"auto",right:"0"}):this.bookSpine.css({right:"auto",left:"0"})}}).extend(BookSpine),SingleHardBook=Class({bookType:BookType.single_book,create:function(a){this._super(a)},crossFlipMode:function(a){var b=this.currentPageIndex;return 1==
...
2,totalPageCount].indexOf(a)||0>[1,totalPageCount].indexOf(b)&&0>[1,totalPageCount].indexOf(a)?!1:!0},toSoftPage:function(a){return!1},toHardPage:function(a){var b=this.currentPageIndex;if(0<=[1,2,3].indexOf(b)&&0<=[1,2,3].indexOf(a)||0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(b)&&0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(a))return!1;0>[1,totalPageCount].indexOf(b)&&[1,totalPageCount].indexOf(a);return!0},toCoverPage:function(a){var b=this.currentPageIndex;return 0>
[1,2,totalPageCount-1,totalPageCount].indexOf(b)&&0>[1,2,totalPageCount-1,totalPageCount].indexOf(a)||0<=[2,3].indexOf(b)&&0>[1,totalPageCount].indexOf(a)||0>[1,totalPageCount].indexOf(b)&&0>[1,totalPageCount].indexOf(a)?!1:!0},isHardPage:function(a,b){return 1==a||2==a||a==totalPageCount||a==totalPageCount-1?!1:!0},isCoverPage:function(a,b){return 1==a||2==a||a==totalPageCount||a==totalPageCount-1?!0:!1},gotoNearPage:function(a){1==this.currentPageIndex?gotoPageFun(2,!1,"cross page"):this.currentPageIndex==
totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):a==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):1==a&&gotoPageFun(2,!1,"cross page")},initBook:function(){this._super();this.hardCover=new HardCover(this.flipBook)},newPage:function(a){return 1==a||2==a||a==totalPageCount||a==totalPageCount-1?new HardPage(a,"page",!1,BookType.normal_book):new AlbumPage(a,"page",!1,BookType.normal_book)},followToPoint:function(a,b,c){this._super(a,b,c);this.hardCover.refresh(this.currentPageIndex,
this.getThicknessWidth())},getDownUpHardPage:function(a,b,c){this.addPageArray([a,b]);c?(this.pageArray[a]&&this.pageArray[a].setLeftOrRight(!0),this.pageArray[b]&&this.pageArray[b].setLeftOrRight(!1),this.pageArray[a]&&this.pageArray[a].setCSSByName("flip-hard-left-side"),this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-right-side")):(this.pageArray[a]&&this.pageArray[a].setLeftOrRight(!1),this.pageArray[b]&&this.pageArray[b].setLeftOrRight(!0),this.pageArray[a]&&this.pageArray[a].setCSSByName("flip-hard-right-side"),
...
2,totalPageCount].indexOf(this.currentPageIndex)&&0<=[totalPageCount-1,totalPageCount-2,totalPageCount].indexOf(a)?!1:!0},toCoverPage:function(a){return totalPageCount!=this.currentPageIndex&&totalPageCount!=a?!1:!0},isHardPage:function(a,b){return a==totalPageCount||a==totalPageCount-1?!1:!0},isCoverPage:function(a,b){return a==totalPageCount||a==totalPageCount-1?!0:!1},gotoNearPage:function(a){this.currentPageIndex==totalPageCount?gotoPageFun(totalPageCount-1,!1,"cross page"):a==totalPageCount&&
gotoPageFun(totalPageCount-1,!1,"cross page")},newPage:function(a){return 1==a||a==totalPageCount||a==totalPageCount-1?new HardPage(a,"page",!1,BookType.normal_book):new AlbumPage(a,"page",!1,BookType.normal_book)}}).extend(AlbumHardBook),SingleAlbumBook=Class({bookType:BookType.single_book,create:function(a){this._super(a)},crossFlipMode:function(a){return!1},toSoftPage:function(a){return!1},toHardPage:function(a){return!0},isHardPage:function(a,b){return!0},toCoverPage:function(){return!1},isCoverPage:function(){return!1},
...
(this.pageArray[c]&&this.pageArray[c].setLeftOrRight(!1),this.pageBackArray[c]&&this.pageBackArray[c].setLeftOrRight(!1),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-right-side"),this.pageBackArray[c]&&this.pageBackArray[c].setCSSByName("flip-hard-left-side"));return[this.pageArray[c],this.pageBackArray[c]]}}).extend(SingleBook),SingleAlbumHardBook=Class({bookType:BookType.single_book,create:function(a){this._super(a)},crossFlipMode:function(a){var b=this.currentPageIndex;return 1==
b&&2!=a||2!=b&&1==a?!0:!1},toSoftPage:function(a){return!1},toHardPage:function(a){return 2==a||1==a?!1:!0},toCoverPage:function(a){return 1!=a?!1:!0},isCoverPage:function(a,b){var c=a;a>b&&(c=b);return 1==c||c==bookConfig.totalPageCount?!0:!1},isHardPage:function(a,b){var c=a;a>b&&(c=b);return 1==c||c==bookConfig.totalPageCount?!1:!0},gotoNearPage:function(a){1==this.currentPageIndex?gotoPageFun(2,!1,"cross page"):1==a&&gotoPageFun(2,!1,"cross page")},initBook:function(){this._super();this.hardCover=
new SingleHardCover(this.flipBook)},newPage:function(a){1==a||a==bookConfig.totalPageCount?(a=new HardPage(a,"page",!0,BookType.single_book),a.setLeftOrRight(bookConfig.RightToLeft)):a=new AlbumPage(a,"page",!0,BookType.single_book);return a},newPageBack:function(a){1==a||a==bookConfig.totalPageCount?(a=new HardPage(a,"pageBack",!0,BookType.single_book),a.setLeftOrRight(bookConfig.RightToLeft)):a=new AlbumPage(a,"pageBack",!0,BookType.single_book,!0);return a},followToPoint:function(a,b,c){this._super(a,
b,c);this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth())},getDownUpHardPage:function(a,b){var c=a;a>b&&(c=b);this.addPageArray([c]);this.addPageBackArray([c]);bookConfig.RightToLeft?(this.pageArray[c]&&this.pageArray[c].setLeftOrRight(!0),this.pageBackArray[c]&&this.pageBackArray[c].setLeftOrRight(!0),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-left-side"),this.pageBackArray[c]&&this.pageBackArray[c].setCSSByName("flip-hard-right-side")):(this.pageArray[c]&&this.pageArray[c].setLeftOrRight(!1),
this.pageBackArray[c]&&this.pageBackArray[c].setLeftOrRight(!1),this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-right-side"),this.pageBackArray[c]&&this.pageBackArray[c].setCSSByName("flip-hard-left-side"));return[this.pageArray[c],this.pageBackArray[c]]},setAttachmentBeforeFlipTo:function(a){this._super(a);this.hardCover&&this.hardCover.refresh(a,this.getThicknessWidth(),this.currentPageIndex)},afterCurling:function(){this._super();this.hardCover&&this.hardCover.refresh(this.currentPageIndex,
this.getThicknessWidth(),this.currentPageIndex)},setAttachmentAfterFlipTo:function(a){this._super(a);this.hardCover&&this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},getThicknessWidth:function(){var a=[0,0];this.bookAttachments.Items.find("ThicknessManager").each(function(b){a=b.getThicknessWidth()});return a},onResize:function(a,b){this._super(a,b);this.hardCover.onResize(a,b,this.getThicknessWidth());this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),
this.currentPageIndex)},resizeBook:function(a,b){this._super(a,b);this.hardCover.onResize(a,b,this.getThicknessWidth());this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),this.currentPageIndex)},show:function(){this._super();this.hardCover.show()},hide:function(){this._super();this.hardCover.hide()}}).extend(SingleBook),SingleCalendarPage=Class({flipToPoint:function(a,b,c){if(a&&b)if(1==this.hardPage)this.flipToHardPoint(a,b);else if(this.downMask&&this.upMask&&this.downMask.page&&
this.upMask.page){this.coordinate=b;var g=this.pageWidth,h=computePoint(this.pageHeight,g,this.maskWidth,a,b);if(h){var n=transformCSS({rotate:h.rotate,tran:{x:-h.maskTranY,y:h.maskTranX}}),p=transformCSS({rotate:h.rotate,tran:{x:-h.maskTranY,y:h.maskTranX}}),z=transformCSS({rotate:-h.rotate,tran:{x:0,y:-h.pageTranX}}),v=transformCSS({rotate:h.rotate,tran:{x:0,y:h.pageTranX}});this.downMask&&this.downMask.setCSSByStyle(n);this.upMask&&this.upMask.setCSSByStyle(p);this.downMask&&this.downMask.page&&
this.downMask.page.setCSSByStyle(z);this.upMask&&this.upMask.page&&this.upMask.page.setCSSByStyle(v);this.setFlipAlpha(g,a,b);this.setFlipShadow(h,c);this.book.followToPoint(this,a,b)}}},flipToHardPoint:function(a,b){if(a&&b){this.coordinate=b;var c=this.pageWidth,g=computePoint(this.pageHeight,c,this.maskWidth,a,b);if(g){var h=-90+90*Math.abs(b.x/a.x);0>b.x&&(h=90-90*Math.abs(b.x/a.x));var n=transformCSS({perspective:6E3,rotateX:-h});h=transformCSS({perspective:6E3,rotateX:-h});this.downMask&&this.downMask.setCSSByStyle(n);
this.upMask&&this.upMask.setCSSByStyle(h);0>b.x/a.x?(this.upMask.setVisible(!1),this.downMask.setVisible(!1)):(this.upMask.setVisible(!1),this.downMask.setVisible(!0));this.setHardFlipShadow(g);this.setFlipAlpha(c,a,b);this.book.followToPoint(this,a,b)}}},setPageZIndex:function(){var a=this.downMask.pageIndex,b=this.upMask.pageIndex,c=originTotalPageCount+5+b,g=originTotalPageCount+5-a;if(bookConfig.HardPageEnable){if(b==totalPageCount||1==b)c=2*(bookConfig.totalPageCount+5)+10;if(a==totalPageCount||
1==a)g=2*(bookConfig.totalPageCount+5)+10}this.upMask.setZIndex(c);this.downMask.setZIndex(g)},setFlipAlpha:function(a,b,c){},setFlipOriginPoint:function(){this.dragMoveToFlip||rightToLeft||(this.fromPoint={x:this.pageHeight,y:0});!this.dragMoveToFlip&&rightToLeft&&(this.fromPoint={x:-this.pageHeight,y:0});this.toPoint="left"==this.book.flipToDirection?{x:-this.pageHeight,y:this.fromPoint.y}:{x:this.pageHeight,y:this.fromPoint.y};this.startPoint||(this.startPoint={x:0,y:0});this.startPoint.x=-this.toPoint.x;
this.startPoint.y=this.toPoint.y},endFlipByIndex:function(a){a=transformCSS({rotate:0,tran:{x:0,y:0}});this.upMask.setCSSByStyle(a);this.upMask.page&&this.upMask.page.setCSSByStyle(a);this.downMask.setCSSByStyle(a);this.downMask.page&&this.downMask.page.setCSSByStyle(a);this.upMask.setUpOrDown(rightToLeft);this.downMask.setUpOrDown(rightToLeft);this.book.setZIndexByPageIndex(this.upMask);this.book.setZIndexByPageIndex(this.downMask);this.upMask.clearFlipShadow();this.downMask.clearFlipShadow()}}).extend(SingleFlipPage),
DoubleCalendarPage=Class({flipToPoint:function(a,b,c){if(a&&b)if(1==this.hardPage)this.flipToHardPoint(a,b);else if(this.downMask&&this.upMask&&this.downMask.page&&this.upMask.page){this.coordinate=b;var g=this.pageWidth,h=computePoint(this.pageHeight,g,this.maskWidth,a,b);if(h){var n=transformCSS({rotate:h.rotate,tran:{x:-h.maskTranY,y:h.maskTranX}}),p=transformCSS({rotate:h.rotate,tran:{x:-h.maskTranY,y:h.maskTranX}}),z=transformCSS({rotate:-h.rotate,tran:{x:0,y:-h.pageTranX}}),v=transformCSS({rotate:h.rotate,
tran:{x:0,y:h.pageTranX}});this.downMask&&this.downMask.setCSSByStyle(n);this.upMask&&this.upMask.setCSSByStyle(p);this.downMask&&this.downMask.page&&this.downMask.page.setCSSByStyle(z);this.upMask&&this.upMask.page&&this.upMask.page.setCSSByStyle(v);this.setFlipAlpha(g,a,b);this.setFlipShadow(h,c);this.book.followToPoint(this,a,b)}}},flipToHardPoint:function(a,b){if(a&&b){var c=this.pageWidth,g=this.pageHeight,h=this.maskWidth;b.x>g&&(b.x=g);b.x<-g&&(b.x=-g);this.coordinate=b;if(g=computePoint(g,
c,h,a,b)){var n=-90+90*Math.abs(b.x/a.x);0>b.x&&(n=90-90*Math.abs(b.x/a.x));h=transformCSS({perspective:6E3,rotateX:-n});n=transformCSS({perspective:6E3,rotateX:-n});this.downMask&&this.downMask.setCSSByStyle(h);this.upMask&&this.upMask.setCSSByStyle(n);0>b.x/a.x?this.setPagesVisible(!1):this.setPagesVisible(!0);this.setHardFlipShadow(g);this.setFlipAlpha(c,a,b);this.book.followToPoint(this,a,b)}}},setFlipOriginPoint:function(a){this.dragMoveToFlip||"left"!=a||(this.fromPoint={x:this.pageHeight,y:0});
this.dragMoveToFlip||"right"!=a||(this.fromPoint={x:-this.pageHeight,y:0});this.toPoint={x:-this.fromPoint.x,y:this.fromPoint.y};this.startPoint||(this.startPoint={x:0,y:0});this.startPoint.x=this.fromPoint.x;this.startPoint.y=this.fromPoint.y},endFlipByIndex:function(a){var b=transformCSS({rotate:0,tran:{x:0,y:0}});this.upMask.setCSSByStyle(b);this.upMask.page&&this.upMask.page.setCSSByStyle(b);this.downMask.setCSSByStyle(b);this.downMask.page&&this.downMask.page.setCSSByStyle(b);a?(this.downMask.setUpOrDown(!0),
this.upMask.setUpOrDown(!0)):(this.downMask.setUpOrDown(!1),this.upMask.setUpOrDown(!1));this.book.setZIndexByPageIndex(this.upMask);this.book.setZIndexByPageIndex(this.downMask);this.upMask.clearFlipShadow();this.downMask.clearFlipShadow()}}).extend(DoubleFlipPage),DoubleCalendar=Class({bookType:BookType.normal_book,doublePage:!0,create:function(a){this._super(a);this.resetZoomArea()},initBook:function(){this._super();this.showPage=this.flipBook},newFlipPage:function(){return new DoubleCalendarPage(this)},
newPage:function(a){return new NormalPage(a,"page",!1,this.bookType)},setPageCss:function(){var a=transformCSS({rotate:0,tran:{x:0,y:0}});this.currentPage&&(this.setZIndexByPageIndex(this.currentPage),this.currentPage.setCSSByStyle(a));this.previousPage&&(this.setZIndexByPageIndex(this.previousPage),this.previousPage.setCSSByStyle(a));this.previousPage2&&(this.setZIndexByPageIndex(this.previousPage2),this.previousPage2.setCSSByStyle(a));this.currentPage2&&(this.setZIndexByPageIndex(this.currentPage2),
this.currentPage2.setCSSByStyle(a));this.nextPage&&(this.setZIndexByPageIndex(this.nextPage),this.nextPage.setCSSByStyle(a));this.nextPage2&&(this.setZIndexByPageIndex(this.nextPage2),this.nextPage2.setCSSByStyle(a));rightToLeft?(this.currentPage&&this.currentPage.setUpOrDown(!1),this.previousPage&&this.previousPage.setUpOrDown(!1),this.previousPage2&&this.previousPage2.setUpOrDown(!1),this.currentPage2&&this.currentPage2.setUpOrDown(!0),this.nextPage&&this.nextPage.setUpOrDown(!0),this.nextPage2&&
this.nextPage2.setUpOrDown(!0)):(this.currentPage&&this.currentPage.setUpOrDown(!0),this.previousPage&&this.previousPage.setUpOrDown(!0),this.previousPage2&&this.previousPage2.setUpOrDown(!0),this.currentPage2&&this.currentPage2.setUpOrDown(!1),this.nextPage&&this.nextPage.setUpOrDown(!1),this.nextPage2&&this.nextPage2.setUpOrDown(!1))},getDownUpHardPage:function(a,b,c){this.addPageArray([a,b]);c?(this.pageArray[a]&&this.pageArray[a].setCSSByName("flip-hard-up-side"),this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-down-side")):
(this.pageArray[a]&&this.pageArray[a].setCSSByName("flip-hard-down-side"),this.pageArray[b]&&this.pageArray[b].setCSSByName("flip-hard-up-side"));return[this.pageArray[a],this.pageArray[b]]},flipToMax:function(a,b,c,g){g=this.flipPageManager.initFlipPageByIndex(a,b,g);this.addPagesBeforeFlipToMax(b,c);this.pageArray[b+1]&&(this.pageArray[b+1].setUpOrDown(rightToLeft),g.nextPage=this.pageArray[b+1]);this.setPagesStyleBeforeFlipToMax(b,c);this.deleteUnnecessaryPagesBeforeFlipToMax(a,b);return g},setPagesStyleBeforeFlipToMax:function(a,
b){b&&this.supportSerialsFlip()&&(this.pageArray[a+1]&&this.setZIndexByPageIndex(this.pageArray[a+1],a),this.pageArray[a+2]&&(this.setZIndexByPageIndex(this.pageArray[a+2],a),this.pageArray[a+2].setUpOrDown(rightToLeft)),this.pageArray[a+3]&&(this.setZIndexByPageIndex(this.pageArray[a+3],a),this.pageArray[a+3].setUpOrDown(rightToLeft)))},setPagesStyleAfterFlipToMax:function(a){this.pageArray[a]&&(this.setZIndexByPageIndex(this.pageArray[a],a),this.pageArray[a].setUpOrDown(!rightToLeft));this.pageArray[a-
1]&&(this.setZIndexByPageIndex(this.pageArray[a-1],a),this.pageArray[a-1].setUpOrDown(!rightToLeft));this.pageArray[a-2]&&(this.setZIndexByPageIndex(this.pageArray[a-2],a),this.pageArray[a-2].setUpOrDown(!rightToLeft));this.supportSerialsFlip()&&this.flipping||(this.pageArray[a+1]&&this.setZIndexByPageIndex(this.pageArray[a+1]),this.pageArray[a+2]&&(this.setZIndexByPageIndex(this.pageArray[a+2]),this.pageArray[a+2].setUpOrDown(rightToLeft)),this.pageArray[a+3]&&(this.setZIndexByPageIndex(this.pageArray[a+
3]),this.pageArray[a+3].setUpOrDown(rightToLeft)))},flipToMin:function(a,b,c,g){g=this.flipPageManager.initFlipPageByIndex(a,b,g);this.addPagesBeforeFlipToMin(b,c);this.pageArray[b-1]&&(this.pageArray[b-1].setUpOrDown(!rightToLeft),g.nextPage=this.pageArray[b-1]);this.setPagesStyleBeforeFlipToMin(b,c);this.deleteUnnecessaryPagesBeforeFlipToMin(a,b);return g},setPagesStyleBeforeFlipToMin:function(a,b){b&&this.supportSerialsFlip()&&(this.pageArray[a-1]&&this.setZIndexByPageIndex(this.pageArray[a-1],
a),this.pageArray[a-2]&&(this.setZIndexByPageIndex(this.pageArray[a-2],a),this.pageArray[a-2].setUpOrDown(!rightToLeft)),this.pageArray[a-3]&&(this.setZIndexByPageIndex(this.pageArray[a-3],a),this.pageArray[a-3].setUpOrDown(!rightToLeft)))},setPagesStyleAfterFlipToMin:function(a){this.pageArray[a]&&(this.setZIndexByPageIndex(this.pageArray[a],a),this.pageArray[a].setUpOrDown(rightToLeft));this.pageArray[a+1]&&(this.setZIndexByPageIndex(this.pageArray[a+1],a),this.pageArray[a+1].setUpOrDown(rightToLeft));
this.pageArray[a+2]&&(this.setZIndexByPageIndex(this.pageArray[a+2],a),this.pageArray[a+2].setUpOrDown(rightToLeft));this.supportSerialsFlip()&&this.flipping||(this.pageArray[a-1]&&this.setZIndexByPageIndex(this.pageArray[a-1]),this.pageArray[a-2]&&(this.setZIndexByPageIndex(this.pageArray[a-2]),this.pageArray[a-2].setUpOrDown(!rightToLeft)),this.pageArray[a-3]&&(this.setZIndexByPageIndex(this.pageArray[a-3]),this.pageArray[a-3].setUpOrDown(!rightToLeft)))},movetoCenter:function(a,b,c){if(!this.status_zoom&&
bookConfig.retainBookCenter&&!(1<BookInfo.getPagesByIndex(a).length&&1<BookInfo.getPagesByIndex(b).length)){var g=this.pageHeight,h=-g/2;g/=2;var n=0,p=0;BookInfo.isLeftPage(a,!0)||1!=BookInfo.getPagesByIndex(a).length||(n=h);BookInfo.isLeftPage(a,!0)&&1==BookInfo.getPagesByIndex(a).length&&(n=g);BookInfo.isLeftPage(b,!0)||1!=BookInfo.getPagesByIndex(b).length||(p=h);BookInfo.isLeftPage(b,!0)&&1==BookInfo.getPagesByIndex(b).length&&(p=g);this.fromTrans=0>this.movedY*p&&this.toTrans!=p?this.movedY:
n;this.toTrans=p;a=2*this.pageHeight;void 0==c&&(c=a);isNaN(c)||(this.movedLength=c,this.movedY=$.easing.easeInOutSine(null,c,this.fromTrans,this.toTrans-this.fromTrans,a),this.setCSS({tran:{x:0,y:this.movedY}}))}},edgeX:function(){this.MiddleX=0},getFromStartPointByIndex:function(a,b){var c=this.getMinPageIndex(this.currentPageIndex),g=c+1;if(a!=g&&a!=c){var h={x:0,y:0},n={x:0,y:0},p=b.getPageWidthHeight().height;b.getPageWidthHeight();b=!1;if(a>g&&!rightToLeft||a<c&&rightToLeft)h={x:p,y:0},n.x=
h.x-2,n.y=h.y+2,b=!0;if(a<c&&!rightToLeft||a>g&&rightToLeft)h={x:-p,y:0},n.x=h.x+2,n.y=h.y+2,b=!1;this.flipToDirection=b?"left":"right";return[h,n]}},afterZoomIn:function(a){if(!isPhone()&&!isPad()||bookConfig.usePdfJs){if(isPhone()||isPad()||this.showPages(),a&&this.flipBook.parameters&&!this.flipBook.parameters.resize){this.flipBook.parameters.resize=!0;a=this.flipBook.offset().left;var b=this.flipBook.offset().top,c=this.flipBook.parameters.left,g=this.flipBook.parameters.top;h=this.flipBook.parameters.scale;
c={tran:{x:a-c,y:b-g},scale:1,origin:{x:0,y:0}};1!=h&&this.resizeBook(Math.round(this.width*h),Math.round(this.height*h/2));this.status_zoom||(h=0,1==this.currentPageIndex&&bookConfig.retainBookCenter&&!bookConfig.isTheBookOpen&&(h=rightToLeft?this.height/4:-this.height/4),this.currentPageIndex==totalPageCount&&bookConfig.retainBookCenter&&(h=rightToLeft?-this.height/4:this.height/4),c.tran={x:0,y:h},c.left=a-0,c.top=b-h);this.setCSS(c);this.flipBook.parameters.tran=c.tran;this.flipBook.parameters.scale=
1;this.flipBook.parameters.toScale=1;this.flipBook.parameters.width=$(this.flipBook).width();this.flipBook.parameters.height=$(this.flipBook).height();this.flipBook.parameters.origin={x:0,y:0};this.flipBook.parameters.resize=!1;isPhone()||isPad()||this.switchLargeImage()}}else if(b=BookInfo.getCurrentPages(),void 0!=b&&null!=b)for(c=0;c<b.length;c++)if(g=b[c],this.pageArray[g]){var h=this.flipBook.parameters.scale;this.pageArray[g].resizeSvg(Math.round(this.pageWidth*h),Math.round(this.pageHeight*
...
100;return fitPageWidthHeight(b,a,c,2*g)},getSpace:function(a){var b=bookConfig.leftMargin+templateArea.getLeftWidth(),c=bookConfig.rightMargin+templateArea.getRightWidth(),g=bookConfig.topMargin+templateArea.getTopHeight(),h=bookConfig.bottomMargin+templateArea.getBottomHeight();a&&(b+=bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),c+=bookConfig.hardCoverBorderWidth+totalThicknessWidth(!0),g+=bookConfig.hardCoverBorderWidth,h+=bookConfig.hardCoverBorderWidth);return{left:b,right:c,top:g,
bottom:h}},resizeBook:function(a,b){this.endFlip();this.width=a;this.height=2*b;this.pageWidth=a;this.pageHeight=b;this.maskWidth=parseInt(Math.sqrt(a*a+b*b));0!=(this.maskWidth-this.height)%2&&(this.maskWidth+=1);this.setCSS({width:this.width,height:this.height});this.resizePage(this.pageWidth,this.pageHeight);this.resetBookShadow(this.currentPageIndex)},resetBookShadow:function(){},setAttachmentBeforeFlipTo:function(){},setAttachmentAfterFlipTo:function(){},flippingTo:function(a){this.currentPageIndex=
a;this.currentPageIndex=Math.max(1,this.currentPageIndex);this.currentPageIndex=Math.min(originTotalPageCount,this.currentPageIndex);this.resetZoomArea()},resetZoomArea:function(){this.flipBook&&this.flipBook.parameters&&this.flipBook.parameters.zoomArea&&(1!=this.getCurrentPages().length||BookInfo.isLeftPage(this.currentPageIndex,!0)?1==this.getCurrentPages().length&&BookInfo.isLeftPage(this.currentPageIndex,!0)?this.flipBook.parameters.zoomArea={left:0,top:0,right:0,bottom:50}:this.flipBook.parameters.zoomArea=
{left:0,top:0,right:0,bottom:0}:this.flipBook.parameters.zoomArea={left:0,top:50,right:0,bottom:0})},getDownUpPage:function(a,b){this.addPageArray([a,b]);this.pageArray[a]&&this.pageArray[a].beginToFlip();this.pageArray[b]&&this.pageArray[b].beginToFlip();this.pageArray[a]&&(this.pageArray[a].page.setCSSByName("down-flip-side"),this.setZIndexByPageIndex(this.pageArray[a]));this.pageArray[b]&&(this.pageArray[b].page.setCSSByName("flip-vertical-side"),this.pageArray[b].page.side.addClass("boxShadow"),
this.setZIndexByPageIndex(this.pageArray[b]));return[this.pageArray[a],this.pageArray[b]]},adjustBookPosition:function(){if(!this.status_zoom&&!this.flipping&&this.width&&this.height){this.pageWidthHeight=this.getFitWH();var a=this.getTranX(),b=this.pageWidthHeight.y/this.height,c=this.getTranY(b);this.flipBook.animateToTransform.bind(this.flipBook)(b,{x:a,y:c},{x:0,y:50})}},getTranX:function(){var a=this.getCssLeft(),b=this.getSpace(!0);return b.left+(windowWidth-b.left-b.right-this.pageWidthHeight.x)/
2-a},getTranY:function(a){if(!bookConfig.retainBookCenter)return 0;var b=0;a=this.height*a/4;1!=this.currentPageIndex||bookConfig.isTheBookOpen||(b=rightToLeft?a:-a);this.currentPageIndex==totalPageCount&&(b=rightToLeft?-a:a);a=this.getCssTop();var c=this.getSpace(!0);return c.top+(windowHeight-c.top-c.bottom-this.height)/2-a+b}}).extend(DoubleFlipBook),SingleFlipCalendar=Class({bookType:BookType.single_book,doublePage:!1,pageBackArray:null,create:function(a){this.pageBackArray=[];this._super(a)},
newPage:function(a){return new NormalPage(a,"page",!0,this.bookType)},newPageBack:function(a){return new NormalPage(a,"pageBack",!0,BookType.single_book,!0)},newFlipPage:function(){return new SingleCalendarPage(this)},resetPages:function(a){isNaN(a)||0>=a||(this.unWrapPageBackExcludeArray([a,a+1]),this.unWrapPageExcludeArray([a,a+1]),this.addPageArray([a,a+1]),this.addPageBackArray([a]),this.currentPage=this.pageArray[a],this.currentPage2=this.pageBackArray[a],this.nextPage=this.pageArray[a+1],this.previousPage=
this.pageArray[a-1],this.previousPage2=this.pageBackArray[a-1],this.setPageCss(),this.loading())},setPageCss:function(){var a=transformCSS({rotate:0,tran:{x:0,y:0}});this.currentPage&&(this.setZIndexByPageIndex(this.currentPage),this.currentPage.setCSSByStyle(a));this.previousPage&&(this.setZIndexByPageIndex(this.previousPage),this.previousPage.setCSSByStyle(a));this.previousPage2&&(this.setZIndexByPageIndex(this.previousPage2),this.previousPage2.setCSSByStyle(a));this.currentPage2&&(this.setZIndexByPageIndex(this.currentPage2),
this.currentPage2.setCSSByStyle(a));this.nextPage&&(this.setZIndexByPageIndex(this.nextPage),this.nextPage.setCSSByStyle(a));rightToLeft?(this.currentPage&&this.currentPage.setUpOrDown(!0),this.previousPage&&this.previousPage.setUpOrDown(!0),this.previousPage2&&this.previousPage2.setUpOrDown(!0),this.currentPage2&&this.currentPage2.setUpOrDown(!0),this.nextPage&&this.nextPage.setUpOrDown(!0)):(this.currentPage&&this.currentPage.setUpOrDown(!1),this.previousPage&&this.previousPage.setUpOrDown(!1),
this.previousPage2&&this.previousPage2.setUpOrDown(!1),this.currentPage2&&this.currentPage2.setUpOrDown(!1),this.nextPage&&this.nextPage.setUpOrDown(!1))},addPageBackArray:function(a){if(a&&this.pageBackArray)for(var b=0;b<a.length;b++)if(!(0>=a[b]||a[b]>originTotalPageCount||(!this.pageBackArray[a[b]]||this.flipping&&!imageLoaded[a[b]]||this.fillContent(a[b]),this.pageBackArray[a[b]]))){var c=this.newPageBack(a[b]),g=this.pageInfoArray[a[b]];c.onResize(this.pageWidth*g.pageWidth,this.pageHeight*
g.pageHeight,g.opacity);c.mirrorSide();this.pageBackArray[a[b]]=c;this.flipping&&!imageLoaded[a[b]]||this.fillContent(a[b]);this.flipBook.append(c.$page)}},getDownUpPage:function(a,b){var c=a;a>b&&(c=b);this.addPageArray([c]);this.addPageBackArray([c]);this.pageArray[c]&&this.pageArray[c].beginToFlip();this.pageBackArray[c]&&this.pageBackArray[c].beginToFlip();this.pageArray[c]&&this.pageArray[c].page.setCSSByName("down-flip-side");this.pageBackArray[c]&&(this.pageBackArray[c].page.setCSSByName("flip-vertical-side"),
this.pageBackArray[c].page.side.addClass("boxShadow"));return[this.pageArray[c],this.pageBackArray[c]]},getDownUpHardPage:function(a,b){var c=a;a>b&&(c=b);this.addPageArray([c]);this.addPageBackArray([c]);rightToLeft?(this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-up-side"),this.pageBackArray[c]&&this.pageBackArray[c].setCSSByName("flip-hard-down-side")):(this.pageArray[c]&&this.pageArray[c].setCSSByName("flip-hard-down-side"),this.pageBackArray[c]&&this.pageBackArray[c].setCSSByName("flip-hard-up-side"));
return[this.pageArray[c],this.pageBackArray[c]]},flipToMax:function(a,b,c){var g=this.flipPageManager.initFlipPageByIndex(a,b);this.addPagesBeforeFlipToMax(b,c);this.pageArray[b]&&(this.pageArray[b].setUpOrDown(rightToLeft),g.nextPage=this.pageArray[b]);this.setPagesStyleBeforeFlipToMax(b,c);this.deleteUnnecessaryPagesBeforeFlipToMax(a,b);return g},addPagesBeforeFlipToMax:function(a,b){this.addPageArray([a]);b&&this.supportSerialsFlip()&&(this.addPageBackArray([a]),this.addPageArray([a+1]))},setPagesStyleBeforeFlipToMax:function(a,
b){b&&(this.pageArray[a]&&(this.setZIndexByPageIndex(this.pageArray[a],a),this.pageArray[a].setUpOrDown(rightToLeft)),this.pageBackArray[a]&&(this.setZIndexByPageIndex(this.pageBackArray[a],a),this.pageBackArray[a].setUpOrDown(rightToLeft)),this.pageArray[a+1]&&(this.setZIndexByPageIndex(this.pageArray[a+1],a),this.pageArray[a+1].setUpOrDown(rightToLeft)))},deleteUnnecessaryPagesBeforeFlipToMax:function(a,b){for(var c=b+1;c<=originTotalPageCount;c++)this.pageBackArray[c]&&(this.pageBackArray[c]&&
this.pageBackArray[c].remove(),this.pageBackArray[c]=void 0);for(c=b+2;c<=originTotalPageCount;c++)this.pageArray[c]&&(this.pageArray[c]&&this.pageArray[c].remove(),this.pageArray[c]=void 0);for(c=a+1;c<b;c++)if(this.pageArray[c]||this.pageBackArray[c])this.pageArray[c]&&this.pageArray[c].remove(),this.pageBackArray[c]&&this.pageBackArray[c].remove(),this.pageArray[c]=void 0,this.pageBackArray[c]=void 0},afterFlipToMax:function(a){this.addPagesAfterFlipToMax(a);this.setPagesStyleAfterFlipToMax(a);
this.deleteUnnecessaryPagesAfterFlipToMax(a)},addPagesAfterFlipToMax:function(a){this.supportSerialsFlip()||(this.addPageArray([a]),this.addPageBackArray([a]),this.addPageArray([a+1]));this.pageArray[a]&&this.fillContent(a);this.pageArray[a+1]&&this.fillContent(a+1)},setPagesStyleAfterFlipToMax:function(a){this.pageArray[a-1]&&this.setZIndexByPageIndex(this.pageArray[a-1],a);this.pageBackArray[a-1]&&this.setZIndexByPageIndex(this.pageBackArray[a-1],a);this.supportSerialsFlip()||(this.pageArray[a]&&
(this.setZIndexByPageIndex(this.pageArray[a]),this.pageArray[a].setUpOrDown(rightToLeft)),this.pageBackArray[a]&&(this.setZIndexByPageIndex(this.pageBackArray[a]),this.pageBackArray[a].setUpOrDown(rightToLeft)),this.pageArray[a+1]&&(this.setZIndexByPageIndex(this.pageArray[a+1]),this.pageArray[a+1].setUpOrDown(rightToLeft)))},deleteUnnecessaryPagesAfterFlipToMax:function(a){for(a-=2;0<=a;a--)if(this.pageArray[a]||this.pageBackArray[a])this.pageArray[a]&&this.pageArray[a].remove(),this.pageBackArray[a]&&
this.pageBackArray[a].remove(),this.pageArray[a]=void 0,this.pageBackArray[a]=void 0},flipToMin:function(a,b,c){var g=this.flipPageManager.initFlipPageByIndex(a,b);this.addPagesBeforeFlipToMin(b,c);this.pageArray[a]&&(g.nextPage=this.pageArray[a]);this.setPagesStyleBeforeFlipToMin(b);this.deleteUnnecessaryPagesBeforeFlipToMin(a,b);return g},addPagesBeforeFlipToMin:function(a,b){},setPagesStyleBeforeFlipToMin:function(a){},deleteUnnecessaryPagesBeforeFlipToMin:function(a,b){for(--a;a>b;a--)if(this.pageArray[a]||
this.pageBackArray[a])this.pageArray[a]&&this.pageArray[a].remove(),this.pageBackArray[a]&&this.pageBackArray[a].remove(),this.pageArray[a]=void 0,this.pageBackArray[a]=void 0},afterFlipToMin:function(a){this.addPagesAfterFlipToMin(a);this.setPagesStyleAfterFlipToMin(a);this.deleteUnnecessaryPagesAfterFlipToMin(a)},addPagesAfterFlipToMin:function(a){this.supportSerialsFlip()||(this.addPageArray([a]),this.addPageBackArray([a]),this.addPageArray([a-1]));this.pageArray[a]&&this.fillContent(a);this.pageArray[a-
1]&&this.fillContent(a-1)},setPagesStyleAfterFlipToMin:function(a){this.pageArray[a+1]&&(this.setZIndexByPageIndex(this.pageArray[a+1]),this.pageArray[a+1].setUpOrDown(rightToLeft))},deleteUnnecessaryPagesAfterFlipToMin:function(a){for(var b=a+2;b<=originTotalPageCount;b++)if(this.pageArray[b]||this.pageBackArray[b])this.pageArray[b]&&this.pageArray[b].remove(),this.pageBackArray[b]&&this.pageBackArray[b].remove(),this.pageArray[b]=void 0,this.pageBackArray[b]=void 0;this.pageBackArray[a+1]&&(this.pageBackArray[a+
1]&&this.pageBackArray[a+1].remove(),this.pageBackArray[a+1]=void 0)},getCurrentPages:function(){return[this.currentPageIndex]},getPagesByIndex:function(a){return[a]},movetoCenter:function(){},getFromStartPointByIndex:function(a,b){var c=this.currentPageIndex;if(a!=c&&a!=c){var g={x:0,y:0},h=b.getPageWidthHeight().height;b.getPageWidthHeight();var n=!1;b={x:h,y:0};rightToLeft&&(b={x:-h,y:0});if(a>c&&!rightToLeft||a<c&&rightToLeft)n=!0;if(a<c&&!rightToLeft||a>c&&rightToLeft)n=!1;a>c&&(g={x:b.x*(h-
2)/h,y:2});a<c&&(g={x:-b.x*(h-2)/h,y:2});this.flipToDirection=n?"left":"right";return[b,g]}},realBookPosition:function(){var a=this.flipBook.offset().left,b=this.flipBook.offset().top-(rightToLeft?0:this.pageHeight);return[a,b]},edgeX:function(){this.MiddleX=this.pageHeight/2;rightToLeft&&(this.MiddleX=-this.pageHeight/2)},realIndex:function(a){var b=this.currentPageIndex;if(a&&!rightToLeft||!a&&rightToLeft)return[b,b+1];if(!a&&!rightToLeft||a&&rightToLeft)return[b,b-1]},getFromStartPointByCoordinate:function(a,
b,c){if(a){var g={x:0,y:0},h={x:0,y:0},n=c.getPageWidthHeight().height;c=c.getPageWidthHeight().width;var p=a.y>c/2?a.y-5:a.y+5;a.x<this.MiddleX&&(g.y=p,h.x=-n);a.x>this.MiddleX&&(g.y=p,h.x=n);b&&0<=b.indexOf("r")&&(h.x=n);b&&0<=b.indexOf("l")&&(h.x=-n);"tl"==b&&(g.y=0);"bl"==b&&(g.y=c);"tr"==b&&(g.y=0);"br"==b&&(g.y=c);g.x=rightToLeft?-n:n;h.y=g.y;return[g,h]}},getFlipTo:function(a){var b=this.currentPageIndex,c="";a>b&&(c="max");a<b&&(c="min");return{flipTo:c,minIndex:b,maxIndex:b,toIndex:a}},afterZoomIn:function(a){if(!isPhone()&&
!isPad()||bookConfig.usePdfJs){if(isPhone()||isPad()||this.showPages(),a&&this.flipBook.parameters&&!this.flipBook.parameters.resize){this.flipBook.parameters.resize=!0;a=this.flipBook.offset().left;var b=this.flipBook.offset().top;a-=this.flipBook.parameters.left;var c=b-this.flipBook.parameters.top;b=this.flipBook.parameters.scale;1!=b&&this.resizeBook(Math.round(this.width*b),Math.round(this.height*b));transformCSS({tran:{x:a,y:c},scale:1,origin:{x:0,y:0},obj:this.flipBook});this.flipBook.parameters.tran=
{x:a,y:c};this.flipBook.parameters.scale=1;this.flipBook.parameters.toScale=1;this.flipBook.parameters.width=$(this.flipBook).width();this.flipBook.parameters.height=$(this.flipBook).height();this.flipBook.parameters.origin={x:0,y:0};this.flipBook.parameters.resize=!1;isPhone()||isPad()||this.switchLargeImage()}}else if(c=BookInfo.getCurrentPages(),void 0!=c&&null!=c)for(var g=0;g<c.length;g++){var h=c[g];this.pageArray[h]&&this.pageArray[h]&&(b=this.flipBook.parameters.scale,this.pageArray[h].resizeSvg(Math.round(this.width*
b),Math.round(this.height*b)),bookConfig.highDefinitionConversion?this.pageArray[h].zoomInSideImage():(1<a.scale&&this.pageArray[h].zoomInSideImage(),1==a.scale&&this.pageArray[h].zoomOutSideImage()))}},setZIndexByPageIndex:function(a,b){a&&(b=b?b:this.currentPageIndex,a==this.pageArray[b]?a.setZIndex(2):a==this.pageBackArray[b]?a.setZIndex(1):a==this.pageArray[b+1]?a.setZIndex(0):a.setZIndex(-1))},getFitWH:function(){this.getSpace(!1);var a=this.getSpace(!0),b=windowWidth-a.left-a.right;a=windowHeight-
a.top-a.bottom;var c=bookConfig.largePageWidth*(-parseFloat(bookConfig.visibleAreaLeft)+parseFloat(bookConfig.visibleAreaRight))/100,g=bookConfig.largePageHeight*(parseFloat(bookConfig.visibleAreaBottom)-parseFloat(bookConfig.visibleAreaTop))/100;return fitPageWidthHeight(b,a,c,g)},getSpace:function(a){var b=bookConfig.leftMargin+templateArea.getLeftWidth(),c=bookConfig.rightMargin+templateArea.getRightWidth(),g=bookConfig.topMargin+templateArea.getTopHeight(),h=bookConfig.bottomMargin+templateArea.getBottomHeight();
a&&(b+=bookConfig.hardCoverBorderWidth,c+=bookConfig.hardCoverBorderWidth,g+=rightToLeft?bookConfig.hardCoverBorderWidth+totalThicknessWidth(!1):0,h+=rightToLeft?0:bookConfig.hardCoverBorderWidth+totalThicknessWidth(!1));return{left:b,right:c,top:g,bottom:h}},resizeBook:function(a,b){this.endFlip();this.width=a;this.height=b;this.pageWidth=a;this.pageHeight=b;this.maskWidth=parseInt(Math.sqrt(a*a+b*b));0!=(this.maskWidth-this.height)%2&&(this.maskWidth+=1);this.flipBook.css({width:this.width+"px",
height:this.height+"px"});this.resizePage(this.pageWidth,this.pageHeight);this.resetBookShadow()},resetBookShadow:function(){},setAttachmentBeforeFlipTo:function(){},setAttachmentAfterFlipTo:function(){},flippingTo:function(a){this.currentPageIndex=a;this.currentPageIndex=Math.max(1,this.currentPageIndex);this.currentPageIndex=Math.min(originTotalPageCount,this.currentPageIndex)}}).extend(SingleFlipBook),NormalCalendar=Class({bookType:BookType.normal_book,doublePage:!0,create:function(a){this._super(a);
this.resetZoomArea()},resetBookShadow:function(a){a=this.flipPageManager.array.length;if(0==a){var b=2==BookInfo.getCurrentPages().length,c=!BookInfo.isLeftPage(this.currentPageIndex,!0);this.bookAttachments.Items.find("BookShadow").each(function(v){v.doubleHeight(b);v.down(c);v.show()})}else{for(var g=!0,h=!0,n=0;n<a;n++){var p=this.flipPageManager.array[n],z=this.flipPageManager[p].nextIndex;p=this.flipPageManager[p].currentIndex;1==BookInfo.getPagesByIndex(z).length&&BookInfo.isLeftPage(z,!0)&&
(h=!1);1==BookInfo.getPagesByIndex(p).length&&BookInfo.isLeftPage(p,!0)&&(h=!1);1!=BookInfo.getPagesByIndex(z).length||BookInfo.isLeftPage(z,!0)||(g=!1);1!=BookInfo.getPagesByIndex(p).length||BookInfo.isLeftPage(p,!0)||(g=!1)}g||h||this.bookAttachments.Items.find("BookShadow").each(function(v){v.hide()});(g&&!h||!g&&h)&&this.bookAttachments.Items.find("BookShadow").each(function(v){v.show();v.doubleHeight(!1);v.down(h)})}},hasTwoSingleFlipPage:function(a){for(var b=this.flipPageManager.array.length,
c,g=0;g<b;g++){var h=this.flipPageManager.array[g],n=this.flipPageManager[h].nextIndex;h=this.flipPageManager[h].currentIndex;1==BookInfo.getPagesByIndex(n).length&&(c=n);1==BookInfo.getPagesByIndex(h).length&&(c=h)}return c&&(c!=a&&1==BookInfo.getPagesByIndex(a).length||c!=this.currentPageIndex&&1==BookInfo.getPagesByIndex(this.currentPageIndex).length)?(this.bookAttachments.Items.find("BookShadow").each(function(p){p.hide()}),!0):!1},flippingTo:function(a){this.currentPageIndex=a;this.currentPageIndex=
Math.max(1,this.currentPageIndex);this.currentPageIndex=Math.min(originTotalPageCount,this.currentPageIndex);this.resetZoomArea()},afterCurling:function(){this._super();this.resetBookShadow(this.currentPageIndex);this.bookAttachments.afterCurling()},setAttachmentBeforeFlipTo:function(a){this.pauseAnimation();this.bookAttachments.setAttachmentBeforeFlipTo(a);this.resetBookShadow(a)},setAttachmentAfterFlipTo:function(a){this.stopMedia();this.resetSlider();this.bookAttachments.setAttachmentAfterFlipTo(a);
...
2,templateArea.getTopHeight()+b+5));if(this.controlBar){var b="lite"==bookConfig.ToolbarViewMode&&bookType==BookType.catalog_book?50:0;this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+b+5);this.controlBar.setVisible(!0)}global.canMagnifierZoom&&BookInfo.getBook().unMagnifierZoom()}},zoomOut:function(){var a=BookInfo.getBook();a.status_zoom=!1;a.flipping||!a.adContainer||1!=a.currentPageIndex||bookConfig.isTheBookOpen||a.adContainer.css({"z-index":3});gotoPageFun(a.toPageIndex,
!1,"change book type");StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(b){b.setAsZoomin();b.executeCallback()});window.toolBar&&window.toolBar.btnZoom&&window.toolBar.changeZoomIcon(!0);this.switchNormalImage();this.controlBar&&this.controlBar.setVisible(!1)},onZoomed:function(a){if(isPhone()||isPad()){var b=BookInfo.getBook(),c=BookInfo.getCurrentPages();if(void 0!=c&&null!=c)for(var g=0;g<c.length;g++){var h=b.pageArray[c[g]];h&&(h.resizeSvg(Math.round(this.pageWidth*a.scale),
Math.round(this.pageHeight*a.scale)),bookConfig.highDefinitionConversion?h.zoomInSideImage():(1<a.scale&&h.zoomInSideImage(),1==a.scale&&h.zoomOutSideImage()))}}else a&&!this.pages.parameters.resize&&(this.pages.parameters.resize=!0,a=this.pages.offset().left,b=this.pages.offset().top,a-=this.pages.parameters.left,b-=this.pages.parameters.top,c=this.pages.parameters.scale,1!=c&&(this.resizePages(parseInt(this.pageWidth*c),parseInt(this.pageHeight*c)),c=1),c=transformCSS({tran:{x:a,y:b},scale:c,origin:{x:0,
y:0}}),this.pages.css(c),this.pages.parameters&&(this.pages.parameters.tran={x:a,y:b},this.pages.parameters.scale=1,this.pages.parameters.toScale=1,this.pages.parameters.width=$(this.pages).width(),this.pages.parameters.height=$(this.pages).height(),this.pages.parameters.origin={x:0,y:0},this.pages.parameters.resize=!1))},mouseWheelFlip:function(){var a;this.side.parent().bind(_event._mousewheel,function(b){if(void 0!=a&&150>new Date-a)var c=!1;else a=new Date,c=!0;if(!c)return!1;c=b.originalEvent;
...
this.currentPageIndex)},movetoCenter:function(a,b,c){if(bookConfig.retainBookCenter){var g=this.getMovedXByIndex(b).x-this.getMovedXByIndex(a).x,h=this.width;if(void 0==c||c>h)c=h;if(!isNaN(c)){this.movedLength=c;var n=this.getFitWHByIndex(a),p=this.getFitWHByIndex(b);this.status_zoom&&(n=this.getFitWHByIndex(a,this.width,this.height),p=this.getFitWHByIndex(b,this.width,this.height));this.getFlipTo(b);var z=BookInfo.getMinPageIndex(a),v=BookInfo.getMaxPageIndex(a);if(bookConfig.RightToLeft)if(a<b){var B=
this.scalePages([z,z-1,z-2],c,h,n[1],p[1],{x:0,y:50});z=this.scalePages([v,b],c,h,n[0],p[1],{x:100,y:50},!1,0,{x:-n[1].x,y:0});var D=this.scalePages([b+1],c,h,n[0],p[0],{x:100,y:50},!0,z);this.scalePages([b+2],c,h,n[0],p[0],{x:100,y:50})}else z=this.scalePages([z,b],c,h,n[1],p[0],{x:100,y:50},!1,0,{x:-n[1].x,y:0}),B=this.scalePages([b-1],c,h,n[1],p[1],{x:0,y:50},!0,z),this.scalePages([b-2],c,h,n[1],p[1],{x:0,y:50}),D=this.scalePages([v,v+1,v+2],c,h,n[0],p[0],{x:100,y:50});else a<b?(D=this.scalePages([z,
z-1,z-2],c,h,n[0],p[0],{x:100,y:50}),z=this.scalePages([v,b],c,h,n[1],p[0],{x:100,y:50},!1,0,{x:-n[1].x,y:0}),B=this.scalePages([b+1],c,h,n[1],p[1],{x:0,y:50},!0,z),this.scalePages([b+2],c,h,n[1],p[1],{x:0,y:50})):(z=this.scalePages([z,b],c,h,n[0],p[1],{x:100,y:50},!1,0,{x:-n[1].x,y:0}),D=this.scalePages([b-1],c,h,n[0],p[0],{x:100,y:50},!0,z),this.scalePages([b-2],c,h,n[0],p[0],{x:100,y:50}),B=this.scalePages([v,v+1,v+2],c,h,n[1],p[1],{x:0,y:50}));this.movedX=$.easing.easeInOutSine(null,c,0,g+(p[0].x-
n[0].x)-0,h);g={tran:{x:parseInt(this.movedX),y:0}};this.status_zoom||this.setCSS(g);this.bookAttachments.Items.find("ThicknessManager").each(function(M){M.leftThickness&&M.leftThickness.doSetMovingScale(a,b,c,h,!1,D.y,(-D.x+1)*n[0].x);M.rightThickness&&M.rightThickness.doSetMovingScale(a,b,c,h,!1,B.y,(B.x-1)*n[1].x)}.bind(this));this.hardCover.doSetMovingScale(D,B)}}},setAttachmentAfterFlipTo:function(a){this._super(a);this.hardCover&&this.hardCover.refresh(this.currentPageIndex,this.getThicknessWidth(),
...
this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+b+5));if(this.controlBar){var b="lite"==bookConfig.ToolbarViewMode&&bookType==BookType.catalog_book?50:0;this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+b+5);this.controlBar.setVisible(!0)}global.canMagnifierZoom&&BookInfo.getBook().unMagnifierZoom()}},zoomOut:function(){var a=BookInfo.getBook();a.status_zoom=!1;a.flipping||!a.adContainer||1!=a.currentPageIndex||
bookConfig.isTheBookOpen||a.adContainer.css({"z-index":3});gotoPageFun(a.toPageIndex,!1,"change book type");StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(b){b.setAsZoomin();b.executeCallback()});window.toolBar&&window.toolBar.btnZoom&&window.toolBar.changeZoomIcon(!0);this.switchNormalImage();this.controlBar&&this.controlBar.setVisible(!1)},onZoomed:function(a){if(isPhone()||isPad()){var b=BookInfo.getBook(),c=BookInfo.getCurrentPages();if(void 0!=c&&null!=c)for(var g=0;g<
c.length;g++){var h=b.pageArray[c[g]];h&&(h.resizeSvg(Math.round(this.pageWidth*a.scale),Math.round(this.pageHeight*a.scale)),bookConfig.highDefinitionConversion?h.zoomInSideImage():(1<a.scale&&h.zoomInSideImage(),1==a.scale&&h.zoomOutSideImage()))}}else a&&!this.pages.parameters.resize&&(this.pages.parameters.resize=!0,a=this.pages.offset().left,b=this.pages.offset().top,a-=this.pages.parameters.left,b-=this.pages.parameters.top,c=this.pages.parameters.scale,1!=c&&(this.resizePages(parseInt(this.pageWidth*
...
this.pageArray.length,c=0;c<b;c++)!this.pageArray[c]||0<=a.indexOf(c)||(this.pageArray[c].remove(),this.pageArray[c]=void 0);this.orderPages()}},mouseWheelFlip:function(){if(bookConfig.mouseWheelFlip){var a;this.docViewBook.bind(_event._mousewheel,function(b){if(void 0!=a&&150>(new Date).getTime()-a)var c=!1;else a=(new Date).getTime(),c=!0;if(!c)return!1;c=b.originalEvent;var g=Math.max(-1,Math.min(1,c.wheelDelta||-c.detail));this.status_zoom&&(b={pointers:[{pageX:b.pageX,pageY:b.pageY},{pageX:b.pageX,
pageY:b.pageY}]},0>g?this.controlBar&&this.controlBar.zoomDown(b):this.controlBar&&this.controlBar.zoomUp(b));this.status_zoom||!bookConfig.mouseWheelFlip||this.flipping||(this.panBookForMove(c.wheelDelta||40*-c.detail),this.restrictInBoundary());if(bookConfig.mouseWheelFlip)return stopEvent(b),!1}.bind(this))}},flippingTo:function(a){this.currentPageIndex=a;this.currentPageIndex=Math.max(1,this.currentPageIndex);this.currentPageIndex=Math.min(originTotalPageCount,this.currentPageIndex)},getRealPageIndex:function(){return this.currentPageIndex},
getRealBookIndex:function(a){return a},gotoPage:function(a,b){if(!isNaN(a)){this.toPageIndex=a;if(this.status_zoom)return a={pointers:[{pageX:windowWidth/2,pageY:windowHeight/2}]},this.docViewBook.onDoubleTap.bind(this.docViewBook)(a),!0;a=this.getRealBookIndex(a);0>=a||a>this.pageLength()||!this.flipEffect(a)||(!b&&flipHistory&&flipHistory.addFromCurrentIndex(this.toPageIndex),bookConfig.restorePageVisible&&window.localStorage.setItem(realLocation+"?historyPageIndex",this.toPageIndex),this.flipping=
!1,-1!==this.toNewPageIndex?(this.flippingTo(a),playFlipSound(),this.mainPageIndex=a,this.resetPages(a),this.setAttachmentAfterFlipTo()):(b=1<Math.abs(a-this.currentPageIndex),this.flipInterval&&this.flipInterval.stop(),b?(this.jumping=!0,this.flippingTo(a),playFlipSound(),this.refreshPages(a),this.afterFlipTo(),this.jumping=!1):this.flipIntervalTmp(a)))}},flipEffect:function(a){return this.status_zoom||a==this.currentPageIndex?!1:!0},flipIntervalTmp:function(a){var b=this.currentTran,c=this.getFlipTo(a);
this.flipping=!0;var g=0;console.log("flipIntervalTmp",this.flipping);var h=function(n,p,z){n<p?(n=(0,$.easing["easeInOut"+z])(null,n,b,c-b,p),p=n-g,g=n,this.panBookForMove(p)):(this.flipping=!1,this.flipInterval.stop(),BookEvent.trigger("afterFlipPage",[a]))}.bind(this);this.flipInterval=function(n,p){h(n,p,"Sine")}.animation(this,this.flippingTime)},refreshPages:function(a){if(!this.pageArray[a]){var b=this.getCurrentViewPageIndex(),c=bookConfig.FlipDirection?this.currentTran-this.height:this.currentTran-
this.width;(a>b||a<this.mainPageIndex)&&!rightToLeft&&(c=this.currentTran);(a<b||a>this.mainPageIndex)&&rightToLeft&&(c=this.currentTran);this.addPageArray([a-1,a,a+1]);this.setBookTran(c)}this.showPage=this.pageArray[a].pages},getCurrentViewPageIndex:function(){var a=Math.abs(this.currentTran);return this.sequenceList[(0>=this.currentTran?1:-1)*(bookConfig.FlipDirection?Math.floor(a/this.height)+1+(a%this.height>this.height/2)?0:1:Math.floor(a/this.width)+1+(a%this.width>this.width/2)?0:1)]},getFlipTo:function(a){if(!this.pageArray[a]||
!this.pageArray[a].sequence)return 0;var b=bookConfig.FlipDirection?this.height+this.marginTop:this.width+this.marginTop;a=this.pageArray[a];var c=0;if(this.pageArray[this.currentPageIndex]){var g,h;c=bookConfig.FlipDirection?null==(g=this.pageArray[this.currentPageIndex])?void 0:g.top:null==(h=this.pageArray[this.currentPageIndex])?void 0:h.left}return-a.sequence*b-parseFloat(c)},getCurrentTran:function(){return this.currentTran},setBookTran:function(a){if(bookConfig.FlipDirection){var b=transformCSS({rotate:0,
tran:{x:0,y:a}});isBelowIE9()&&(b={top:a+this.bookTop+"px"})}else b=transformCSS({rotate:0,tran:{x:a,y:0}}),isBelowIE9()&&(b={left:a+this.bookLeft+"px"});this.setCSSByStyle(b);this.currentTran=a},onResize:function(){this.resize();this.status_zoom=!1;this.showPage=this.pageArray[this.currentPageIndex].pages},resize:function(){this.endFlip();this.resizeBook();this.resizePage(this.width,this.height);this.resetPages(this.currentPageIndex);this.resizeAdvertisement()},getTop:function(){return this.bookTop},
resizeBook:function(){var a=bookConfig.topMargin+templateArea.getTopHeight(),b=bookConfig.bottomMargin+templateArea.getBottomHeight(),c=bookConfig.leftMargin+templateArea.getLeftWidth(),g=bookConfig.rightMargin+templateArea.getRightWidth();g=windowWidth-c-g;b=windowHeight-a-b;var h=bookConfig.largePageWidth*(-parseFloat(bookConfig.visibleAreaLeft)+parseFloat(bookConfig.visibleAreaRight))/100,n=bookConfig.largePageHeight*(parseFloat(bookConfig.visibleAreaBottom)-parseFloat(bookConfig.visibleAreaTop))/
100;h=fitPageWidthHeight(g,b,h,n);this.width=parseInt(h.x);this.height=parseInt(h.y);this.bookTop=a+(b-this.height)/2;this.bookLeft=c+(g-this.width)/2;useTheAliCloudChart(parseInt(h.x),this.height);this.docViewBook.css({width:this.width+"px",height:this.height+"px",left:this.bookLeft+"px",top:this.bookTop+"px"})},resizeAdvertisement:function(){var a=bookConfig.largePageWidth*(-parseFloat(bookConfig.visibleAreaLeft)+parseFloat(bookConfig.visibleAreaRight))/100,b=bookConfig.largePageHeight*(parseFloat(bookConfig.visibleAreaBottom)-
parseFloat(bookConfig.visibleAreaTop))/100;a=fitPageWidthHeight(this.width,this.height,a,2*b);this.pageWidth=parseInt(a.x);this.pageHeight=2*parseInt(a.y/2)},resizePage:function(a,b,c){c=this.pageArray.length;for(var g=this.docViewBook.parameters.scale,h=a*g,n=b*g,p=0;p<c;p++)if(this.pageArray[p]){this.pageArray[p].onResize(a,b);this.pageArray[p].controlBar&&this.pageArray[p].controlBar.setVisible(!1);for(var z=this.pageArray[p].pageArray,v=0;v<z.length;v++)z[v]&&z[v].pageBackground&&((isPhone()||
isPad())&&![4,5].includes(z[v].pageBackground.urlType)||1===g||z[v].sideImage.css({width:h+"px",height:n+"px",transform:"scale("+1/g+")","transform-origin":"0 0","will-change":"transform"}))}},getHeight:function(){return this.height},getWidth:function(){return this.width},getScale:function(){return this.currentPage.pages.parameters.toScale},getCssLeft:function(){return parseInt(this.docViewBook.css("left"))},getCssTop:function(){return parseInt(this.docViewBook.css("top"))},checkFlipping:function(){this.flipping=
!1;this.loading();this.fillContent(this.currentPageIndex)},afterFlipTo:function(){this.mainPageIndex=this.currentPageIndex;this.resetPages(this.currentPageIndex);this.setBookTran(0);this.startTran=this.currentTran;this.checkFlipping();this.setAttachmentAfterFlipTo()},setAttachmentBeforeFlipTo:function(){this.bookAttachments.setAttachmentBeforeFlipTo()},setAttachmentAfterFlipTo:function(){this.stopMedia();this.resetSlider();this.flipping||this.enterPage();bookConfig.ThumbnailsButtonVisible&&global.thumbnail&&
(thumbnail.clearHighLight(),thumbnail.setHighLight(this.getRealPageIndex()));window.resizeBookAfterFlip&&!this.flipping&&window.setTimeout(function(){onStageResize()},30)},endFlip:function(){this.flipping=!1},loading:function(){this.flipping||this.pageArray[this.currentPageIndex]&&this.pageArray[this.currentPageIndex].loading()},getCurrentPageIndex:function(){return this.getRealPageIndex()},getCurrentPages:function(){return[this.currentPageIndex]},setCSSByStyle:function(a){this.docViewBook.css(a)},
...
this.pageArray.length,b=0;b<a;b++)this.pageArray[b]&&this.pageArray[b].resetSlider()},afterChangeBookType:function(){for(var a=this.pageArray.length,b=0;b<a;b++)this.pageArray[b]&&this.pageArray[b].initReaderOrSlider()},select:function(){this.selected=!0;var a=this.currentPageIndex;if(this.pageArray[a]){if(this.pageArray[a]){this.pageArray[a].initSelectTextEvent();var b=this.pageArray[a].page;b&&b.pageAttachments.$select&&b.pageAttachments.$select.css({width:this.width+"px",height:this.height+"px"})}this.pageArray[a].pages.parameters&&
(this.pageArray[a].pages.parameters.eventCancel=!0);this.docViewBook.parameters&&(this.docViewBook.parameters.eventCancel=!0)}},unSelect:function(){this.selected=!1;var a=this.getCurrentPages();if(void 0!=a&&null!=a){for(var b=0;b<a.length;b++){var c=a[b];this.pageArray[c]&&(this.pageArray[c]&&this.pageArray[c].destroySelect(),this.pageArray[c].pages.parameters&&(this.pageArray[c].pages.parameters.eventCancel=!1))}this.docViewBook.parameters&&(this.docViewBook.parameters.eventCancel=!1);StateSynchronous.instance().findButtons("SelectTextButton",
!0).each(function(g){g.setAsUnSelect();g.executeCallback()})}},magnifierZoom:function(){this.selected=!0;var a=this.currentPageIndex;this.pageArray[a]&&this.pageArray[a]&&this.pageArray[a].initMagnifierEvent()},unMagnifierZoom:function(){this.selected=!1;var a=BookInfo.getCurrentPages();if(void 0!=a&&null!=a){for(var b=0;b<a.length;b++){var c=a[b];this.pageArray[c]&&this.pageArray[c]&&this.pageArray[c].destroyMagnifier()}bookConfig.MagnifierButtonVisible&&window.magnifierZoomBox&&window.magnifierZoomBox.hide();
StateSynchronous.instance().findButtons("magnifier",!0).each(function(g){g.setAsZoomin()})}},switchLargeImage:function(){for(var a=this.pageArray.length,b=0;b<a;b++)this.pageArray[b]&&this.pageArray[b].switchLargeImage()},switchNormalImage:function(a){for(var b=this.pageArray.length,c=0;c<b;c++)this.pageArray[c]&&this.pageArray[c].switchNormalImage(a)},destroy:function(){this.docViewBook.remove()},zoomIn:function(){this.status_zoom=!0;StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(b){b.setAsZoomout();
b.executeCallback()});window.toolBar&&window.toolBar.btnZoom&&window.toolBar.changeZoomIcon(!1);this.switchLargeImage();bookConfig.ZoomToolbarVisible&&!this.controlBar&&(this.controlBar=new ZoomControlBar(tmpContainer),this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+a+5));if(this.controlBar){var a="lite"==bookConfig.ToolbarViewMode&&bookType==BookType.catalog_book?50:0;this.controlBar.setPosition((windowWidth-this.controlBar.width)/2,templateArea.getTopHeight()+
a+5);this.controlBar.setVisible(!0)}global.canMagnifierZoom&&this.unMagnifierZoom()},zoomOut:function(){this.status_zoom=!1;gotoPageFun(this.toPageIndex,!1,"change book type");StateSynchronous.instance().findButtons("ZoomButton",!0).each(function(a){a.setAsZoomin();a.executeCallback()});window.toolBar&&window.toolBar.btnZoom&&window.toolBar.changeZoomIcon(!0);this.controlBar&&this.controlBar.setVisible(!1)},onZoomed:function(a){console.log(a);if(a&&!this.docViewBook.parameters.resize){this.docViewBook.parameters.resize=
!0;a=this.docViewBook.offset().left;var b=this.docViewBook.offset().top;a-=this.docViewBook.parameters.left;b-=this.docViewBook.parameters.top;var c=this.docViewBook.parameters.scale,g=transformCSS({tran:{x:a,y:b},scale:c,origin:{x:0,y:0}}),h=this.pageArray.length,n=parseInt(this.width*c),p=parseInt(this.height*c);console.log(this.width,this.height,this.width*c);for(var z=0;z<h;z++)if(this.pageArray[z])for(var v=this.pageArray[z].pageArray,B=0;B<v.length;B++)if(v[B]){var D=v[B];if(D.pageAttachments){var M=
fitPageWidthHeight(n,p,D.imageWidth,D.imageHeight);D.pageAttachments.onResize(M.x,M.y,n,p);D.pageAttachments.$animation&&D.pageAttachments.$animation.css({transform:"scale("+1/c+")","transform-origin":"0 0","will-change":"transform"});D.pageAttachments.$highlight&&D.pageAttachments.$highlight.css({transform:"scale("+1/c+")","transform-origin":"0","will-change":"transform"});D.pageAttachments.$select&&D.pageAttachments.$select.css({width:this.width+"px",height:this.height+"px"})}D.pageBackground&&
(D.pageBackground.onResize(n,p),console.log("urlType",D.pageBackground.urlType),!isPhone()&&!isPad()||[4,5].includes(D.pageBackground.urlType))&&(1!==c?D.sideImage.css({width:n+"px",height:p+"px",transform:"scale("+1/c+")","transform-origin":"0 0","will-change":"transform"}):D.sideImage.css({width:"100%",height:"100%",transform:"scale(1)","transform-origin":"0 0","will-change":"transform"}))}this.docViewBook.css(g);this.docViewBook.parameters&&(this.docViewBook.parameters.tran={x:a,y:b},this.docViewBook.parameters.width=
$(this.docViewBook).width(),this.docViewBook.parameters.height=$(this.docViewBook).height(),this.docViewBook.parameters.origin={x:0,y:0},this.docViewBook.parameters.resize=!1)}}}).extend(Book);
DocViewBook.expand({initEvent:function(){this.moveDirectionType={MOVE_LEFT:-1,MOVE_RIGHT:1,MOVE_NONE:0};this.mouseMoveDirection=this.moveDirectionType.MOVE_NONE;this.animationId=null;this.hammerEventModular();this.mouseWheelFlip()},hammerEventModular:function(){var a=new Hammer.Manager(this.docViewBook[0]);a.add(new Hammer.Pan);a.add((new Hammer.Swipe).recognizeWith(a.get("pan")));a.add(new Hammer.Press({time:"1000"}));a.add(new Hammer.Pinch);a.add(new Hammer.Tap({event:"doubletap",taps:2}));a.on("panstart panmove panend pancancel",
this.onPan.bind(this));a.on("press",this.onPress.bind(this));this.docViewBook.bind("click",this.onTap.bind(this));a.on("swipe swipeup",this.onSwipe.bind(this));this.docViewBook.bind("mouseover ",this.onOver.bind(this));this.docViewBook.bind("mouseout ",this.onOut.bind(this));this.docViewBook.bind(_event._down,this.onDown.bind(this));$("body").bind(_event._end+" "+_event._leave,this.onUp.bind(this));this.initZoomEvent()},onPan:function(a){if(!this.selected){this.animateInterval&&this.animateInterval.stop();
this.swipeInterval&&this.swipeInterval.stop();this.stopAnimation();var b=this.getDelta(a);"panstart"===a.type&&(this.startMove=0,document.documentElement.style.cursor="grabbing",document.body.style.cursor="grabbing");if("panmove"===a.type){b=bookConfig.FlipDirection||bookConfig.upsideOnMobile()?b.deltaY:b.deltaX;var c=b-this.startMove;this.startMove=b;this.panBookForMove(c)}if("panend"==a.type||"pancancel"==a.type)document.documentElement.style.cursor="grab",document.body.style.cursor="grab",console.log("restrictInBoundary"),
this.restrictInBoundary()}},onSwipe:function(a){if(!this.selected){this.animateInterval&&this.animateInterval.stop();this.swipeInterval&&this.swipeInterval.stop();this.stopAnimation();var b=bookConfig.FlipDirection||bookConfig.upsideOnMobile(),c=parseFloat(this.pageArray[this.currentPageIndex][b?"top":"left"]),g=bookConfig.RightToLeft?1:bookConfig.totalPageCount;this.currentPageIndex===(bookConfig.RightToLeft?bookConfig.totalPageCount:1)&&0<c||this.currentPageIndex===g&&0>c?this.restrictInBoundary():
(c=this.getVelocity(a),a=c.velocityX,c=c.velocityY,b=b?c:a,50<Math.abs(b)&&(b=50*(0<b?1:-1)),this.startInertialScroll(b))}},onPress:function(a){},onTap:function(a){onWindowTap(a.srcEvent)},onOut:function(){document.documentElement.style.cursor="default";document.body.style.cursor="default"},onOver:function(a){this.selected||(document.documentElement.style.cursor="grab",document.body.style.cursor="grab")},onDown:function(a){this.fingleDown=!0},onUp:function(a){this.swipeInterval||this.animationId||
this.flipping||!this.fingleDown||(30<=Math.abs(this.currentTran-this.startTran)&&(this.currentTran>this.startTran&&!rightToLeft||this.currentTran<this.startTran&&rightToLeft?previousPageFun("window click"):this.currentTran!=this.startTran&&nextPageFun("window click")),this.startTran=this.currentTran,this.panstart=this.fingleDown=!1,this.onBack())},onBack:function(){if(0!=this.currentTran&&!this.flipping){this.flipping=!0;var a=this.currentTran,b=function(c,g,h){c<g?(c=(0,$.easing["easeInOut"+h])(null,
c,a,0-a,g),this.setBookTran(c)):(this.flipping=!1,this.flipInterval.stop(),this.setBookTran(0),this.startTran=this.currentTran)}.bind(this);this.flipInterval=function(c,g){b(c,g,"Sine")}.animation(this,this.flippingTime)}},initZoomEvent:function(){isBelowIE9()?this.docViewBook.IEZoom({side:this,zoomIn:this.zoomIn.bind(this),zoomOut:this.zoomOut.bind(this),onZoomed:this.onZoomed.bind(this)}):this.docViewBook.zoom({isSeries:!0,side:this,zoomIn:this.zoomIn.bind(this),zoomOut:this.zoomOut.bind(this),
onZoomed:this.onZoomed.bind(this)})},dragChangePage:function(a){gotoPageFun(a,!1)},getVelocity:function(a){var b=0,c=0,g=bookConfig.upsideOnMobile();0==a.velocityX||g||(b=a.velocityX);0==a.velocityY||g||(c=a.velocityY);0!=a.velocityX&&g&&(b=a.velocityY);0!=a.velocityY&&g&&(c=-a.velocityX);return{velocityX:b,velocityY:c}},getDelta:function(a){var b=0,c=0,g=bookConfig.upsideOnMobile();0==a.deltaX||g||(b=a.deltaX);0==a.deltaY||g||(c=a.deltaY);0!=a.deltaX&&g&&(b=a.deltaY);0!=a.deltaY&&g&&(c=-a.deltaX);
return{deltaX:b,deltaY:c}},panBookForMove:function(a){console.log("panBookForMove",a);var b=bookConfig.FlipDirection||bookConfig.upsideOnMobile(),c=b?this.height+this.marginTop:this.width+this.marginTop,g=b?"top":"left";b=b?"height":"width";this.status_zoom&&(a/=this.docViewBook.parameters.scale);for(var h=0;h<this.pageArray.length;h++){var n=this.pageArray[h];if(n){var p=parseFloat(n[g])+a,z=c*n.sequence;if((1===this.currentPageIndex&&p>z||this.currentPageIndex===bookConfig.totalPageCount&&p<z)&&
this.status_zoom){this.disableDriection=!1;return}this.disableDriection=!0;n.pageIndex===this.currentPageIndex&&-1===this.toNewPageIndex&&(p<-this[b]/2&&0>a&&(this.toNewPageIndex=bookConfig.RightToLeft?this.currentPageIndex-1:this.currentPageIndex+1),p>this[b]/2&&0<a&&(this.toNewPageIndex=bookConfig.RightToLeft?this.currentPageIndex+1:this.currentPageIndex-1));n[g]=p;p=transformCSS({tran:{x:n.left,y:n.top}});n.setCSSByStyle(p)}}this.toNewPageIndex<=bookConfig.totalPageCount&&0<this.toNewPageIndex&&
this.dragChangePage(this.toNewPageIndex);this.toNewPageIndex=-1},restrictInBoundary:function(){if(1===this.currentPageIndex||this.currentPageIndex===bookConfig.totalPageCount){this.animateInterval&&this.animateInterval.stop();this.stopAnimation();var a=bookConfig.FlipDirection||bookConfig.upsideOnMobile()?"top":"left",b=parseFloat(this.pageArray[this.currentPageIndex][a]),c=bookConfig.RightToLeft?1:bookConfig.totalPageCount;if(this.currentPageIndex===(bookConfig.RightToLeft?bookConfig.totalPageCount:
1)&&0<b||this.currentPageIndex===c&&0>b){var g=0,h=0;g=b;this.animateInterval=function(n,p){n=$.easing.easeOutBack(null,h,0,g,20);0<h&&(n-=$.easing.easeOutBack(null,h-1,0,b,20));console.log("movedTrans",n,b);for(p=0;p<this.pageArray.length;p++){var z=this.pageArray[p];if(z){var v=parseFloat(z[a]);z[a]=v-n;v=transformCSS({tran:{x:z.left,y:z.top}});z.setCSSByStyle(v)}}h++}.animation(this,320)}}},startInertialScroll:function(a){var b=this;this.animationId&&this.stopAnimation();var c=performance.now(),
g=c,h=a,n=0,p=0,z=a,v=bookConfig.FlipDirection||bookConfig.upsideOnMobile(),B=v?"top":"left",D=v?"height":"width",M=bookConfig.RightToLeft?bookConfig.totalPageCount:1,Q=bookConfig.RightToLeft?1:bookConfig.totalPageCount,ca=function(V){var da=Math.min(V-g,32);h=a=h+.25*(1.3*z*(1-(1-Math.pow(1-Math.min((V-c)/1500,1),3)))-h);n+=a*da;.35<=Math.abs(n)&&(da=Math.round(p+.3*(Math.round(n)-p)),0!==da&&b.panBookForMove(da,!0),n-=da,p=da);da=parseFloat(b.pageArray[b.currentPageIndex][B]);.1>Math.abs(a)||b.currentPageIndex===
M&&da>b[D]/2||b.currentPageIndex===Q&&da<-b[D]/2?(console.log("stopAnimation"),b.stopAnimation(),b.restrictInBoundary(),b.startTran=b.currentTran,b.fingleDown=!1,b.panstart=!1):(g=V,b.animationId=requestAnimationFrame(ca))};this.animationId=requestAnimationFrame(ca)},stopAnimation:function(){if(this.animationId){console.log("stopAnimation");cancelAnimationFrame(this.animationId);this.animationId=null;for(var a=this.pageArray.length,b=0;b<a;b++)this.pageArray[b]&&this.pageArray[b].fillContent(b)}}});
